...
# modes:
BUILD_TYPE = "Release"
cmake -G $LFORTRAN_CMAKE_GENERATOR -DCMAKE_VERBOSE_MAKEFILE=ON -DWITH_LLVM=yes -DWITH_XEUS=yes -DCMAKE_PREFIX_PATH=$CONDA_PREFIX -DCMAKE_INSTALL_PREFIX=$CONDA_PREFIX -DCMAKE_INSTALL_LIBDIR=share/lfortran/lib -DCMAKE_INSTALL_INCLUDEDIR=share/lfortran/lib -DCMAKE_BUILD_TYPE=@(BUILD_TYPE) ..
