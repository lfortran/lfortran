...
# error-stops 1): their x86-64 backend passes fp128 libcall arguments (e.g.
# __lttf2) in general purpose registers instead of SSE registers. Keep
# compiling them; skip running them on LLVM 7 and 8.
