...
./inst_aarch64/bin/lfortran --target arm64-linux -c examples/expr2.f90 -o expr2.o
./inst_aarch64/bin/lfortran --target arm64-linux -o expr2 expr2.o
qemu-aarch64 -L /usr/aarch64-linux-gnu/ ./expr2
...
./inst_aarch64/bin/lfortran --target arm64-linux integration_tests/intrinsics_04s.f90 -o intrinsics_04s
qemu-aarch64 -L /usr/aarch64-linux-gnu/ ./intrinsics_04s

./inst_aarch64/bin/lfortran --target arm64-linux integration_tests/intrinsics_04.f90 -o intrinsics_04
qemu-aarch64 -L /usr/aarch64-linux-gnu/ ./intrinsics_04
