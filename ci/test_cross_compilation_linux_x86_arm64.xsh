...
./inst_aarch64/bin/lfortran --link-with-gcc --target arm64-linux --static -c examples/expr2.f90 -o expr2.o
./inst_aarch64/bin/lfortran --link-with-gcc --target arm64-linux --static -o expr2 expr2.o
...
./inst_aarch64/bin/lfortran --link-with-gcc --target arm64-linux --static integration_tests/intrinsics_04s.f90 -o intrinsics_04s
qemu-aarch64-static ./intrinsics_04s

./inst_aarch64/bin/lfortran --link-with-gcc --target arm64-linux --static integration_tests/intrinsics_04.f90 -o intrinsics_04
