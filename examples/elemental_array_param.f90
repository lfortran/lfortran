program test_elemental_functions
    implicit none
    ...
    if (any(abs(result_2param - 1.0) > epsilon)) then
    ...
    if (abs(result_2param - 1.0) > epsilon) then
    ...
    if (any(abs(result_3param - 1.0) > epsilon)) then
    ...
    if (abs(result_3param - 1.0) > epsilon) then
...
end program test_elemental_functions
