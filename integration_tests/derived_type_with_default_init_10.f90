...
module derived_type_with_default_init_10_mod
    implicit none
contains
...
end module derived_type_with_default_init_10_mod
...
program derived_type_with_default_init_10
    use derived_type_with_default_init_10_mod
    implicit none
...
end program derived_type_with_default_init_10
