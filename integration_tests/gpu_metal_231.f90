...
submodule(gpu_metal_231_iface) gpu_metal_231_impl
implicit none
contains
...
module gpu_metal_231_drivers
use gpu_metal_231_iface
use gpu_metal_231_plain
implicit none
contains
