...
module derived_types_118_origin
   implicit none
   private
...
end module derived_types_118_origin

module derived_types_118_reexport
   use derived_types_118_origin
   implicit none
   private
   public :: merge_config
end module derived_types_118_reexport

module derived_types_118_consumer
   use derived_types_118_reexport
   implicit none
   private
   public :: do_stuff
contains
...
end module derived_types_118_consumer

program derived_types_118
   use derived_types_118_consumer, only : do_stuff
   implicit none
   integer :: val
   call do_stuff(val)
   if (val /= 2) error stop
