program intrinsics_203
    ...
    print *, asind(i)
    if (asind(i) - 18.723412014063609_dp > 1e-5) error stop

    print *, asind(j)
    if (asind(j) - 31.735588727756351_dp > 1e-5) error stop

    print *, asind(k)
    if (asind(k) - 46.718986762209930_dp > 1e-5) error stop
    ...
    if (asind(0.321_dp) - 18.723411422692248_dp > 1e-5) error stop

    print *, asind(0.526_dp)
    if (asind(0.526_dp) - 31.735587185816161_dp > 1e-5) error stop

    print *, asind(0.728_dp)
    if (asind(0.728_dp) - 46.718987997582886_dp > 1e-7) error stop
