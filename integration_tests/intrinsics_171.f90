program intrinsics_171
    ...
    print *, dshiftl(7_8,12_8,5)
    if(dshiftl(7_8,12_8,5) /= 224) error stop
    ...
    print *, kind(dshiftl(7_8,12_8,5))
    if(kind(dshiftl(7_8,12_8,5)) /= 8) error stop
