module implied_do_loops22_types
  implicit none
...
end module implied_do_loops22_types

program implied_do_loops22
  use implied_do_loops22_types
  implicit none
  ...
  ! Implied do loop (array constructor) - was segfaulting
...
end program implied_do_loops22
