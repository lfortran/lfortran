...
int f_int_float(int *a, float *b) { return *a + *b; }

int f_int_double(int *a, double *b) { return *a + *b; }
...
int f_int_float_value(int a, float b) { return a + b; }

int f_int_double_value(int a, double b) { return a + b; }
...
void sub_int_float(int *a, float *b, int *r) { *r = *a + *b; }

void sub_int_double(int *a, double *b, int *r) { *r = *a + *b; }
...
void sub_int_float_value(int a, float b, int *r) { *r = a + b; }

void sub_int_double_value(int a, double b, int *r) { *r = a + b; }
...
int f_string(char *s) { return strlen(s); }

int32_t call_fortran_i32(int32_t i) { return fortran_i32(&i); }

int32_t call_fortran_i32_value(int32_t i) { return fortran_i32_value(i); }

int64_t call_fortran_i64(int64_t i) { return fortran_i64(&i); }

int64_t call_fortran_i64_value(int64_t i) { return fortran_i64_value(i); }

float call_fortran_f32(float i) { return fortran_f32(&i); }

float call_fortran_f32_value(float i) { return fortran_f32_value(i); }

double call_fortran_f64(double i) { return fortran_f64(&i); }

double call_fortran_f64_value(double i) { return fortran_f64_value(i); }
