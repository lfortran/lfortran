program intrinsics_297
    ...
    integer(4), parameter :: i4(1) = maxloc([1,2,3], 1, [.true., .true., .true.])
    integer(8), parameter :: i5(1) = maxloc([1,2,3], 1, mask=[.true., .false., .true.], kind = 8)
    integer(4), parameter :: i6(1) = maxloc([1,2,3], mask=[.true., .false., .true.], dim=1)
    integer(4), parameter :: i7(1) = maxloc(["aa", "db", "ca"], 1, mask=[.true., .false., .true.])
    integer(4), parameter :: i8(1) = maxloc(["aa", "db", "ca"], mask=[.true., .false., .true.], dim = 1)
    integer(4), parameter :: i9(1) = maxloc([1, 3, 2], 1, mask = [.true., .false., .true.], back = .true.)
    integer(4), parameter :: i10(1) = maxloc([3, 2, 1, 3], back = .true.)
    integer(4), parameter :: i11(1) = maxloc([3.0, 2.0, 1.0, 3.0], back = .true.)
    integer(4), parameter :: i12(1) = maxloc(["aa", "db", "ca"], 1, mask = [.false., .false., .false.], kind = 4)
    ...
    print *, kind(maxloc(["aa", "db", "ca"], 1, mask = [.false., .false., .false.], kind = 8))
    if (kind(maxloc(["aa", "db", "ca"], 1, mask = [.false., .false., .false.], kind = 8)) /= 8) error stop
end program