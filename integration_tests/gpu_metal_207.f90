...
if (abs(sum(a(:)%v) - 10.0) > 1.0e-6) error stop "gpu_metal_207: real(4) component"
if (sum(a(:)%k) /= 20) error stop "gpu_metal_207: integer(4) component"
...
if (abs(sum(c%u) - 10.0) > 1.0e-6) error stop "gpu_metal_207: extends real(4) component"
if (abs(c%b - 0.5) > 1.0e-6) error stop "gpu_metal_207: inherited real(4) component"

print *, "gpu_metal_207 ok"
end program
