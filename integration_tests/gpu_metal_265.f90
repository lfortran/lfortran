...
module gpu_metal_265_m
   implicit none
   type, abstract :: gpu_metal_265_base_t
      integer :: tag_
      real, allocatable :: upper_(:,:)
      real, allocatable :: inner_(:)
   end type gpu_metal_265_base_t
   type, extends(gpu_metal_265_base_t) :: gpu_metal_265_kid_t
   end type gpu_metal_265_kid_t
end module gpu_metal_265_m

program gpu_metal_265
   use gpu_metal_265_m
   implicit none
   integer, parameter :: rows = 3, cols = 4
   type(gpu_metal_265_kid_t) :: op(2)
