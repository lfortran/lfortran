program intrinsics_176
    ...
    if ((set_exponent(4.1_dp, 5) - 16.3999999999999986_8) > 1e-12) error stop

    print *, set_exponent(y, j)
    if ((set_exponent(y, j) - 16.399999999999999_8) > 1e-12) error stop
    ...
    if ((set_exponent(0.5_dp, 7) - 64.000000000000000_8) > 1e-12) error stop

    print *, set_exponent(y, j)
    if ((set_exponent(y, j) - 64.000000000000000_8) > 1e-12) error stop
    ...
    if ((set_exponent(-15.678_dp, 12) - (-4013.5680000000002_8)) > 1e-12) error stop

    print *, set_exponent(y, j)
    if ((set_exponent(y, j) - (-4013.5680000000002_8)) > 1e-12) error stop
