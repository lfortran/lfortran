program intrinsics_209
    ...
    integer :: i
    real(dp) :: w(19)
    real(dp) :: large_pos(19)
    real(dp) :: large_neg(19)
    real(sp) :: x(19)
    real(dp) :: expected_w(19)
    real(sp) :: expected_x(19)
    real(dp) :: expected_large_pos(19)
    real(dp) :: expected_large_neg(19)
    ...
    real(sp), parameter :: x_comp(19) = [0.321_sp, 0.526_sp, 0.728_sp, -0.321_sp, -0.526_sp, -0.728_sp, &
    ...
    real(sp), parameter :: res_x(19) = atand(x_comp)
    ...
    large_pos = [988.522977022977_dp, 989.021978021978_dp, 989.520979020979_dp ,990.01998001998_dp , & 
    ...
    large_neg = [-988.522977022977_dp, -989.021978021978_dp, -989.520979020979_dp, -990.01998001998_dp , & 
            -990.518981018981_dp, -991.017982017982_dp, -991.516983016983_dp, -992.015984015984_dp, &
            -992.514985014985_dp, -993.013986013986_dp, -993.512987012987_dp, -994.011988011988_dp, &
            -994.510989010989_dp, -995.00999000999_dp, -995.508991008991_dp, -996.007992007992_dp, &
            -996.506993006993_dp, -997.005994005994_dp, -997.504995004995_dp]
    ...
    expected_large_pos = [89.942039020538502_dp, 89.942068264142364_dp, 89.942097478252023_dp, 89.942126662912045_dp, &     
    ...
    expected_large_neg = [-89.942039020538502_dp, -89.942068264142364_dp, -89.942097478252023_dp, -89.942126662912045_dp, &     
    -89.942155818166967_dp, -89.942184944061196_dp, -89.942214040639058_dp, -89.942243107944805_dp, &    
    -89.942272146022574_dp, -89.942301154916436_dp, -89.942330134670371_dp, -89.942359085328249_dp, &    
    -89.942388006933868_dp, -89.942416899530954_dp, -89.942445763163107_dp, -89.942474597873883_dp, &    
    -89.942503403706695_dp, -89.942532180704944_dp, -89.942560928911888_dp]
    ...
    do i = 1, size(large_pos)
        print *, atand(large_pos(i))
        if (abs(atand(large_pos(i)) - expected_large_pos(i)) > 1e-12_dp) error stop
    end do

    do i = 1, size(large_neg)
        print *, atand(large_neg(i))
        if (abs(atand(large_neg(i)) - expected_large_neg(i)) > 1e-12_dp) error stop
    end do
