! Interfaces for gpu_metal_267.  The body lives in a submodule compiled on
...
end module gpu_metal_267_m
submodule(gpu_metal_267_m) gpu_metal_267_s
   implicit none
contains
