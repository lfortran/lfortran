    ...
    if (ASR::is_a<ASR::IntegerCompare_t>(*value)) {
        ...
        if (ASR::is_a<ASR::Array_t>(*left_type)) {
            ...
            if (left_array_type->m_physical_type == ASR::array_physical_typeType::FixedSizeArray) {
                ...
                ASR::ttype_t* logical_array_type = ASRUtils::TYPE(ASR::make_Array_t(al, value->base.loc, logical_type, left_m_dims, left_n_dims, ASR::array_physical_typeType::PointerToDataArray, false));
                value_type = logical_array_type;
            }
            ...
            if (right_array_type->m_physical_type == ASR::array_physical_typeType::FixedSizeArray) {
                ...
                ASR::ttype_t* logical_array_type = ASRUtils::TYPE(ASR::make_Array_t(al, value->base.loc, logical_type, right_m_dims, right_n_dims, ASR::array_physical_typeType::PointerToDataArray, false));
                value_type = logical_array_type;
            }
        }
    }
