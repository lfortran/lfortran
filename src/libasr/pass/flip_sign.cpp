...
public:
    FlipSignVisitor(Allocator &al_, ASR::TranslationUnit_t &unit_,
                    const LFortran::CompilerOptions& compiler_options_) : SkipOptimizationFunctionVisitor(al_),
    unit(unit_), compiler_options(compiler_options_)
    {
    ...
    void visit_If(const ASR::If_t& x) {
        ...
        if( is_flip_sign_present ) {
            ...
            ASR::stmt_t* flip_sign_call = PassUtils::get_flipsign(flip_sign_signal_variable,
                                            flip_sign_variable, al, unit, compiler_options, current_scope,
