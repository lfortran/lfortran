...
class CollectUnusedFunctionsVisitor : public ASR::BaseWalkVisitor<CollectUnusedFunctionsVisitor>
{
public:
...
collect_unused_functions(ASR::TranslationUnit_t& unit)
{
...
bool
is_program_present(ASR::TranslationUnit_t& unit)
{
    ProgramVisitor v;
    v.visit_TranslationUnit(unit);
...
public:
    ...
    UnusedFunctionsVisitor(Allocator& al)
        : al{ al }
    {
    }
...
void
pass_unused_functions(Allocator& al,
