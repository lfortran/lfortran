                                     ...
                                     const LCompilers::PassOptions& pass_options)
{
    ...
    if (unit.n_items > 0) {
        ...
        for (size_t i = 0; i < unit.n_items; i++) {
            if (unit.m_items[i]->type == ASR::asrType::expr) {
                ...
                if (LFortran::ASRUtils::expr_type(value)->type == ASR::ttypeType::Integer) {
                    ...
                    int a_kind
                        = down_cast<ASR::Integer_t>(LFortran::ASRUtils::expr_type(value))->m_kind;
                    ...
                    return_var = ASR::make_Variable_t(al,
                                                      ...
                                                      fn_scope,
                                                      var_name,
                                                      LFortran::ASRUtils::intent_local,
                                                      nullptr,
                                                      nullptr,
                                                      ...
                                                      false);
                    return_var_ref
                        = EXPR(ASR::make_Var_t(al, loc, down_cast<ASR::symbol_t>(return_var)));
        ...
        if (return_var) {
            ...
            ASR::asr_t* fn = ASR::make_Function_t(al,
                                                  loc,
                                                  /* a_symtab */ fn_scope,
                                                  /* a_name */ fn_name,
                                                  /* a_args */ nullptr,
