...
public:
    ...
    void visit_DoLoop(const ASR::DoLoop_t &x) {
        pass_result = PassUtils::replace_doloop(al, x, current_scope, -1, use_loop_variable_after_loop);
    }
    ...
    void visit_DoConcurrentLoop(const ASR::DoConcurrentLoop_t &x) {
        ...
        pass_result = PassUtils::replace_doloop(al, do_loop_ref, current_scope, -1, use_loop_variable_after_loop);
    }
};
