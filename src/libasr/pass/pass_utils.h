...
namespace PassUtils
{
    ...
    ASR::ttype_t* set_dim_rank(ASR::ttype_t* x_type,
    ...
    ASR::expr_t* create_array_ref(ASR::symbol_t* arr,
                                  Vec<ASR::expr_t*>& idx_vars,
                                  Allocator& al,
                                  const Location& loc,
                                  ASR::ttype_t* _type);

    void create_vars(Vec<ASR::expr_t*>& vars,
                     int n_vars,
                     const Location& loc,
                     Allocator& al,
    ...
    void create_idx_vars(Vec<ASR::expr_t*>& idx_vars,
                         int n_dims,
                         const Location& loc,
                         Allocator& al,
                         SymbolTable*& current_scope,
    ...
    ASR::expr_t* create_compare_helper(Allocator& al,
                                       const Location& loc,
                                       ASR::expr_t* left,
                                       ASR::expr_t* right,
                                       ASR::cmpopType op);

    ASR::expr_t* create_binop_helper(Allocator& al,
                                     const Location& loc,
                                     ASR::expr_t* left,
                                     ASR::expr_t* right,
                                     ASR::binopType op);
    ...
    ASR::stmt_t* get_flipsign(ASR::expr_t* arg0,
                              ASR::expr_t* arg1,
                              Allocator& al,
    ...
    ASR::expr_t* create_auxiliary_variable(Location& loc,
                                           std::string& name,
                                           Allocator& al,
                                           SymbolTable*& current_scope,
                                           ASR::ttype_t* var_type);

    ASR::expr_t* get_fma(ASR::expr_t* arg0,
                         ASR::expr_t* arg1,
                         ASR::expr_t* arg2,
                         Allocator& al,
                         ASR::TranslationUnit_t& unit,
    ...
    ASR::stmt_t* get_vector_copy(ASR::expr_t* array0,
                                 ASR::expr_t* array1,
                                 ASR::expr_t* start,
                                 ASR::expr_t* end,
                                 ASR::expr_t* step,
    ...
    Vec<ASR::stmt_t*> replace_doloop(Allocator& al, const ASR::DoLoop_t& loop, int comp = -1);
