...
typedef void (*pass_function)(Allocator&,
                              LFortran::ASR::TranslationUnit_t&,
...
private:
    ...
    void _apply_passes(Allocator& al,
...
public:
    ...
    void apply_passes(Allocator& al,
                      LFortran::ASR::TranslationUnit_t* asr,
                      PassOptions& pass_options)
    {
