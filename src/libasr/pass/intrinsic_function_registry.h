...
#define INTRINSIC_ARRAY_NAME_CASE(X)                                                               \
    case (static_cast<int64_t>(ASRUtils::IntrinsicArrayFunctions::X)): {                           \
        return #X;                                                                                 \
    }

#define INTRINSIC_SCALAR_NAME_CASE(X)                                                              \
    case (static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::X)): {                          \
        return #X;                                                                                 \
    }

#define INTRINSIC_IMPURE_NAME_CASE(X)                                                              \
    case (static_cast<int64_t>(ASRUtils::IntrinsicImpureFunctions::X)): {                          \
        return #X;                                                                                 \
    }

    inline std::string get_intrinsic_scalar_name(int x)
    {
        switch (x) {
            INTRINSIC_SCALAR_NAME_CASE(Sin)
            INTRINSIC_SCALAR_NAME_CASE(Cos)
            INTRINSIC_SCALAR_NAME_CASE(Tan)
            INTRINSIC_SCALAR_NAME_CASE(Asin)
            INTRINSIC_SCALAR_NAME_CASE(Acos)
            INTRINSIC_SCALAR_NAME_CASE(Atan)
            INTRINSIC_SCALAR_NAME_CASE(Sinh)
            INTRINSIC_SCALAR_NAME_CASE(Cosh)
            INTRINSIC_SCALAR_NAME_CASE(Tanh)
            INTRINSIC_SCALAR_NAME_CASE(Gamma)
            INTRINSIC_SCALAR_NAME_CASE(LogGamma)
            INTRINSIC_SCALAR_NAME_CASE(Abs)
            INTRINSIC_SCALAR_NAME_CASE(Exp)
            INTRINSIC_SCALAR_NAME_CASE(Exp2)
            INTRINSIC_SCALAR_NAME_CASE(Expm1)
            INTRINSIC_SCALAR_NAME_CASE(ListIndex)
            INTRINSIC_SCALAR_NAME_CASE(Partition)
            INTRINSIC_SCALAR_NAME_CASE(Sign)
            INTRINSIC_SCALAR_NAME_CASE(SymbolicSymbol)
            INTRINSIC_SCALAR_NAME_CASE(SymbolicAdd)
            INTRINSIC_SCALAR_NAME_CASE(SymbolicSub)
            INTRINSIC_SCALAR_NAME_CASE(SymbolicMul)
            INTRINSIC_SCALAR_NAME_CASE(SymbolicDiv)
            INTRINSIC_SCALAR_NAME_CASE(SymbolicPow)
            INTRINSIC_SCALAR_NAME_CASE(SymbolicPi)
            INTRINSIC_SCALAR_NAME_CASE(SymbolicInteger)
            INTRINSIC_SCALAR_NAME_CASE(SymbolicDiff)
            INTRINSIC_SCALAR_NAME_CASE(SymbolicExpand)
            INTRINSIC_SCALAR_NAME_CASE(SymbolicSin)
            INTRINSIC_SCALAR_NAME_CASE(SymbolicCos)
            INTRINSIC_SCALAR_NAME_CASE(SymbolicLog)
            INTRINSIC_SCALAR_NAME_CASE(SymbolicExp)
            INTRINSIC_SCALAR_NAME_CASE(SymbolicAbs)
            default: {
    ...
    inline std::string get_intrinsic_array_name(int x)
    {
        switch (x) {
            INTRINSIC_ARRAY_NAME_CASE(Sum)
            INTRINSIC_ARRAY_NAME_CASE(Max)
            INTRINSIC_ARRAY_NAME_CASE(Min)
            INTRINSIC_ARRAY_NAME_CASE(Product)
            INTRINSIC_ARRAY_NAME_CASE(MaxVal)
            INTRINSIC_ARRAY_NAME_CASE(MinVal)
            INTRINSIC_ARRAY_NAME_CASE(Merge)
            INTRINSIC_ARRAY_NAME_CASE(Any)
            default: {
                throw LCompilersException("pickle: intrinsic_id not implemented");
            }
        }
    }
    inline std::string get_intrinsic_impure_name(int x)
    {
        switch (x) {
            INTRINSIC_IMPURE_NAME_CASE(ListReverse)
            INTRINSIC_IMPURE_NAME_CASE(ListPop)
            default: {
                throw LCompilersException("pickle: intrinsic_id not implemented");
            }
        }
    ...
    typedef ASR::expr_t* (*impl_function)(Allocator&,
                                          const Location&,
                                          SymbolTable*,
                                          Vec<ASR::ttype_t*>&,
                                          Vec<ASR::call_arg_t>&,
    ...
    typedef ASR::expr_t* (*eval_intrinsic_function)(Allocator&,
                                                    const Location&,
                                                    Vec<ASR::expr_t*>&);
    ...
    typedef void (*verify_function)(const ASR::IntrinsicFunction_t&, diag::Diagnostics&);

    typedef void (*verify_array_func)(ASR::expr_t*,
                                      ASR::ttype_t*,
                                      const Location&,
                                      diag::Diagnostics&,
    ...
    public:
        ASRBuilder(Allocator& al_, const Location& loc_)
            : al(al_)
            , loc(loc_)
        {
        }

#define make_ConstantWithKind(Constructor, TypeConstructor, value, kind, loc)                      \
    ASRUtils::EXPR(                                                                                \
        ASR::Constructor(al, loc, value, ASRUtils::TYPE(ASR::TypeConstructor(al, loc, 4))))

#define make_ConstantWithType(Constructor, value, type, loc)                                       \
    ASRUtils::EXPR(ASR::Constructor(al, loc, value, type))
...
#define declare_basic_variables(name)                                                              \
    ...
    dep.reserve(al, 1);
        ...
        // Symbols -----------------------------------------------------------------
        ASR::expr_t* Variable(SymbolTable* symtab,
                              std::string var_name,
                              ASR::ttype_t* type,
                              ASR::intentType intent,
                              ASR::abiType abi = ASR::abiType::Source,
                              bool a_value_attr = false)
        {
            ASR::symbol_t* sym
                = ASR::down_cast<ASR::symbol_t>(ASR::make_Variable_t(al,
                                                                     loc,
                                                                     symtab,
                                                                     s2c(al, var_name),
                                                                     nullptr,
...
#define make_Function_t(name, symtab, dep, args, body, return_var, abi, deftype, bindc_name)       \
    ASR::down_cast<ASR::symbol_t>(ASRUtils::make_Function_t_util(al,                               \
                                                                 loc,                              \
                                                                 symtab,                           \
                                                                 s2c(al, name),                    \
                                                                 dep.p,                            \
...
#define make_Function_Without_ReturnVar_t(name, symtab, dep, args, body, abi, deftype, bindc_name) \
    ASR::down_cast<ASR::symbol_t>(ASRUtils::make_Function_t_util(al,                               \
                                                                 loc,                              \
                                                                 symtab,                           \
                                                                 s2c(al, name),                    \
...
#define List(x) TYPE(ASR::make_List_t(al, loc, x))
        ...
        {
            Vec<ASR::ttype_t*> m_tuple_type;
            m_tuple_type.reserve(al, 3);
...
#define i32_n(x) EXPR(ASR::make_IntegerUnaryMinus_t(al, loc, i32(abs(x)), int32, i32(x)))
...
#define ListItem(x, pos, type) EXPR(ASR::make_ListItem_t(al, loc, x, pos, type, nullptr))
#define ListAppend(x, val) STMT(ASR::make_ListAppend_t(al, loc, x, val))

#define StringSection(s, start, end)                                                               \
    EXPR(ASR::make_StringSection_t(al, loc, s, start, end, nullptr, character(-2), nullptr))
#define StringItem(x, idx) EXPR(ASR::make_StringItem_t(al, loc, x, idx, character(-2), nullptr))
#define StringConstant(s, type) EXPR(ASR::make_StringConstant_t(al, loc, s2c(al, s), type))
#define StringLen(s) EXPR(ASR::make_StringLen_t(al, loc, s, int32, nullptr))

#define iAdd(left, right)                                                                          \
    EXPR(ASR::make_IntegerBinOp_t(al, loc, left, ASR::binopType::Add, right, int32, nullptr))
#define iSub(left, right)                                                                          \
    EXPR(ASR::make_IntegerBinOp_t(al, loc, left, ASR::binopType::Sub, right, int32, nullptr))

#define And(x, y)                                                                                  \
    EXPR(ASR::make_LogicalBinOp_t(al, loc, x, ASR::logicalbinopType::And, y, logical, nullptr))
#define Not(x) EXPR(ASR::make_LogicalNot_t(al, loc, x, logical, nullptr))

#define iEq(x, y)                                                                                  \
    EXPR(ASR::make_IntegerCompare_t(al, loc, x, ASR::cmpopType::Eq, y, logical, nullptr))
#define iNotEq(x, y)                                                                               \
    EXPR(ASR::make_IntegerCompare_t(al, loc, x, ASR::cmpopType::NotEq, y, logical, nullptr))
#define iLt(x, y)                                                                                  \
    EXPR(ASR::make_IntegerCompare_t(al, loc, x, ASR::cmpopType::Lt, y, logical, nullptr))
#define iLtE(x, y)                                                                                 \
    EXPR(ASR::make_IntegerCompare_t(al, loc, x, ASR::cmpopType::LtE, y, logical, nullptr))
#define iGtE(x, y)                                                                                 \
    EXPR(ASR::make_IntegerCompare_t(al, loc, x, ASR::cmpopType::GtE, y, logical, nullptr))

#define fGtE(x, y)                                                                                 \
    EXPR(ASR::make_RealCompare_t(al, loc, x, ASR::cmpopType::GtE, y, logical, nullptr))
#define fLt(x, y) EXPR(ASR::make_RealCompare_t(al, loc, x, ASR::cmpopType::Lt, y, logical, nullptr))

#define sEq(x, y)                                                                                  \
    EXPR(ASR::make_StringCompare_t(al, loc, x, ASR::cmpopType::Eq, y, logical, nullptr))
#define sNotEq(x, y)                                                                               \
    EXPR(ASR::make_StringCompare_t(al, loc, x, ASR::cmpopType::NotEq, y, logical, nullptr))

        ASR::stmt_t* If(ASR::expr_t* a_test,
                        std::vector<ASR::stmt_t*> if_body,
                        std::vector<ASR::stmt_t*> else_body)
        {
            Vec<ASR::stmt_t*> m_if_body;
            m_if_body.reserve(al, 1);
            for (auto& x : if_body)
                m_if_body.push_back(al, x);

            Vec<ASR::stmt_t*> m_else_body;
            m_else_body.reserve(al, 1);
            for (auto& x : else_body)
                m_else_body.push_back(al, x);

            return STMT(ASR::make_If_t(
                al, loc, a_test, m_if_body.p, m_if_body.n, m_else_body.p, m_else_body.n));
        }
        ...
        ASR::stmt_t* While(ASR::expr_t* a_test, std::vector<ASR::stmt_t*> body)
        {
            ...
            m_body.reserve(al, 1);
            for (auto& x : body)
                m_body.push_back(al, x);

            return STMT(ASR::make_WhileLoop_t(al, loc, nullptr, a_test, m_body.p, m_body.n));
        }

        ASR::expr_t* TupleConstant(std::vector<ASR::expr_t*> ele, ASR::ttype_t* type)
        {
            Vec<ASR::expr_t*> m_ele;
            m_ele.reserve(al, 3);
            for (auto& x : ele)
...
#define make_Compare(Constructor, left, op, right)                                                 \
    ASRUtils::EXPR(ASR::Constructor(al,                                                            \
                                    loc,                                                           \
                                    left,                                                          \
                                    ASR::cmpopType::op,                                            \
                                    right,                                                         \
...
#define create_ElementalBinOp(OpType, BinOpName, OpName, value)                                    \
    case ASR::ttypeType::OpType: {                                                                 \
        return ASRUtils::EXPR(ASR::BinOpName(                                                      \
            al, loc, left, ASR::binopType::OpName, right, ASRUtils::expr_type(left), value));      \
    }

        ASR::expr_t* ElementalAdd(ASR::expr_t* left,
                                  ASR::expr_t* right,
                                  const Location& loc,
            ...
            switch (left_type->type) {
                create_ElementalBinOp(Real, make_RealBinOp_t, Add, value)
                    create_ElementalBinOp(Integer, make_IntegerBinOp_t, Add, value)
                        create_ElementalBinOp(Complex, make_ComplexBinOp_t, Add, value) default:
                {
                    throw LCompilersException("Expression type, " + std::to_string(left_type->type)
                                              + " not yet supported");
                }
            }
        }

        ASR::expr_t* ElementalSub(ASR::expr_t* left,
                                  ASR::expr_t* right,
                                  const Location& loc,
                                  ASR::expr_t* value = nullptr)
        {
            switch (ASRUtils::expr_type(left)->type) {
                create_ElementalBinOp(Real, make_RealBinOp_t, Sub, value)
                    create_ElementalBinOp(Integer, make_IntegerBinOp_t, Sub, value)
                        create_ElementalBinOp(Complex, make_ComplexBinOp_t, Sub, value) default:
                {
                    throw LCompilersException("Expression type, " + std::to_string(left->type)
                                              + " not yet supported");
                }
            }
        }

        ASR::expr_t* ElementalDiv(ASR::expr_t* left,
                                  ASR::expr_t* right,
                                  const Location& loc,
                                  ASR::expr_t* value = nullptr)
        {
            switch (ASRUtils::expr_type(left)->type) {
                create_ElementalBinOp(Real, make_RealBinOp_t, Div, value)
                    create_ElementalBinOp(Integer, make_IntegerBinOp_t, Div, value)
                        create_ElementalBinOp(Complex, make_ComplexBinOp_t, Div, value) default:
                {
                    throw LCompilersException("Expression type, " + std::to_string(left->type)
                                              + " not yet supported");
                }
        ...
        ASR::expr_t* ElementalMul(ASR::expr_t* left,
                                  ASR::expr_t* right,
                                  const Location& loc,
                                  ASR::expr_t* value = nullptr)
        {
            switch (ASRUtils::expr_type(left)->type) {
                create_ElementalBinOp(Real, make_RealBinOp_t, Mul, value)
                    create_ElementalBinOp(Integer, make_IntegerBinOp_t, Mul, value)
                        create_ElementalBinOp(Complex, make_ComplexBinOp_t, Mul, value) default:
                {
                    throw LCompilersException("Expression type, " + std::to_string(left->type)
                                              + " not yet supported");
                }
        ...
        ASR::expr_t* ElementalPow(ASR::expr_t* left,
                                  ASR::expr_t* right,
                                  const Location& loc,
                                  ASR::expr_t* value = nullptr)
        {
            switch (ASRUtils::expr_type(left)->type) {
                create_ElementalBinOp(Real, make_RealBinOp_t, Pow, value)
                    create_ElementalBinOp(Integer, make_IntegerBinOp_t, Pow, value)
                        create_ElementalBinOp(Complex, make_ComplexBinOp_t, Pow, value) default:
                {
                    throw LCompilersException("Expression type, " + std::to_string(left->type)
                                              + " not yet supported");
                }
        ...
        ASR::expr_t* ElementalMax(ASR::expr_t* left,
                                  ASR::expr_t* right,
                                  const Location& loc,
                                  ASR::expr_t* value = nullptr)
        {
            ...
            return ASRUtils::EXPR(ASR::make_IfExp_t(
                al, loc, test_condition, left, right, ASRUtils::expr_type(left), value));
        }

        ASR::expr_t* ElementalMin(ASR::expr_t* left,
                                  ASR::expr_t* right,
                                  const Location& loc,
                                  ASR::expr_t* value = nullptr)
        {
        ...
        ASR::expr_t* ElementalOr(ASR::expr_t* left, ASR::expr_t* right, const Location& loc)
        {
            return ASRUtils::EXPR(
                ASR::make_LogicalBinOp_t(al,
                                         loc,
                                         left,
                                         ASR::Or,
                                         right,
        ...
        ASR::expr_t* Or(ASR::expr_t* left, ASR::expr_t* right, const Location& loc)
        {
            return ASRUtils::EXPR(ASR::make_LogicalBinOp_t(
                al, loc, left, ASR::Or, right, ASRUtils::expr_type(left), nullptr));
        }

        ASR::expr_t* Call(ASR::symbol_t* s, Vec<ASR::call_arg_t>& args, ASR::ttype_t* return_type)
        {
            return ASRUtils::EXPR(ASRUtils::make_FunctionCall_t_util(
                al, loc, s, s, args.p, args.size(), return_type, nullptr, nullptr));
        }

        ASR::expr_t* Call(ASR::symbol_t* s, Vec<ASR::expr_t*>& args, ASR::ttype_t* return_type)
        {
            Vec<ASR::call_arg_t> args_;
            args_.reserve(al, 2);
            visit_expr_list(al, args, args_);
            return ASRUtils::EXPR(ASRUtils::make_FunctionCall_t_util(
                al, loc, s, s, args_.p, args_.size(), return_type, nullptr, nullptr));
        }

        ASR::expr_t* Call(ASR::symbol_t* s,
                          Vec<ASR::call_arg_t>& args,
                          ASR::ttype_t* return_type,
                          ASR::expr_t* value)
        {
            return ASRUtils::EXPR(ASRUtils::make_FunctionCall_t_util(
                al, loc, s, s, args.p, args.size(), return_type, value, nullptr));
        }

// Statements --------------------------------------------------------------
#define Return() STMT(ASR::make_Return_t(al, loc))
#define Assignment(lhs, rhs) ASRUtils::STMT(ASR::make_Assignment_t(al, loc, lhs, rhs, nullptr))

        template <typename LOOP_BODY>
        ASR::stmt_t* create_do_loop(const Location& loc,
                                    int rank,
                                    ASR::expr_t* array,
                                    SymbolTable* scope,
                                    ...
                                    LOOP_BODY loop_body)
        {
            ...
            for (int i = (int) idx_vars.size() - 1; i >= 0; i--) {
                ...
                doloop = ASRUtils::STMT(
                    ASR::make_DoLoop_t(al, loc, nullptr, head, doloop_body.p, doloop_body.size()));
            }
            return doloop;
        }
                                                                  ...
                                                                  LOOP_BODY loop_body)
        {
            ...
            ASR::stmt_t* doloop
                = create_do_loop(loc, rank, array, fn_scope, idx_vars, doloop_body, loop_body);
        ...
        void generate_reduction_intrinsic_stmts_for_array_output(const Location& loc,
                                                                 ...
                                                                 Vec<ASR::stmt_t*>& fn_body,
                                                                 Vec<ASR::expr_t*>& idx_vars,
                                                                 Vec<ASR::expr_t*>& target_idx_vars,
                                                                 Vec<ASR::stmt_t*>& doloop_body,
                                                                 INIT init_stmts,
                                                                 LOOP_BODY loop_body)
        {
            ...
            for (int i = 1; i <= n_dims; i++) {
                ...
                ASR::expr_t* test_expr = make_Compare(make_IntegerCompare_t, dim, Eq, current_dim);
                ...
                ASR::stmt_t* doloop
                    = create_do_loop(loc, array, loop_vars, loop_dims, doloop_body, loop_body);
                Vec<ASR::stmt_t*> if_body;
                if_body.reserve(al, 1);
                if_body.push_back(al, doloop);
                ASR::stmt_t* if_ = ASRUtils::STMT(
                    ASR::make_If_t(al, loc, test_expr, if_body.p, if_body.size(), else_, else_n));
    ...
    namespace UnaryIntrinsicFunction
    {
                                                         ...
                                                         ASR::expr_t* value)
        {
...

            {
                ...
                {
                    args_1.reserve(al, 1);
                    ASR::expr_t* arg = b.Variable(
                        fn_symtab_1, "x", arg_type, ASR::intentType::In, ASR::abiType::BindC, true);
                    args_1.push_back(al, arg);
                }

                ASR::expr_t* return_var_1 = b.Variable(fn_symtab_1,
                                                       c_func_name,
                                                       arg_type,
                ...
                SetChar dep_1;
                dep_1.reserve(al, 1);
                Vec<ASR::stmt_t*> body_1;
                body_1.reserve(al, 1);
                ASR::symbol_t* s = make_Function_t(c_func_name,
                                                   fn_symtab_1,
                                                   dep_1,
                                                   args_1,
                                                   body_1,
            ...
            ASR::symbol_t* new_symbol = make_Function_t(
                fn_name, fn_symtab, dep, args, body, result, Source, Implementation, nullptr);
            scope->add_symbol(fn_name, new_symbol);
            return b.Call(new_symbol, new_args, arg_type, value);
        }

        static inline ASR::asr_t* create_UnaryFunction(Allocator& al,
                                                       const Location& loc,
                                                       Vec<ASR::expr_t*>& args,
                                                       eval_intrinsic_function eval_function,
                                                       ...
                                                       ASR::ttype_t* type)
        {
            ...
            return ASRUtils::make_IntrinsicFunction_t_util(
                al, loc, intrinsic_id, args.p, args.n, overload_id, type, value);
        }
                                                         ...
                                                         SymbolTable* scope)
        {
            ...
            body.push_back(al,
                           b.If(iEq(pat_len, i32(0)),
                                { Assignment(result, i32(0)), Return() },
                                { b.If(iEq(s_len, i32(0)), { Return() }, {}) }));
            body.push_back(
                al,
                Assignment(lps, EXPR(ASR::make_ListConstant_t(al, loc, nullptr, 0, List(int32)))));
            body.push_back(al, Assignment(i, i32(0)));
            body.push_back(al,
                           b.While(iLtE(i, iSub(pat_len, i32(1))),
                                   { Assignment(i, iAdd(i, i32(1))), ListAppend(lps, i32(0)) }));
                ...
                b.While(iLt(i, pat_len),
                        { b.If(sEq(StringItem(args[1], iAdd(i, i32(1))),
                               ...
                               { b.If(iNotEq(pi_len, i32(0)),
                                      { Assignment(pi_len,
                                                   ListItem(lps, iSub(pi_len, i32(1)), int32)) },
                                      { Assignment(i, iAdd(i, i32(1))) }) }) }));
            ...
            body.push_back(
                al,
                b.While(
                    And(iGtE(iSub(s_len, i), iSub(pat_len, j)), Not(flag)),
                    { b.If(sEq(StringItem(args[1], iAdd(j, i32(1))),
                               StringItem(args[0], iAdd(i, i32(1)))),
                           { Assignment(i, iAdd(i, i32(1))), Assignment(j, iAdd(j, i32(1))) },
                           {}),
                      b.If(iEq(j, pat_len),
            ...
            ASR::symbol_t* fn_sym = make_Function_t(
                fn_name, fn_symtab, dep, args, body, result, Source, Implementation, nullptr);
                                       ...
                                       diag::Diagnostics& diagnostics)
        {
            ...
            ASRUtils::require_impl(
                ASRUtils::check_equal_type(input_type, output_type, true),
                "The input and output type of elemental intrinsics must exactly match, input type: "
                    + ASRUtils::get_type_code(input_type)
                    + " output type: " + ASRUtils::get_type_code(output_type),
                loc,
                diagnostics);
        }
...
#define instantiate_UnaryFunctionArgs                                                              \
    Allocator &al, const Location &loc, SymbolTable *scope, Vec<ASR::ttype_t*>&arg_types,          \
...
#define instantiate_UnaryFunctionBody(Y)                                                           \
    ...
    return UnaryIntrinsicFunction::instantiate_functions(                                          \
        al, loc, scope, #Y, arg_type, new_args, overload_id, compile_time_value);

    namespace LogGamma
    {

        static inline ASR::expr_t* eval_log_gamma(Allocator& al,
                                                  const Location& loc,
                                                  Vec<ASR::expr_t*>& args)
        {
        ...
        static inline ASR::asr_t* create_LogGamma(
            Allocator& al,
            const Location& loc,
            Vec<ASR::expr_t*>& args,
            const std::function<void(const std::string&, const Location&)> err)
        {
            ...
            if (!ASRUtils::is_real(*type)) {
                err("`x` argument of `log_gamma` must be real", args[0]->base.loc);
            }

            return UnaryIntrinsicFunction::create_UnaryFunction(
                al,
                loc,
                args,
                eval_log_gamma,
                static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::LogGamma),
                0,
                type);
        }
...
#define create_trig(X, stdeval, lcompilers_name)                                                   \
    ...
    {                                                                                              \
        ...
        {                                                                                          \
            ...
            if (ASRUtils::extract_value(args[0], rv)) {                                            \
                ...
                if (ASRUtils::extract_value(args[0], crv)) {                                       \
                    ...
                    return ASRUtils::EXPR(                                                         \
                        ASR::make_ComplexConstant_t(al, loc, val.real(), val.imag(), t));          \
                }                                                                                  \
            }                                                                                      \
            return nullptr;                                                                        \
        }                                                                                          \
        static inline ASR::asr_t* create_##X(                                                      \
            Allocator& al,                                                                         \
            const Location& loc,                                                                   \
            Vec<ASR::expr_t*>& args,                                                               \
            const std::function<void(const std::string&, const Location&)> err)                    \
        {                                                                                          \
            ...
            if (!ASRUtils::is_real(*type) && !ASRUtils::is_complex(*type)) {                       \
                err("`x` argument of `" #X "` must be real or complex", args[0]->base.loc);        \
            }                                                                                      \
            return UnaryIntrinsicFunction::create_UnaryFunction(                                   \
                al,                                                                                \
                loc,                                                                               \
                args,                                                                              \
                eval_##X,                                                                          \
                static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::X),                       \
                0,                                                                                 \
                type);                                                                             \
        }                                                                                          \
        ...
        {                                                                                          \
            LCOMPILERS_ASSERT(arg_types.size() == 1);                                              \
            ASR::ttype_t* arg_type = arg_types[0];                                                 \
            return UnaryIntrinsicFunction::instantiate_functions(al,                               \
                                                                 loc,                              \
                                                                 scope,                            \
                                                                 #lcompilers_name,                 \
                                                                 arg_type,                         \
    ...
    create_trig(Sin, sin, sin) create_trig(Cos, cos, cos) create_trig(Tan, tan, tan)
        create_trig(Asin, asin, asin) create_trig(Acos, acos, acos) create_trig(Atan, atan, atan)
            create_trig(Sinh, sinh, sinh) create_trig(Cosh, cosh, cosh)
                    ...
                    namespace Abs
    {
                                       ...
                                       diag::Diagnostics& diagnostics)
        {
            ...
            if (ASR::is_a<ASR::Complex_t>(*ASRUtils::type_get_past_pointer(input_type))) {
                ASRUtils::require_impl(
                    ASR::is_a<ASR::Real_t>(*output_type),
                    "Abs intrinsic must return output of real for complex input, found: "
                        + output_type_str,
                    loc,
                    diagnostics);
                ...
                ASRUtils::require_impl(
                    ...
                    "The input and output type of Abs intrinsic must be of same kind, input kind: "
                        + std::to_string(input_kind)
                        + " output kind: " + std::to_string(output_kind),
                    loc,
                    diagnostics);
                ASR::dimension_t *input_dims, *output_dims;
                size_t input_n_dims
                    = ASRUtils::extract_dimensions_from_ttype(input_type, input_dims);
                size_t output_n_dims
                    = ASRUtils::extract_dimensions_from_ttype(output_type, output_dims);
                ASRUtils::require_impl(
                    ASRUtils::dimensions_equal(
                        input_dims, input_n_dims, output_dims, output_n_dims),
                    "The dimensions of input and output arguments of Abs intrinsic must be same, input: "
                        + input_type_str + " output: " + output_type_str,
                    loc,
                    diagnostics);
            } else {
                ASRUtils::require_impl(
                    ASRUtils::check_equal_type(input_type, output_type, true),
                    "The input and output type of elemental intrinsics must exactly match, input type: "
                        + input_type_str + " output type: " + output_type_str,
                    loc,
                    diagnostics);
            }
        }
        ...
        static inline ASR::asr_t* create_Abs(
            Allocator & al,
            const Location& loc,
            Vec<ASR::expr_t*>& args,
            const std::function<void(const std::string&, const Location&)> err)
        {
            ...
            if (is_complex(*type)) {
                type = TYPE(ASR::make_Real_t(
                    al, type->base.loc, ASRUtils::extract_kind_from_ttype_t(type)));
            }
            return UnaryIntrinsicFunction::create_UnaryFunction(
                al,
                loc,
        ...
        static inline ASR::expr_t* instantiate_Abs(Allocator & al,
                                                   const Location& loc,
                                                   SymbolTable* scope,
                                                   Vec<ASR::ttype_t*>& arg_types,
                                                   Vec<ASR::call_arg_t>& new_args,
                                                   ...
                                                   ASR::expr_t* compile_time_value)
        {
            ...
            if (is_integer(*arg_types[0]) || is_real(*arg_types[0])) {
                ...
                if (is_integer(*arg_types[0])) {
                    ASR::expr_t* zero
                        = make_ConstantWithType(make_IntegerConstant_t, 0, arg_types[0], loc);
                    test = make_Compare(make_IntegerCompare_t, args[0], GtE, zero);
                    negative_x = EXPR(
                        ASR::make_IntegerUnaryMinus_t(al, loc, args[0], arg_types[0], nullptr));
                } else {
                    ASR::expr_t* zero
                        = make_ConstantWithType(make_RealConstant_t, 0.0, arg_types[0], loc);
                    test = make_Compare(make_RealCompare_t, args[0], GtE, zero);
                    negative_x
                        = EXPR(ASR::make_RealUnaryMinus_t(al, loc, args[0], arg_types[0], nullptr));
                }
                ...
                body.push_back(al,
                               STMT(ASR::make_If_t(
                                   al, loc, test, if_body.p, if_body.n, else_body.p, else_body.n)));
            } else {
                // * Complex type: `r = (real(x)**2 + aimag(x)**2)**0.5`
                ASR::ttype_t* real_type = TYPE(
                    ASR::make_Real_t(al, loc, ASRUtils::extract_kind_from_ttype_t(arg_types[0])));
                ...
                ASR::expr_t* aimag_of_x;
                {
                    ...
                    {
                        args_1.reserve(al, 1);
                        auto arg = b.Variable(fn_symtab_1,
                                              "x",
                                              arg_types[0],
                                              ASR::intentType::In,
                                              ASR::abiType::BindC,
                    ...
                    auto return_var_1 = b.Variable(fn_symtab_1,
                                                   c_func_name,
                                                   real_type,
                ...
                ASR::expr_t* constant_two
                    = make_ConstantWithType(make_RealConstant_t, 2.0, real_type, loc);
                ASR::expr_t* constant_point_five
                    = make_ConstantWithType(make_RealConstant_t, 0.5, real_type, loc);
                ASR::expr_t* real_of_x = EXPR(ASR::make_Cast_t(
                    al, loc, args[0], ASR::cast_kindType::ComplexToReal, real_type, nullptr));
                ...
                body.push_back(
                    al, Assignment(result, b.ElementalPow(bin_op_1, constant_point_five, loc)));
            }

            ASR::symbol_t* f_sym = make_Function_t(
                func_name, fn_symtab, dep, args, body, result, Source, Implementation, nullptr);
    ...
    namespace Sign
    {
        ...
        static ASR::expr_t* eval_Sign(Allocator& al, const Location& loc, Vec<ASR::expr_t*>& args)
        {
        ...
        static inline ASR::asr_t* create_Sign(
            Allocator& al,
            const Location& loc,
            Vec<ASR::expr_t*>& args,
            const std::function<void(const std::string&, const Location&)> err)
        {
            ...
            if (!ASRUtils::is_integer(*type1) && !ASRUtils::is_real(*type1)) {
                err("Argument of the sign function must be Integer or Real", args[0]->base.loc);
            }
            ...
            return ASR::make_IntrinsicFunction_t(
                al,
                loc,
                static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Sign),
                args.p,
                args.n,
                0,
        ...
        static inline ASR::expr_t* instantiate_Sign(Allocator& al,
                                                    const Location& loc,
                                                    SymbolTable* scope,
                                                    Vec<ASR::ttype_t*>& arg_types,
                                                    Vec<ASR::call_arg_t>& new_args,
                                                    ...
                                                    ASR::expr_t* compile_time_value)
        {
            ...
            if (is_real(*arg_types[0])) {
                ...
                body.push_back(
                    al,
                    b.If(fGtE(args[0], zero),
                         { Assignment(result, args[0]) },
                         /* else */ { Assignment(result, f32_neg(args[0], arg_types[0])) }));
                body.push_back(al,
                               b.If(fLt(args[1], zero),
                ...
                body.push_back(
                    al,
                    b.If(iGtE(args[0], zero),
                         { Assignment(result, args[0]) },
                         /* else */ { Assignment(result, i32_neg(args[0], arg_types[0])) }));
                body.push_back(al,
                               b.If(iLt(args[1], zero),
...
#define create_exp_macro(X, stdeval)                                                               \
    ...
    {                                                                                              \
        ...
        {                                                                                          \
            ...
            ASR::ttype_t* type = ASRUtils::expr_type(args[0]);                                     \
            if (!ASRUtils::is_real(*type)) {                                                       \
                err("Argument of the `" #X "` function must be either Real", args[0]->base.loc);   \
            }                                                                                      \
            return UnaryIntrinsicFunction::create_UnaryFunction(                                   \
                al,                                                                                \
                loc,                                                                               \
    ...
    create_exp_macro(Exp, exp) create_exp_macro(Exp2, exp2) create_exp_macro(Expm1, expm1)
        ...
        namespace ListIndex
    {
        static inline void verify_args(const ASR::IntrinsicFunction_t& x,
                                       diag::Diagnostics& diagnostics)
        {
            ASRUtils::require_impl(x.n_args <= 4,
                                   "Call to list.index must have at most four arguments",
                                   x.base.base.loc,
                                   diagnostics);
            ASRUtils::require_impl(
                ASR::is_a<ASR::List_t>(*ASRUtils::expr_type(x.m_args[0]))
                    && ASRUtils::check_equal_type(
                        ASRUtils::expr_type(x.m_args[1]),
                ...
                diagnostics);
            if (x.n_args >= 3) {
                ASRUtils::require_impl(ASR::is_a<ASR::Integer_t>(*ASRUtils::expr_type(x.m_args[2])),
                                       "Third argument to list.index must be an integer",
                                       x.base.base.loc,
                                       diagnostics);
            }
            if (x.n_args == 4) {
                ASRUtils::require_impl(ASR::is_a<ASR::Integer_t>(*ASRUtils::expr_type(x.m_args[3])),
        ...
        static inline ASR::expr_t* eval_list_index(
        ...
        static inline ASR::asr_t* create_ListIndex(
            Allocator & al,
            const Location& loc,
            Vec<ASR::expr_t*>& args,
            const std::function<void(const std::string&, const Location&)> err)
        {
            ...
            if (!ASRUtils::check_equal_type(ele_type, list_type)) {
                ...
                err("Type mismatch in 'index', the types must be compatible "
                    "(found: '"
                        + fnd + "', expected: '" + org + "')",
                    loc);
            }
            ...
            return ASR::make_IntrinsicFunction_t(
                al,
                loc,
                static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::ListIndex),
                args.p,
                args.size(),
                overload_id,
                to_type,
    ...
    namespace ListReverse
    {
        ...
        {
            ASRUtils::require_impl(x.n_args == 1,
                                   "Call to list.reverse must have exactly one argument",
                                   x.base.base.loc,
                                   diagnostics);
        ...
        static inline ASR::asr_t* create_ListReverse(
            Allocator& al,
            const Location& loc,
            Vec<ASR::expr_t*>& args,
            const std::function<void(const std::string&, const Location&)> err)
        {
            ...
            return ASR::make_Expr_t(
                al,
                loc,
                ASRUtils::EXPR(ASRUtils::make_IntrinsicFunction_t_util(
                    al,
                    loc,
                    static_cast<int64_t>(ASRUtils::IntrinsicImpureFunctions::ListReverse),
                    args.p,
                    args.size(),
                    0,
                    nullptr,
    ...
    namespace ListPop
    {
        ...
        {
            ASRUtils::require_impl(x.n_args <= 2,
                                   "Call to list.pop must have at most one argument",
                                   x.base.base.loc,
                                   diagnostics);
            ASRUtils::require_impl(ASR::is_a<ASR::List_t>(*ASRUtils::expr_type(x.m_args[0])),
            ...
            ASRUtils::require_impl(
                ASRUtils::check_equal_type(
                    x.m_type, ASRUtils::get_contained_type(ASRUtils::expr_type(x.m_args[0]))),
        ...
        static inline ASR::asr_t* create_ListPop(
            Allocator& al,
            const Location& loc,
            Vec<ASR::expr_t*>& args,
            const std::function<void(const std::string&, const Location&)> err)
        {
            ...
            if (args.size() == 2 && !ASR::is_a<ASR::Integer_t>(*ASRUtils::expr_type(args[1]))) {
            ...
            return ASR::make_IntrinsicFunction_t(
                al,
                loc,
                static_cast<int64_t>(ASRUtils::IntrinsicImpureFunctions::ListPop),
                args.p,
                args.size(),
                overload_id,
                to_type,
    ...
    namespace Any
    {
        ...
        static inline void verify_array(ASR::expr_t* array,
                                        ASR::ttype_t* return_type,
                                        const Location& loc,
                                        diag::Diagnostics& diagnostics)
        {
            ...
            ASRUtils::require_impl(ASRUtils::is_logical(*array_type),
                                   "Input to Any intrinsic must be of logical type, found: "
                                       + ASRUtils::get_type_code(array_type),
                                   loc,
                                   diagnostics);
            int array_n_dims = ASRUtils::extract_n_dims_from_ttype(array_type);
            ASRUtils::require_impl(array_n_dims > 0,
                                   "Input to Any intrinsic must always be an array",
                                   loc,
                                   diagnostics);
            ASRUtils::require_impl(ASRUtils::is_logical(*return_type),
                                   "Any intrinsic must return a logical output",
                                   loc,
                                   diagnostics);
        ...
        static inline void verify_array_dim(ASR::expr_t* array,
                                            ASR::expr_t* dim,
                                            ASR::ttype_t* return_type,
                                            const Location& loc,
                                            diag::Diagnostics& diagnostics)
        {
            ASR::ttype_t* array_type = ASRUtils::expr_type(array);
            ASRUtils::require_impl(
                ASRUtils::is_logical(*ASRUtils::type_get_past_pointer(array_type)),
                "Input to Any intrinsic must be of logical type, found: "
                    + ASRUtils::get_type_code(array_type),
                loc,
                diagnostics);
            ...
            ASRUtils::require_impl(ASR::is_a<ASR::Integer_t>(
                                       *ASRUtils::type_get_past_pointer(ASRUtils::expr_type(dim))),
                                   "dim argument must be an integer",
                                   loc,
                                   diagnostics);
        ...
        {
            ASRUtils::require_impl(x.n_args >= 1,
                                   "Any intrinsic must accept at least one argument",
                                   x.base.base.loc,
                                   diagnostics);
            ASRUtils::require_impl(x.m_args[0] != nullptr,
                                   "Array argument to any intrinsic cannot be nullptr",
                                   x.base.base.loc,
                                   diagnostics);
            switch (x.m_overload_id) {
                case 0: {
                ...
                case 1: {
                    ASRUtils::require_impl(x.n_args == 2 && x.m_args[1] != nullptr,
                                           ...
                                           diagnostics);
                    verify_array_dim(
                        x.m_args[0], x.m_args[1], x.m_type, x.base.base.loc, diagnostics);
                    break;
                }
                default: {
                    require_impl(false,
                                 "Unrecognised overload id in Any intrinsic",
                                 x.base.base.loc,
                                 diagnostics);
                }
            }
            ...
            const std::function<void(const std::string&, const Location&)> err)
        {
            ...
            if (axis == nullptr) {
                ...
                if (dims.size() > 0) {
                    logical_return_type = ASRUtils::make_Array_t_util(
                        al,
                        loc,
                        ASRUtils::TYPE(ASR::make_Logical_t(al, loc, 4)),
                        dims.p,
        ...
        static inline void generate_body_for_scalar_output(Allocator& al,
                                                           const Location& loc,
                                                           ASR::expr_t* array,
                                                           ...
                                                           Vec<ASR::stmt_t*>& fn_body)
        {
            ...
            Vec<ASR::expr_t*> idx_vars;
            Vec<ASR::stmt_t*> doloop_body;
            builder.generate_reduction_intrinsic_stmts_for_scalar_output(
                loc,
                array,
                fn_scope,
                fn_body,
        ...
        static inline void generate_body_for_array_output(Allocator& al,
                                                          const Location& loc,
                                                          ASR::expr_t* array,
                                                          ASR::expr_t* dim,
                                                          ASR::expr_t* result,
            ...
            builder.generate_reduction_intrinsic_stmts_for_array_output(
                ...
                [=, &al, &idx_vars, &target_idx_vars, &doloop_body, &result, &builder]() {
                    ASR::expr_t* result_ref
                        = PassUtils::create_array_ref(result, target_idx_vars, al);
                    ASR::expr_t* array_ref = PassUtils::create_array_ref(array, idx_vars, al);
                                                   ...
                                                   ASR::expr_t* compile_time_value)
        {
            ...
            std::string new_name = "any_" + std::to_string(kind) + "_" + std::to_string(rank) + "_"
            ...
            // Check if Function is already defined.
            {
                ...
                while (scope->get_symbol(new_func_name) != nullptr) {
                    ...
                    ASR::Function_t* f = ASR::down_cast<ASR::Function_t>(s);
                    int orig_array_rank
                        = ASRUtils::extract_n_dims_from_ttype(ASRUtils::expr_type(f->m_args[0]));
                    if (ASRUtils::types_equal(ASRUtils::expr_type(f->m_args[0]), arg_type)
                        && orig_array_rank == rank) {
            ...
            ASR::ttype_t* logical_return_type = ASRUtils::TYPE(ASR::make_Logical_t(al, loc, 4));
            Vec<ASR::expr_t*> args;
            int result_dims = 0;
            {
                args.reserve(al, 1);
            ...
            if (return_var) {
                new_symbol = make_Function_t(new_name,
                                             fn_symtab,
                                             dep,
                                             args,
                                             body,
                ...
                new_symbol = make_Function_Without_ReturnVar_t(
                    new_name, fn_symtab, dep, args, body, Source, Implementation, nullptr);
            }
            scope->add_symbol(new_name, new_symbol);
            return builder.Call(new_symbol, new_args, logical_return_type, compile_time_value);
        }
    ...
    namespace Max
    {
        ...
        {
            ASRUtils::require_impl(x.n_args > 1,
                                   "ASR Verify: Call to max0 must have at least two arguments",
                                   x.base.base.loc,
                                   diagnostics);
            ASRUtils::require_impl(
            ...
            for (size_t i = 0; i < x.n_args; i++) {
                ASRUtils::require_impl(
                    (ASR::is_a<ASR::Real_t>(*ASRUtils::expr_type(x.m_args[i]))
                     && ASR::is_a<ASR::Real_t>(*ASRUtils::expr_type(x.m_args[0])))
        ...
        static ASR::expr_t* eval_Max(Allocator& al, const Location& loc, Vec<ASR::expr_t*>& args)
        {
            ...
            if (ASR::is_a<ASR::Real_t>(*arg_type)) {
                ...
                return ASR::down_cast<ASR::expr_t>(
                    ASR::make_RealConstant_t(al, loc, max_val, arg_type));
                ...
                return ASR::down_cast<ASR::expr_t>(
                    ASR::make_IntegerConstant_t(al, loc, max_val, arg_type));
            } else {
                return nullptr;
            }
        }
            ...
            const std::function<void(const std::string&, const Location&)> err)
        {
            ...
            if (is_compile_time) {
                ...
                return ASR::make_IntrinsicFunction_t(
                    al,
                    loc,
                    static_cast<int64_t>(ASRUtils::IntrinsicArrayFunctions::Max),
                    args.p,
                    args.n,
                    0,
                    ASRUtils::expr_type(args[0]),
        ...
        static inline ASR::expr_t* instantiate_Max(Allocator& al,
                                                   const Location& loc,
                                                   SymbolTable* scope,
                                                   Vec<ASR::ttype_t*>& arg_types,
                                                   Vec<ASR::call_arg_t>& new_args,
                                                   ...
                                                   ASR::expr_t* compile_time_value)
        {
            ...
            for (size_t i = 1; i < args.size(); i++) {
                ...
                body.push_back(
                    al, STMT(ASR::make_If_t(al, loc, test, if_body.p, if_body.n, nullptr, 0)));
            }
            ASR::symbol_t* f_sym = make_Function_t(
                fn_name, fn_symtab, dep, args, body, result, Source, Implementation, nullptr);
            scope->add_symbol(fn_name, f_sym);
    ...
    namespace Min
    {
        ...
        {
            ASRUtils::require_impl(x.n_args > 1,
                                   "ASR Verify: Call to min0 must have at least two arguments",
                                   x.base.base.loc,
                                   diagnostics);
            ASRUtils::require_impl(
                ASR::is_a<ASR::Real_t>(*ASRUtils::expr_type(x.m_args[0]))
        ...
        static ASR::expr_t* eval_Min(Allocator& al, const Location& loc, Vec<ASR::expr_t*>& args)
        {
            ...
            if (ASR::is_a<ASR::Real_t>(*arg_type)) {
                ...
                return ASR::down_cast<ASR::expr_t>(
                    ASR::make_RealConstant_t(al, loc, min_val, arg_type));
            } else if (ASR::is_a<ASR::Integer_t>(*arg_type)) {
                ...
                return ASR::down_cast<ASR::expr_t>(
                    ASR::make_IntegerConstant_t(al, loc, min_val, arg_type));
            } else {
                return nullptr;
            }
        }
            ...
            const std::function<void(const std::string&, const Location&)> err)
        {
            ...
            if (is_compile_time) {
                ...
                return ASR::make_IntrinsicFunction_t(
                    al,
                    loc,
                    static_cast<int64_t>(ASRUtils::IntrinsicArrayFunctions::Min),
                    args.p,
                    args.n,
                    0,
                    ASRUtils::expr_type(args[0]),
        ...
        static inline ASR::expr_t* instantiate_Min(Allocator& al,
                                                   const Location& loc,
                                                   SymbolTable* scope,
                                                   Vec<ASR::ttype_t*>& arg_types,
                                                   Vec<ASR::call_arg_t>& new_args,
    ...
    namespace ArrIntrinsic
    {
        ...
        static inline void verify_array_int_real_cmplx(
            ASR::expr_t* array,
            ASR::ttype_t* return_type,
            const Location& loc,
            diag::Diagnostics& diagnostics,
        ...
        {
            std::string intrinsic_func_name
                = ASRUtils::get_intrinsic_array_name(static_cast<int>(intrinsic_func_id));
            ASR::ttype_t* array_type = ASRUtils::expr_type(array);
            ASRUtils::require_impl(
                ASRUtils::is_integer(*array_type) || ASRUtils::is_real(*array_type)
                    || ASRUtils::is_complex(*array_type),
                "Input to " + intrinsic_func_name
                    + " intrinsic must be of integer, real or complex type, found: "
                    + ASRUtils::get_type_code(array_type),
                loc,
                diagnostics);
            int array_n_dims = ASRUtils::extract_n_dims_from_ttype(array_type);
            ASRUtils::require_impl(array_n_dims > 0,
                                   "Input to " + intrinsic_func_name
                                       + " intrinsic must always be an array",
                                   loc,
                                   diagnostics);
            ASRUtils::require_impl(
                ASRUtils::check_equal_type(return_type, array_type, false),
                intrinsic_func_name + " intrinsic must return an output of the same type as input",
                loc,
                diagnostics);
            int return_n_dims = ASRUtils::extract_n_dims_from_ttype(return_type);
            ASRUtils::require_impl(
                return_n_dims == 0,
                intrinsic_func_name
                    + " intrinsic output for array only input should be a scalar, found an array of "
                    + std::to_string(return_n_dims),
                loc,
                diagnostics);
        }

        static inline void verify_array_int_real(
            ASR::expr_t* array,
            ASR::ttype_t* return_type,
            const Location& loc,
            diag::Diagnostics& diagnostics,
            ASRUtils::IntrinsicArrayFunctions intrinsic_func_id)
        {
            ...
            ASRUtils::require_impl(ASRUtils::is_integer(*array_type)
                                   ...
                                   "Input to " + intrinsic_func_name
                                       + " intrinsic must be of integer or real type, found: "
                                       + ASRUtils::get_type_code(array_type),
                                   loc,
                                   diagnostics);
            int array_n_dims = ASRUtils::extract_n_dims_from_ttype(array_type);
                                            ...
                                            ASRUtils::IntrinsicArrayFunctions intrinsic_func_id)
        {
            ...
            ASRUtils::require_impl(array_n_dims == return_n_dims + 1,
                                   intrinsic_func_name
                                       + " intrinsic output must return an array with dimension "
                                         "only 1 less than that of input array",
                                   loc,
                                   diagnostics);
        }
        ...
        static inline void verify_args(const ASR::IntrinsicFunction_t& x,
                                       diag::Diagnostics& diagnostics,
                                       ASRUtils::IntrinsicArrayFunctions intrinsic_func_id,
                                       verify_array_func verify_array)
        {
            std::string intrinsic_func_name
                = ASRUtils::get_intrinsic_array_name(static_cast<int>(intrinsic_func_id));
            ASRUtils::require_impl(x.n_args >= 1,
                                   intrinsic_func_name
                                       + " intrinsic must accept at least one argument",
                                   x.base.base.loc,
                                   diagnostics);
            ASRUtils::require_impl(x.m_args[0] != nullptr,
                                   "Array argument to " + intrinsic_func_name
                                       + " intrinsic cannot be nullptr",
                                   x.base.base.loc,
                                   diagnostics);
            ...
            switch (x.m_overload_id) {
                ...
                case id_array_mask: {
                    if (x.m_overload_id == id_array_mask) {
                        ASRUtils::require_impl(x.n_args == 2 && x.m_args[1] != nullptr,
                                               "mask argument cannot be nullptr",
                                               x.base.base.loc,
                                               diagnostics);
                    }
                    verify_array(
                        x.m_args[0], x.m_type, x.base.base.loc, diagnostics, intrinsic_func_id);
                    break;
                }
                case id_array_dim:
                ...
                default: {
                    require_impl(false,
                                 "Unrecognised overload id in " + intrinsic_func_name
                                     + " intrinsic",
                                 x.base.base.loc,
                                 diagnostics);
                }
            ...
            if (x.m_overload_id == id_array_mask || x.m_overload_id == id_array_dim_mask) {
                ...
                size_t array_n_dims
                    = ASRUtils::extract_dimensions_from_ttype(array_type, array_dims);
                size_t mask_n_dims = ASRUtils::extract_dimensions_from_ttype(mask_type, mask_dims);
                ASRUtils::require_impl(
                    ASRUtils::dimensions_equal(array_dims, array_n_dims, mask_dims, mask_n_dims),
                    "The dimensions of array and mask arguments of " + intrinsic_func_name
                        + " intrinsic must be same",
                    x.base.base.loc,
                    diagnostics);
            }
        }
            ...
            ASRUtils::IntrinsicArrayFunctions intrinsic_func_id)
        {
            ...
            if (arg2 && !arg3) {
                ...
                if (arg2_rank != 0) {
                    err("dim argument to " + intrinsic_func_name
                            + " must be a scalar and must not be an array",
                        arg2->base.loc);
                }

                if (arg3_rank == 0) {
                    err("mask argument to " + intrinsic_func_name
                            + " must be an array and must not be a scalar",
                        arg3->base.loc);
                }
            ...
            if (overload_id == id_array || overload_id == id_array_mask) {
                return_type = ASRUtils::duplicate_type_without_dims(al, array_type, loc);
            ...
            return ASRUtils::make_IntrinsicFunction_t_util(al,
                                                           loc,
                                                           static_cast<int64_t>(intrinsic_func_id),
                                                           arr_intrinsic_args.p,
                                                           arr_intrinsic_args.n,
                                                           overload_id,
                                                           return_type,
                                                           value);
        }

        static inline void generate_body_for_array_input(
            Allocator& al,
            const Location& loc,
            ASR::expr_t* array,
            ASR::expr_t* return_var,
            ...
            builder.generate_reduction_intrinsic_stmts_for_scalar_output(
                ...
                [=, &al, &fn_body] {
                    ...
                    ASR::ttype_t* element_type
                        = ASRUtils::duplicate_type_without_dims(al, array_type, loc);
                ...
                [=, &al, &idx_vars, &doloop_body, &builder]() {
                    ASR::expr_t* array_ref = PassUtils::create_array_ref(array, idx_vars, al);
                    ASR::expr_t* elemental_operation_val
                        = (builder.*elemental_operation)(return_var, array_ref, loc, nullptr);
                    ASR::stmt_t* loop_invariant = Assignment(return_var, elemental_operation_val);
                    doloop_body.push_back(al, loop_invariant);
                });
        }

        static inline void generate_body_for_array_mask_input(
            Allocator& al,
            const Location& loc,
            ASR::expr_t* array,
            ASR::expr_t* mask,
            ...
            elemental_operation_func elemental_operation)
        {
            ...
            builder.generate_reduction_intrinsic_stmts_for_scalar_output(
                ...
                [=, &al, &idx_vars, &doloop_body, &builder]() {
                    ...
                    ASR::stmt_t* if_mask_ = ASRUtils::STMT(
                        ASR::make_If_t(al, loc, mask_ref, if_mask.p, if_mask.size(), nullptr, 0));
            ...
            elemental_operation_func elemental_operation)
        {
            ...
            builder.generate_reduction_intrinsic_stmts_for_array_output(
                ...
                [=, &al, &idx_vars, &target_idx_vars, &doloop_body, &builder, &result]() {
                    ...
                    ASR::expr_t* array_ref = PassUtils::create_array_ref(array, idx_vars, al);
                    ASR::expr_t* elemental_operation_val
                        = (builder.*elemental_operation)(result_ref, array_ref, loc, nullptr);
        ...
        static inline ASR::expr_t* instantiate_ArrIntrinsic(
            Allocator& al,
            const Location& loc,
            SymbolTable* scope,
            Vec<ASR::ttype_t*>& arg_types,
            ...
            elemental_operation_func elemental_operation)
        {
            ...
            int kind = ASRUtils::extract_kind_from_ttype_t(arg_type);
            int rank = ASRUtils::extract_n_dims_from_ttype(arg_type);
            std::string new_name = intrinsic_func_name + "_" + std::to_string(kind) + "_"
                                   + std::to_string(rank) + "_" + std::to_string(overload_id);
            // Check if Function is already defined.
            {
                std::string new_func_name = new_name;
                int i = 1;
            ...
            fill_func_arg("array", array_type) if (overload_id == id_array_dim
                                                   || overload_id == id_array_dim_mask)
            {
            ...
            if (overload_id == id_array_mask || overload_id == id_array_dim_mask) {
                ...
                ASR::ttype_t* mask_type
                    = ASRUtils::TYPE(ASR::make_Logical_t(al, arg_type->base.loc, 4));
                if (mask_dims.size() > 0) {
                    mask_type = ASRUtils::make_Array_t_util(
                        al, arg_type->base.loc, mask_type, mask_dims.p, mask_dims.size());
                }
                fill_func_arg("mask", mask_type)
            }
            ...
            ASR::ttype_t* return_type = nullptr;
            int result_dims = 0;
            if (overload_id == id_array_mask || overload_id == id_array) {
                return_type = ASRUtils::duplicate_type_without_dims(al, arg_type, loc);
            } else if (overload_id == id_array_dim_mask || overload_id == id_array_dim) {
                Vec<ASR::dimension_t> dims;
                size_t n_dims = ASRUtils::extract_n_dims_from_ttype(arg_type);
                dims.reserve(al, (int) n_dims - 1);
                for (int i = 0; i < (int) n_dims - 1; i++) {
            ...
            if (overload_id == id_array) {
                generate_body_for_array_input(al,
                                              loc,
                                              args[0],
                                              output_var,
                                              fn_symtab,
                ...
                generate_body_for_array_dim_input(al,
                                                  loc,
                                                  args[0],
                                                  args[1],
                                                  output_var,
                ...
                generate_body_for_array_dim_mask_input(al,
                                                       loc,
                                                       args[0],
                                                       args[1],
                                                       args[2],
                ...
                generate_body_for_array_mask_input(al,
                                                   loc,
                                                   args[0],
                                                   args[1],
                                                   output_var,
            ...
            scope->add_symbol(new_name, new_symbol);
            return builder.Call(new_symbol, new_args, return_type, compile_time_value);
        }
    ...
    namespace Sum
    {
        ...
        static inline ASR::asr_t* create_Sum(
            ...
            const std::function<void(const std::string&, const Location&)> err)
        {
            return ArrIntrinsic::create_ArrIntrinsic(
                al, loc, args, err, ASRUtils::IntrinsicArrayFunctions::Sum);
        }
        ...
        static inline ASR::expr_t* instantiate_Sum(Allocator& al,
                                                   ...
                                                   ASR::expr_t* compile_time_value)
        {
            return ArrIntrinsic::instantiate_ArrIntrinsic(
                al,
                loc,
                scope,
                arg_types,
                ...
                compile_time_value,
                ASRUtils::IntrinsicArrayFunctions::Sum,
                &ASRUtils::get_constant_zero_with_given_type,
                &ASRUtils::ASRBuilder::ElementalAdd);
        }
    ...
    namespace Product
    {
                                       ...
                                       diag::Diagnostics& diagnostics)
        {
            ArrIntrinsic::verify_args(x,
                                      diagnostics,
                                      ASRUtils::IntrinsicArrayFunctions::Product,
                                      &ArrIntrinsic::verify_array_int_real_cmplx);
        }
        ...
        {
            return ArrIntrinsic::create_ArrIntrinsic(
                al, loc, args, err, ASRUtils::IntrinsicArrayFunctions::Product);
        }
                                                       ...
                                                       ASR::expr_t* compile_time_value)
        {
            return ArrIntrinsic::instantiate_ArrIntrinsic(
                ...
                compile_time_value,
                ASRUtils::IntrinsicArrayFunctions::Product,
                &ASRUtils::get_constant_one_with_given_type,
                &ASRUtils::ASRBuilder::ElementalMul);
        }
    ...
    namespace MaxVal
    {
                                       ...
                                       diag::Diagnostics& diagnostics)
        {
            ArrIntrinsic::verify_args(x,
                                      diagnostics,
                                      ASRUtils::IntrinsicArrayFunctions::MaxVal,
        ...
        {
            return ArrIntrinsic::create_ArrIntrinsic(
                al, loc, args, err, ASRUtils::IntrinsicArrayFunctions::MaxVal);
        }
                                                      ...
                                                      ASR::expr_t* compile_time_value)
        {
            return ArrIntrinsic::instantiate_ArrIntrinsic(
                ...
                compile_time_value,
                ASRUtils::IntrinsicArrayFunctions::MaxVal,
                &ASRUtils::get_minimum_value_with_given_type,
    ...
    namespace MinVal
    {
                                       ...
                                       diag::Diagnostics& diagnostics)
        {
            ArrIntrinsic::verify_args(x,
                                      diagnostics,
                                      ASRUtils::IntrinsicArrayFunctions::MinVal,
                                      &ArrIntrinsic::verify_array_int_real);
        }
        ...
        {
            return ArrIntrinsic::create_ArrIntrinsic(
                al, loc, args, err, ASRUtils::IntrinsicArrayFunctions::MinVal);
        }
                                                      ...
                                                      ASR::expr_t* compile_time_value)
        {
            return ArrIntrinsic::instantiate_ArrIntrinsic(
                ...
                compile_time_value,
                ASRUtils::IntrinsicArrayFunctions::MinVal,
                &ASRUtils::get_maximum_value_with_given_type,
                &ASRUtils::ASRBuilder::ElementalMin);
        }
    ...
    namespace Partition
    {
        ...
        {
            ASRUtils::require_impl(x.n_args == 2,
                                   "Call to partition must have exactly two arguments",
                                   x.base.base.loc,
                                   diagnostics);
            ASRUtils::require_impl(
        ...
        static inline ASR::expr_t* eval_Partition(Allocator& al,
                                                  const Location& loc,
                                                  std::string& s_var,
                                                  std::string& sep)
        {
            /*
                ...
                (if separator exist)           tuple:   (left of separator, separator, right of
               separator) (if separator does not exist)  tuple:   (string, "", "") res_tuple_type:
               stores the type of each expression present in resulting 3-tuple
            */
            ASRBuilder b(al, loc);
        ...
        static inline ASR::asr_t* create_partition(
            Allocator& al,
            const Location& loc,
            Vec<ASR::expr_t*>& args,
            ASR::expr_t* s_var,
            const std::function<void(const std::string&, const Location&)> err)
        {
            ...
            return ASRUtils::make_IntrinsicFunction_t_util(
                al,
                loc,
                static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Partition),
                e_args.p,
                e_args.n,
                0,
                return_type,
                                                         ...
                                                         ASR::expr_t* compile_time_value)
        {
            ...
            body.push_back(
                al,
                Assignment(index,
                           b.Call(UnaryIntrinsicFunction::create_KMP_function(al, loc, scope),
                                  args,
                                  int32)));
            body.push_back(
                al,
                b.If(iEq(index, i32_n(-1)),
                     { Assignment(
                         result,
                         b.TupleConstant({ args[0],
                                           StringConstant("", character(0)),
                                           StringConstant("", character(0)) },
                                         b.Tuple({ character(-2), character(0), character(0) }))) },
                     { Assignment(result,
                                  b.TupleConstant({ StringSection(args[0], i32(0), index),
                                                    args[1],
                                                    StringSection(args[0],
                                                                  iAdd(index, StringLen(args[1])),
                                                                  StringLen(args[0])) },
                                                  return_type)) }));
            body.push_back(al, Return());
            ASR::symbol_t* fn_sym = make_Function_t(
    ...
    namespace Merge
    {
        ...
        static inline ASR::expr_t* eval_Merge(Allocator& /*al*/,
                                              const Location& /*loc*/,
                                              Vec<ASR::expr_t*>& args)
        {
                                       ...
                                       diag::Diagnostics& diagnostics)
        {
            ...
            if (tsource_ndims > 0 && fsource_ndims > 0) {
                ASRUtils::require_impl(
                    tsource_ndims == fsource_ndims,
                    "All arguments of `merge` should be of same rank and dimensions",
                    loc,
                    diagnostics);

                if (ASRUtils::extract_physical_type(tsource_type)
                        == ASR::array_physical_typeType::FixedSizeArray
                    && ASRUtils::extract_physical_type(fsource_type)
                           == ASR::array_physical_typeType::FixedSizeArray) {
                    ASRUtils::require_impl(
                        ASRUtils::get_fixed_size_of_array(tsource_mdims, tsource_ndims)
                            == ASRUtils::get_fixed_size_of_array(fsource_mdims, fsource_ndims),
                        "`tsource` and `fsource` arguments should have matching size",
                        loc,
                        diagnostics);
                }
            }
                ...
                if (tsource_ndims > 0 && fsource_ndims == 0) {
                    ...
                    result_type
                        = ASRUtils::duplicate_type(al,
                                                   tsource_type,
                                                   &mask_mdims_vec,
                                                   ASRUtils::extract_physical_type(mask_type),
                                                   true);
                                                     ...
                                                     ASR::expr_t* compile_time_value)
        {
            ...
            if (ASR::is_a<ASR::Character_t>(*tsource_type)) {
                ...
                tsource_char->m_len_expr = nullptr;
                fsource_char->m_len_expr = nullptr;
                tsource_char->m_len = -2;
                fsource_char->m_len = -2;
            }
...

            {
                ...
                body.push_back(
                    al,
                    STMT(ASR::make_If_t(
                        al, loc, mask_arg, if_body.p, if_body.n, else_body.p, else_body.n)));
            }
    ...
    namespace SymbolicSymbol
    {
        ...
        static inline ASR::asr_t* create_SymbolicSymbol(
            Allocator& al,
            const Location& loc,
            Vec<ASR::expr_t*>& args,
            const std::function<void(const std::string&, const Location&)> err)
        {
            ...
            if (!ASRUtils::is_character(*type)) {
                err("Argument of the Symbol function must be a Character", args[0]->base.loc);
            }
            ...
            return UnaryIntrinsicFunction::create_UnaryFunction(
                ...
                args,
                eval_SymbolicSymbol,
                static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicSymbol),
                0,
                to_type);
        }
...
#define create_symbolic_binary_macro(X)                                                            \
    ...
    {                                                                                              \
        ...
        {                                                                                          \
            ...
            ASRUtils::require_impl(ASR::is_a<ASR::SymbolicExpression_t>(*left_type)                \
                                   ...
                                   "Both arguments of `" #X                                        \
                                   "` must be of type SymbolicExpression",                         \
                                   x.base.base.loc,                                                \
                                   diagnostics);                                                   \
        }                                                                                          \
                                                                                                   \
    ...
    create_symbolic_binary_macro(SymbolicAdd) create_symbolic_binary_macro(SymbolicSub)
        create_symbolic_binary_macro(SymbolicMul) create_symbolic_binary_macro(SymbolicDiv)
            create_symbolic_binary_macro(SymbolicPow) create_symbolic_binary_macro(SymbolicDiff)
                ...
                namespace SymbolicPi
    {
        ...
        {
            ASRUtils::require_impl(
                x.n_args == 0, "SymbolicPi does not take arguments", x.base.base.loc, diagnostics);
        }

        static inline ASR::expr_t* eval_SymbolicPi(
            Allocator& /*al*/, const Location& /*loc*/, Vec<ASR::expr_t*>& /*args*/)
        {
            // TODO
            return nullptr;
        ...
        static inline ASR::asr_t* create_SymbolicPi(
            Allocator & al,
            const Location& loc,
            Vec<ASR::expr_t*>& args,
            const std::function<void(const std::string&, const Location&)> /*err*/)
        {
            ...
            return ASR::make_IntrinsicFunction_t(
                al,
                loc,
                static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicPi),
                nullptr,
                0,
                0,
                to_type,
    ...
    namespace SymbolicInteger
    {
        ...
        static inline ASR::asr_t* create_SymbolicInteger(
            Allocator& al,
            const Location& loc,
            Vec<ASR::expr_t*>& args,
            const std::function<void(const std::string&, const Location&)> /*err*/)
        {
            ...
            return UnaryIntrinsicFunction::create_UnaryFunction(
                ...
                loc,
                args,
                eval_SymbolicInteger,
                static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicInteger),
                0,
                to_type);
        }
    }  // namespace SymbolicInteger
...
#define create_symbolic_unary_macro(X)                                                             \
    ...
    {                                                                                              \
        ...
        {                                                                                          \
            const Location& loc = x.base.base.loc;                                                 \
            ASRUtils::require_impl(                                                                \
                x.n_args == 1, #X " must have exactly 1 input argument", loc, diagnostics);        \
                                                                                                   \
            ASR::ttype_t* input_type = ASRUtils::expr_type(x.m_args[0]);                           \
            ASRUtils::require_impl(ASR::is_a<ASR::SymbolicExpression_t>(*input_type),              \
                                   #X " expects an argument of type SymbolicExpression",           \
                                   loc,                                                            \
                                   diagnostics);                                                   \
        }                                                                                          \
                                                                                                   \
    ...
    create_symbolic_unary_macro(SymbolicSin) create_symbolic_unary_macro(SymbolicCos)
        create_symbolic_unary_macro(SymbolicLog) create_symbolic_unary_macro(SymbolicExp)
            create_symbolic_unary_macro(SymbolicAbs) create_symbolic_unary_macro(SymbolicExpand)


                namespace IntrinsicFunctionRegistry
    {
        static const std::map<int64_t, std::tuple<impl_function, verify_function>>&
            intrinsic_function_by_id_db
            = {
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::LogGamma),
                  ...
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Tan),
                    { &Tan::instantiate_Tan, &UnaryIntrinsicFunction::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Asin),
                    { &Asin::instantiate_Asin, &UnaryIntrinsicFunction::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Acos),
                    { &Acos::instantiate_Acos, &UnaryIntrinsicFunction::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Atan),
                    { &Atan::instantiate_Atan, &UnaryIntrinsicFunction::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Sinh),
                    { &Sinh::instantiate_Sinh, &UnaryIntrinsicFunction::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Cosh),
                    { &Cosh::instantiate_Cosh, &UnaryIntrinsicFunction::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Tanh),
                  ...
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Exp2),
                    { nullptr, &UnaryIntrinsicFunction::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Expm1),
                    { nullptr, &UnaryIntrinsicFunction::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Abs),
                  ...
                  { static_cast<int64_t>(ASRUtils::IntrinsicArrayFunctions::Product),
                  ...
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicAdd),
                    { nullptr, &SymbolicAdd::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicSub),
                    { nullptr, &SymbolicSub::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicMul),
                    { nullptr, &SymbolicMul::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicDiv),
                    { nullptr, &SymbolicDiv::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicPow),
                    { nullptr, &SymbolicPow::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicPi),
                    { nullptr, &SymbolicPi::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicInteger),
                    { nullptr, &SymbolicInteger::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicDiff),
                    { nullptr, &SymbolicDiff::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicExpand),
                    { nullptr, &SymbolicExpand::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicSin),
                    { nullptr, &SymbolicSin::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicCos),
                    { nullptr, &SymbolicCos::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicLog),
                    { nullptr, &SymbolicLog::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicExp),
                    { nullptr, &SymbolicExp::verify_args } },
                  { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicAbs),
                    { nullptr, &SymbolicAbs::verify_args } },
              };

        static const std::map<int64_t, std::string>& intrinsic_function_id_to_name = {
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::LogGamma), "log_gamma" },

            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Sin), "sin" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Cos), "cos" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Tan), "tan" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Asin), "asin" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Acos), "acos" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Atan), "atan" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Sinh), "sinh" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Cosh), "cosh" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Tanh), "tanh" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Abs), "abs" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Exp), "exp" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Exp2), "exp2" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Expm1), "expm1" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::ListIndex), "list.index" },
            { static_cast<int64_t>(ASRUtils::IntrinsicImpureFunctions::ListReverse),
              "list.reverse" },
            { static_cast<int64_t>(ASRUtils::IntrinsicImpureFunctions::ListPop), "list.pop" },
            { static_cast<int64_t>(ASRUtils::IntrinsicArrayFunctions::Any), "any" },
            { static_cast<int64_t>(ASRUtils::IntrinsicArrayFunctions::Sum), "sum" },
            { static_cast<int64_t>(ASRUtils::IntrinsicArrayFunctions::Product), "product" },
            { static_cast<int64_t>(ASRUtils::IntrinsicArrayFunctions::Max), "max" },
            { static_cast<int64_t>(ASRUtils::IntrinsicArrayFunctions::MaxVal), "maxval" },
            { static_cast<int64_t>(ASRUtils::IntrinsicArrayFunctions::Min), "min" },
            { static_cast<int64_t>(ASRUtils::IntrinsicArrayFunctions::MinVal), "minval" },
            { static_cast<int64_t>(ASRUtils::IntrinsicArrayFunctions::Merge), "merge" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::Sign), "sign" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicSymbol), "Symbol" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicAdd),
              "SymbolicAdd" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicSub),
              "SymbolicSub" },
            ...
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicPow),
              "SymbolicPow" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicPi), "pi" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicInteger),
              "SymbolicInteger" },
            { static_cast<int64_t>(ASRUtils::IntrinsicScalarFunctions::SymbolicDiff),
              "SymbolicDiff" },
        ...
        static const std::map<std::string,
                              std::tuple<create_intrinsic_function, eval_intrinsic_function>>&
            intrinsic_function_by_name_db
            = {
                  ...
                  { "list.reverse",
                    { &ListReverse::create_ListReverse, &ListReverse::eval_list_reverse } },
                  ...
                  { "Symbol",
                    { &SymbolicSymbol::create_SymbolicSymbol,
                      &SymbolicSymbol::eval_SymbolicSymbol } },
                  { "SymbolicAdd",
                    { &SymbolicAdd::create_SymbolicAdd, &SymbolicAdd::eval_SymbolicAdd } },
                  { "SymbolicSub",
                    { &SymbolicSub::create_SymbolicSub, &SymbolicSub::eval_SymbolicSub } },
                  { "SymbolicMul",
                    { &SymbolicMul::create_SymbolicMul, &SymbolicMul::eval_SymbolicMul } },
                  { "SymbolicDiv",
                    { &SymbolicDiv::create_SymbolicDiv, &SymbolicDiv::eval_SymbolicDiv } },
                  { "SymbolicPow",
                    { &SymbolicPow::create_SymbolicPow, &SymbolicPow::eval_SymbolicPow } },
                  { "pi", { &SymbolicPi::create_SymbolicPi, &SymbolicPi::eval_SymbolicPi } },
                  { "SymbolicInteger",
                    { &SymbolicInteger::create_SymbolicInteger,
                      &SymbolicInteger::eval_SymbolicInteger } },
                  { "diff",
                    { &SymbolicDiff::create_SymbolicDiff, &SymbolicDiff::eval_SymbolicDiff } },
                  { "expand",
                    { &SymbolicExpand::create_SymbolicExpand,
                      &SymbolicExpand::eval_SymbolicExpand } },
                  { "SymbolicSin",
                    { &SymbolicSin::create_SymbolicSin, &SymbolicSin::eval_SymbolicSin } },
                  { "SymbolicCos",
                    { &SymbolicCos::create_SymbolicCos, &SymbolicCos::eval_SymbolicCos } },
                  { "SymbolicLog",
                    { &SymbolicLog::create_SymbolicLog, &SymbolicLog::eval_SymbolicLog } },
                  { "SymbolicExp",
                    { &SymbolicExp::create_SymbolicExp, &SymbolicExp::eval_SymbolicExp } },
                  { "SymbolicAbs",
                    { &SymbolicAbs::create_SymbolicAbs, &SymbolicAbs::eval_SymbolicAbs } },
              };
        ...
        {
            ASRUtils::IntrinsicScalarFunctions scalar_id_
                = static_cast<ASRUtils::IntrinsicScalarFunctions>(id);
            ASRUtils::IntrinsicArrayFunctions array_id_
                = static_cast<ASRUtils::IntrinsicArrayFunctions>(id);
            return (scalar_id_ == ASRUtils::IntrinsicScalarFunctions::Abs
                    || scalar_id_ == ASRUtils::IntrinsicScalarFunctions::Cos
                    || scalar_id_ == ASRUtils::IntrinsicScalarFunctions::Gamma
                    || scalar_id_ == ASRUtils::IntrinsicScalarFunctions::LogGamma
                    || scalar_id_ == ASRUtils::IntrinsicScalarFunctions::Sin
                    || scalar_id_ == ASRUtils::IntrinsicScalarFunctions::Exp
                    || scalar_id_ == ASRUtils::IntrinsicScalarFunctions::Exp2
                    || scalar_id_ == ASRUtils::IntrinsicScalarFunctions::Expm1
                    || array_id_ == ASRUtils::IntrinsicArrayFunctions::Merge
                    || scalar_id_ == ASRUtils::IntrinsicScalarFunctions::SymbolicSymbol);
        }
        ...
        */
        static inline int get_dim_index(ASRUtils::IntrinsicArrayFunctions id)
        {
            if (id == ASRUtils::IntrinsicArrayFunctions::Any
                || id == ASRUtils::IntrinsicArrayFunctions::Sum
                || id == ASRUtils::IntrinsicArrayFunctions::Product
                || id == ASRUtils::IntrinsicArrayFunctions::MaxVal
                || id == ASRUtils::IntrinsicArrayFunctions::MinVal) {
                return 1;
            } else {
                LCOMPILERS_ASSERT(false);
            }
    ...
    enum class IntrinsicImpureFunction : int64_t {
        IsIostatEnd,
        IsIostatEor,
        // ...
    };
    ...
    namespace IsIostatEnd
    {
        ...
        static inline ASR::asr_t* create_IsIostatEnd(
            Allocator& al,
            const Location& loc,
            Vec<ASR::expr_t*>& args,
            const std::function<void(const std::string&, const Location&)> /*err*/)
        {
            ...
            return ASR::make_IntrinsicImpureFunction_t(
                al,
                loc,
                static_cast<int64_t>(ASRUtils::IntrinsicImpureFunction::IsIostatEnd),
                args.p,
                args.n,
                0,
                logical,
    ...
    namespace IsIostatEor
    {
        ...
        static inline ASR::asr_t* create_IsIostatEor(
            Allocator& al,
            const Location& loc,
            Vec<ASR::expr_t*>& args,
            const std::function<void(const std::string&, const Location&)> /*err*/)
        {
            ...
            return ASR::make_IntrinsicImpureFunction_t(
                al,
                loc,
                static_cast<int64_t>(ASRUtils::IntrinsicImpureFunction::IsIostatEor),
                args.p,
                args.n,
                0,
                logical,
...
#define IMPURE_INTRINSIC_NAME_CASE(X)                                                              \
    case (static_cast<int64_t>(ASRUtils::IntrinsicImpureFunction::X)): {                           \
        return #X;                                                                                 \
    }
