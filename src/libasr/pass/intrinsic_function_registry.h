...
namespace IntrinsicElementalFunctionRegistry {
    ...
    inline const std::map<int64_t,
        std::tuple<impl_function,
                   ...
                   eval_intrinsic_function>>& get_intrinsic_function_by_id_db() {
        static const std::map<int64_t,
            std::tuple<impl_function,
                       verify_function,
                       create_intrinsic_function,
                       eval_intrinsic_function>> intrinsic_function_by_id_db = {
        {static_cast<int64_t>(IntrinsicElementalFunctions::ObjectType),
            {nullptr, &ObjectType::verify_args, &ObjectType::create_ObjectType, &ObjectType::eval_ObjectType}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Gamma),
            {&Gamma::instantiate_Gamma, &Gamma::verify_args, &Gamma::create_Gamma, &Gamma::eval_Gamma}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Log10),
            {&Log10::instantiate_Log10, &Log10::verify_args, &Log10::create_Log10, &Log10::eval_Log10}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::LogGamma),
            {&LogGamma::instantiate_LogGamma, &LogGamma::verify_args, &LogGamma::create_LogGamma, &LogGamma::eval_LogGamma}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Erf),
            {&Erf::instantiate_Erf, &Erf::verify_args, &Erf::create_Erf, &Erf::eval_Erf}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Erfc),
            {&Erfc::instantiate_Erfc, &Erfc::verify_args, &Erfc::create_Erfc, &Erfc::eval_Erfc}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::ErfcScaled),
            {&ErfcScaled::instantiate_ErfcScaled, &ErfcScaled::verify_args, &ErfcScaled::create_ErfcScaled, &ErfcScaled::eval_ErfcScaled}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Trunc),
            {&Trunc::instantiate_Trunc, &Trunc::verify_args, &Trunc::create_Trunc, &Trunc::eval_Trunc}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Fix),
            {&Fix::instantiate_Fix, &Fix::verify_args, &Fix::create_Fix, &Fix::eval_Fix}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Sin),
            {&Sin::instantiate_Sin, &Sin::verify_args, &Sin::create_Sin, &Sin::eval_Sin}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::OutOfRange),
            {&OutOfRange::instantiate_OutOfRange, &OutOfRange::verify_args, &OutOfRange::create_OutOfRange, &OutOfRange::eval_OutOfRange}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::BesselJ0),
            {&BesselJ0::instantiate_BesselJ0, &BesselJ0::verify_args, &BesselJ0::create_BesselJ0, &BesselJ0::eval_BesselJ0}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::BesselJ1),
            {&BesselJ1::instantiate_BesselJ1, &BesselJ1::verify_args, &BesselJ1::create_BesselJ1, &BesselJ1::eval_BesselJ1}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::BesselY0),
            {&BesselY0::instantiate_BesselY0, &BesselY0::verify_args, &BesselY0::create_BesselY0, &BesselY0::eval_BesselY0}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::BesselY1),
            {&BesselY1::instantiate_BesselY1, &BesselY1::verify_args, &BesselY1::create_BesselY1, &BesselY1::eval_BesselY1}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Asind),
            {&Asind::instantiate_Asind, &Asind::verify_args, &Asind::create_Asind, &Asind::eval_Asind}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Acosd),
            {&Acosd::instantiate_Acosd, &Acosd::verify_args, &Acosd::create_Acosd, &Acosd::eval_Acosd}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Atand),
            {&Atand::instantiate_Atand, &Atand::verify_args, &Atand::create_Atand, &Atand::eval_Atand}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Sind),
            {&Sind::instantiate_Sind, &Sind::verify_args, &Sind::create_Sind, &Sind::eval_Sind}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Cosd),
            {&Cosd::instantiate_Cosd, &Cosd::verify_args, &Cosd::create_Cosd, &Cosd::eval_Cosd}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Tand),
            {&Tand::instantiate_Tand, &Tand::verify_args, &Tand::create_Tand, &Tand::eval_Tand}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Cos),
            {&Cos::instantiate_Cos, &Cos::verify_args, &Cos::create_Cos, &Cos::eval_Cos}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Tan),
            {&Tan::instantiate_Tan, &Tan::verify_args, &Tan::create_Tan, &Tan::eval_Tan}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Asin),
            {&Asin::instantiate_Asin, &Asin::verify_args, &Asin::create_Asin, &Asin::eval_Asin}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Acos),
            {&Acos::instantiate_Acos, &Acos::verify_args, &Acos::create_Acos, &Acos::eval_Acos}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Atan),
            {&Atan::instantiate_Atan, &Atan::verify_args, &Atan::create_Atan, &Atan::eval_Atan}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Sinh),
            {&Sinh::instantiate_Sinh, &Sinh::verify_args, &Sinh::create_Sinh, &Sinh::eval_Sinh}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Cosh),
            {&Cosh::instantiate_Cosh, &Cosh::verify_args, &Cosh::create_Cosh, &Cosh::eval_Cosh}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Tanh),
            {&Tanh::instantiate_Tanh, &Tanh::verify_args, &Tanh::create_Tanh, &Tanh::eval_Tanh}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Atan2),
            {&Atan2::instantiate_Atan2, &Atan2::verify_args, &Atan2::create_Atan2, &Atan2::eval_Atan2}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Atan2d),
            {&Atan2d::instantiate_Atan2d, &Atan2d::verify_args, &Atan2d::create_Atan2d, &Atan2d::eval_Atan2d}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Asinh),
            {&Asinh::instantiate_Asinh, &Asinh::verify_args, &Asinh::create_Asinh, &Asinh::eval_Asinh}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Acosh),
            {&Acosh::instantiate_Acosh, &Acosh::verify_args, &Acosh::create_Acosh, &Acosh::eval_Acosh}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Atanh),
            {&Atanh::instantiate_Atanh, &Atanh::verify_args, &Atanh::create_Atanh, &Atanh::eval_Atanh}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Sinpi),
            {&Sinpi::instantiate_Sinpi, &Sinpi::verify_args, &Sinpi::create_Sinpi, &Sinpi::eval_Sinpi}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Cospi),
            {&Cospi::instantiate_Cospi, &Cospi::verify_args, &Cospi::create_Cospi, &Cospi::eval_Cospi}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Tanpi),
            {&Tanpi::instantiate_Tanpi, &Tanpi::verify_args, &Tanpi::create_Tanpi, &Tanpi::eval_Tanpi}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Asinpi),
            {&Asinpi::instantiate_Asinpi, &Asinpi::verify_args, &Asinpi::create_Asinpi, &Asinpi::eval_Asinpi}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Acospi),
            {&Acospi::instantiate_Acospi, &Acospi::verify_args, &Acospi::create_Acospi, &Acospi::eval_Acospi}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Atanpi),
            {&Atanpi::instantiate_Atanpi, &Atanpi::verify_args, &Atanpi::create_Atanpi, &Atanpi::eval_Atanpi}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Atan2pi),
            {&Atan2pi::instantiate_Atan2pi, &Atan2pi::verify_args, &Atan2pi::create_Atan2pi, &Atan2pi::eval_Atan2pi}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Log),
            {&Log::instantiate_Log, &Log::verify_args, &Log::create_Log, &Log::eval_Log}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Logical),
            {&Logical::instantiate_Logical, &Logical::verify_args, &Logical::create_Logical, &Logical::eval_Logical}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Exp),
            {&Exp::instantiate_Exp, &Exp::verify_args, &Exp::create_Exp, &Exp::eval_Exp}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Exp2),
            {nullptr, &Exp2::verify_args, &Exp2::create_Exp2, &Exp2::eval_Exp2}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Expm1),
            {nullptr, &Expm1::verify_args, &Expm1::create_Expm1, &Expm1::eval_Expm1}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::FMA),
            {&FMA::instantiate_FMA, &FMA::verify_args, &FMA::create_FMA, &FMA::eval_FMA}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::FlipSign),
            {&FlipSign::instantiate_FlipSign, &FlipSign::verify_args, nullptr, nullptr}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::FloorDiv),
            {&FloorDiv::instantiate_FloorDiv, &FloorDiv::verify_args, &FloorDiv::create_FloorDiv, &FloorDiv::eval_FloorDiv}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Mod),
            {&Mod::instantiate_Mod, &Mod::verify_args, &Mod::create_Mod, &Mod::eval_Mod}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Trailz),
            {&Trailz::instantiate_Trailz, &Trailz::verify_args, &Trailz::create_Trailz, &Trailz::eval_Trailz}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Isnan),
            {&Isnan::instantiate_Isnan, &Isnan::verify_args, &Isnan::create_Isnan, &Isnan::eval_Isnan}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Nearest),
            {&Nearest::instantiate_Nearest, &Nearest::verify_args, &Nearest::create_Nearest, &Nearest::eval_Nearest}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::CompilerVersion),
            {nullptr, &CompilerVersion::verify_args, &CompilerVersion::create_CompilerVersion, &CompilerVersion::eval_CompilerVersion}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::CommandArgumentCount),
            {&CommandArgumentCount::instantiate_CommandArgumentCount, &CommandArgumentCount::verify_args, &CommandArgumentCount::create_CommandArgumentCount, nullptr}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Rand),
            {&Rand::instantiate_Rand, &Rand::verify_args, &Rand::create_Rand, nullptr}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::ThisImage),
            {nullptr, &ThisImage::verify_args, &ThisImage::create_ThisImage, &ThisImage::eval_ThisImage}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::NumImages),
            {nullptr, &NumImages::verify_args, &NumImages::create_NumImages, &NumImages::eval_NumImages}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Spacing),
            {&Spacing::instantiate_Spacing, &Spacing::verify_args, &Spacing::create_Spacing, &Spacing::eval_Spacing}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Modulo),
            {&Modulo::instantiate_Modulo, &Modulo::verify_args, &Modulo::create_Modulo, &Modulo::eval_Modulo}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::BesselJN),
            {&BesselJN::instantiate_BesselJN, &BesselJN::verify_args, &BesselJN::create_BesselJN, &BesselJN::eval_BesselJN}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::BesselYN),
            {&BesselYN::instantiate_BesselYN, &BesselYN::verify_args, &BesselYN::create_BesselYN, &BesselYN::eval_BesselYN}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SameTypeAs),
            {nullptr, &SameTypeAs::verify_args, &SameTypeAs::create_SameTypeAs, &SameTypeAs::eval_SameTypeAs}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::ExtendsTypeOf),
            {nullptr, &ExtendsTypeOf::verify_args, &ExtendsTypeOf::create_ExtendsTypeOf, &ExtendsTypeOf::eval_ExtendsTypeOf}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Merge),
            {&Merge::instantiate_Merge, &Merge::verify_args, &Merge::create_Merge, &Merge::eval_Merge}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Mergebits),
            {&Mergebits::instantiate_Mergebits, &Mergebits::verify_args, &Mergebits::create_Mergebits, &Mergebits::eval_Mergebits}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Shiftr),
            {&Shiftr::instantiate_Shiftr, &Shiftr::verify_args, &Shiftr::create_Shiftr, &Shiftr::eval_Shiftr}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Adjustl),
            {&Adjustl::instantiate_Adjustl, &Adjustl::verify_args, &Adjustl::create_Adjustl, &Adjustl::eval_Adjustl}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Adjustr),
            {&Adjustr::instantiate_Adjustr, &Adjustr::verify_args, &Adjustr::create_Adjustr, &Adjustr::eval_Adjustr}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::StringConcat),
            {&StringConcat::instantiate_StringConcat, &StringConcat::verify_args, &StringConcat::create_StringConcat, &StringConcat::eval_StringConcat}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::StringLenTrim),
            {&StringLenTrim::instantiate_StringLenTrim, &StringLenTrim::verify_args, &StringLenTrim::create_StringLenTrim, &StringLenTrim::eval_StringLenTrim}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::StringTrim),
            {&StringTrim::instantiate_StringTrim, &StringTrim::verify_args, &StringTrim::create_StringTrim, &StringTrim::eval_StringTrim}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Ichar),
            {&Ichar::instantiate_Ichar, &Ichar::verify_args, &Ichar::create_Ichar, &Ichar::eval_Ichar}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Char),
            {&Char::instantiate_Char, &Char::verify_args, &Char::create_Char, &Char::eval_Char}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Achar),
            {&Achar::instantiate_Achar, &Achar::verify_args, &Achar::create_Achar, &Achar::eval_Achar}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Iachar),
            {&Iachar::instantiate_Iachar, &Iachar::verify_args, &Iachar::create_Iachar, &Iachar::eval_Iachar}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Rshift),
            {&Rshift::instantiate_Rshift, &Rshift::verify_args, &Rshift::create_Rshift, &Rshift::eval_Rshift}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Shiftl),
            {&Shiftl::instantiate_Shiftl, &Shiftl::verify_args, &Shiftl::create_Shiftl, &Shiftl::eval_Shiftl}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Dshiftl),
            {&Dshiftl::instantiate_Dshiftl, &Dshiftl::verify_args, &Dshiftl::create_Dshiftl, &Dshiftl::eval_Dshiftl}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Dshiftr),
            {&Dshiftr::instantiate_Dshiftr, &Dshiftr::verify_args, &Dshiftr::create_Dshiftr, &Dshiftr::eval_Dshiftr}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Ishft),
            {&Ishft::instantiate_Ishft, &Ishft::verify_args, &Ishft::create_Ishft, &Ishft::eval_Ishft}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Bgt),
            {&Bgt::instantiate_Bgt, &Bgt::verify_args, &Bgt::create_Bgt, &Bgt::eval_Bgt}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Blt),
            {&Blt::instantiate_Blt, &Blt::verify_args, &Blt::create_Blt, &Blt::eval_Blt}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Bge),
            {&Bge::instantiate_Bge, &Bge::verify_args, &Bge::create_Bge, &Bge::eval_Bge}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Exponent),
            {&Exponent::instantiate_Exponent, &Exponent::verify_args, &Exponent::create_Exponent, &Exponent::eval_Exponent}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Fraction),
            {&Fraction::instantiate_Fraction, &Fraction::verify_args, &Fraction::create_Fraction, &Fraction::eval_Fraction}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SetExponent),
            {&SetExponent::instantiate_SetExponent, &SetExponent::verify_args, &SetExponent::create_SetExponent, &SetExponent::eval_SetExponent}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Ble),
            {&Ble::instantiate_Ble, &Ble::verify_args, &Ble::create_Ble, &Ble::eval_Ble}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Lgt),
            {&Lgt::instantiate_Lgt, &Lgt::verify_args, &Lgt::create_Lgt, &Lgt::eval_Lgt}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Llt),
            {&Llt::instantiate_Llt, &Llt::verify_args, &Llt::create_Llt, &Llt::eval_Llt}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Lge),
            {&Lge::instantiate_Lge, &Lge::verify_args, &Lge::create_Lge, &Lge::eval_Lge}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Lle),
            {&Lle::instantiate_Lle, &Lle::verify_args, &Lle::create_Lle, &Lle::eval_Lle}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Not),
            {&Not::instantiate_Not, &Not::verify_args, &Not::create_Not, &Not::eval_Not}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Iand),
            {&Iand::instantiate_Iand, &Iand::verify_args, &Iand::create_Iand, &Iand::eval_Iand}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::And),
            {&And::instantiate_And, &And::verify_args, &And::create_And, &And::eval_And}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Ior),
            {&Ior::instantiate_Ior, &Ior::verify_args, &Ior::create_Ior, &Ior::eval_Ior}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Or),
            {&Or::instantiate_Or, &Or::verify_args, &Or::create_Or, &Or::eval_Or}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Ieor),
            {&Ieor::instantiate_Ieor, &Ieor::verify_args, &Ieor::create_Ieor, &Ieor::eval_Ieor}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Xor),
            {&Xor::instantiate_Xor, &Xor::verify_args, &Xor::create_Xor, &Xor::eval_Xor}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Ibclr),
            {&Ibclr::instantiate_Ibclr, &Ibclr::verify_args, &Ibclr::create_Ibclr, &Ibclr::eval_Ibclr}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Btest),
            {&Btest::instantiate_Btest, &Btest::verify_args, &Btest::create_Btest, &Btest::eval_Btest}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Ibset),
            {&Ibset::instantiate_Ibset, &Ibset::verify_args, &Ibset::create_Ibset, &Ibset::eval_Ibset}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Ibits),
            {&Ibits::instantiate_Ibits, &Ibits::verify_args, &Ibits::create_Ibits, &Ibits::eval_Ibits}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Leadz),
            {&Leadz::instantiate_Leadz, &Leadz::verify_args, &Leadz::create_Leadz, &Leadz::eval_Leadz}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::ToLowerCase),
            {&ToLowerCase::instantiate_ToLowerCase, &ToLowerCase::verify_args, &ToLowerCase::create_ToLowerCase, &ToLowerCase::eval_ToLowerCase}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Hypot),
            {&Hypot::instantiate_Hypot, &Hypot::verify_args, &Hypot::create_Hypot, &Hypot::eval_Hypot}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Kind),
            {nullptr, &Kind::verify_args, &Kind::create_Kind, &Kind::eval_Kind}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Digits),
            {&Digits::instantiate_Digits, &Digits::verify_args, &Digits::create_Digits, &Digits::eval_Digits}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Rrspacing),
            {&Rrspacing::instantiate_Rrspacing, &Rrspacing::verify_args, &Rrspacing::create_Rrspacing, &Rrspacing::eval_Rrspacing}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Repeat),
            {&Repeat::instantiate_Repeat, &Repeat::verify_args, &Repeat::create_Repeat, &Repeat::eval_Repeat}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::StringContainsSet),
            {&StringContainsSet::instantiate_StringContainsSet, &StringContainsSet::verify_args, &StringContainsSet::create_StringContainsSet, &StringContainsSet::eval_StringContainsSet}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::StringFindSet),
            {&StringFindSet::instantiate_StringFindSet, &StringFindSet::verify_args, &StringFindSet::create_StringFindSet, &StringFindSet::eval_StringFindSet}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SubstrIndex),
            {&SubstrIndex::instantiate_SubstrIndex, &SubstrIndex::verify_args, &SubstrIndex::create_SubstrIndex, &SubstrIndex::eval_SubstrIndex}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::MinExponent),
            {nullptr, &MinExponent::verify_args, &MinExponent::create_MinExponent, &MinExponent::eval_MinExponent}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::MaxExponent),
            {nullptr, &MaxExponent::verify_args, &MaxExponent::create_MaxExponent, &MaxExponent::eval_MaxExponent}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Abs),
            {&Abs::instantiate_Abs, &Abs::verify_args, &Abs::create_Abs, &Abs::eval_Abs}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Aimag),
            {&Aimag::instantiate_Aimag, &Aimag::verify_args, &Aimag::create_Aimag, &Aimag::eval_Aimag}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Dreal),
            {&Dreal::instantiate_Dreal, &Dreal::verify_args, &Dreal::create_Dreal, &Dreal::eval_Dreal}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Partition),
            {&Partition::instantiate_Partition, &Partition::verify_args, nullptr, nullptr}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::ListIndex),
            {nullptr, &ListIndex::verify_args, &ListIndex::create_ListIndex, &ListIndex::eval_list_index}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::ListReverse),
            {nullptr, &ListReverse::verify_args, &ListReverse::create_ListReverse, &ListReverse::eval_ListReverse}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::DictKeys),
            {nullptr, &DictKeys::verify_args, &DictKeys::create_DictKeys, &DictKeys::eval_dict_keys}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::DictValues),
            {nullptr, &DictValues::verify_args, &DictValues::create_DictValues, &DictValues::eval_dict_values}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::ListPop),
            {nullptr, &ListPop::verify_args, &ListPop::create_ListPop, &ListPop::eval_list_pop}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::ListReserve),
            {nullptr, &ListReserve::verify_args, &ListReserve::create_ListReserve, &ListReserve::eval_ListReserve}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SetAdd),
            {nullptr, &SetAdd::verify_args, &SetAdd::create_SetAdd, &SetAdd::eval_set_add}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SetRemove),
            {nullptr, &SetRemove::verify_args, &SetRemove::create_SetRemove, &SetRemove::eval_set_remove}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Max),
            {&Max::instantiate_Max, &Max::verify_args, &Max::create_Max, &Max::eval_Max}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Min),
            {&Min::instantiate_Min, &Min::verify_args, &Min::create_Min, &Min::eval_Min}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Sign),
            {&Sign::instantiate_Sign, &Sign::verify_args, &Sign::create_Sign, &Sign::eval_Sign}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Radix),
            {nullptr, &Radix::verify_args, &Radix::create_Radix, &Radix::eval_Radix}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::StorageSize),
            {nullptr, &StorageSize::verify_args, &StorageSize::create_StorageSize, &StorageSize::eval_StorageSize}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Scale),
            {&Scale::instantiate_Scale, &Scale::verify_args, &Scale::create_Scale, &Scale::eval_Scale}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Dprod),
            {&Dprod::instantiate_Dprod, &Dprod::verify_args, &Dprod::create_Dprod, &Dprod::eval_Dprod}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Range),
            {nullptr, &Range::verify_args, &Range::create_Range, &Range::eval_Range}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Aint),
            {&Aint::instantiate_Aint, &Aint::verify_args, &Aint::create_Aint, &Aint::eval_Aint}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Popcnt),
            {&Popcnt::instantiate_Popcnt, &Popcnt::verify_args, &Popcnt::create_Popcnt, &Popcnt::eval_Popcnt}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Poppar),
            {&Poppar::instantiate_Poppar, &Poppar::verify_args, &Poppar::create_Poppar, &Poppar::eval_Poppar}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Real),
            {&Real::instantiate_Real, &Real::verify_args, &Real::create_Real, &Real::eval_Real}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Cmplx),
            {&Cmplx::instantiate_Cmplx, &Cmplx::verify_args, &Cmplx::create_Cmplx, &Cmplx::eval_Cmplx}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Nint),
            {&Nint::instantiate_Nint, &Nint::verify_args, &Nint::create_Nint, &Nint::eval_Nint}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Idnint),
            {&Idnint::instantiate_Idnint, &Idnint::verify_args, &Idnint::create_Idnint, &Idnint::eval_Idnint}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Anint),
            {&Anint::instantiate_Anint, &Anint::verify_args, &Anint::create_Anint, &Anint::eval_Anint}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Dim),
            {&Dim::instantiate_Dim, &Dim::verify_args, &Dim::create_Dim, &Dim::eval_Dim}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Floor),
            {&Floor::instantiate_Floor, &Floor::verify_args, &Floor::create_Floor, &Floor::eval_Floor}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Ceiling),
            {&Ceiling::instantiate_Ceiling, &Ceiling::verify_args, &Ceiling::create_Ceiling, &Ceiling::eval_Ceiling}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Maskr),
            {&Maskr::instantiate_Maskr, &Maskr::verify_args, &Maskr::create_Maskr, &Maskr::eval_Maskr}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Maskl),
            {&Maskl::instantiate_Maskl, &Maskl::verify_args, &Maskl::create_Maskl, &Maskl::eval_Maskl}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Sqrt),
            {&Sqrt::instantiate_Sqrt, &Sqrt::verify_args, &Sqrt::create_Sqrt, &Sqrt::eval_Sqrt}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Sngl),
            {&Sngl::instantiate_Sngl, &Sngl::verify_args, &Sngl::create_Sngl, &Sngl::eval_Sngl}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Ifix),
            {&Ifix::instantiate_Ifix, &Ifix::verify_args, &Ifix::create_Ifix, &Ifix::eval_Ifix}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Idint),
            {&Idint::instantiate_Idint, &Idint::verify_args, &Idint::create_Idint, &Idint::eval_Idint}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Ishftc),
            {&Ishftc::instantiate_Ishftc, &Ishftc::verify_args, &Ishftc::create_Ishftc, &Ishftc::eval_Ishftc}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Conjg),
            {&Conjg::instantiate_Conjg, &Conjg::verify_args, &Conjg::create_Conjg, &Conjg::eval_Conjg}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SignFromValue),
            {&SignFromValue::instantiate_SignFromValue, &SignFromValue::verify_args, nullptr, nullptr}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Epsilon),
            {nullptr, &UnaryIntrinsicFunction::verify_args, &Epsilon::create_Epsilon, &Epsilon::eval_Epsilon}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Precision),
            {nullptr, &Precision::verify_args, &Precision::create_Precision, &Precision::eval_Precision}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Tiny),
            {nullptr, &UnaryIntrinsicFunction::verify_args, &Tiny::create_Tiny, &Tiny::eval_Tiny}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::BitSize),
            {nullptr, &UnaryIntrinsicFunction::verify_args, &BitSize::create_BitSize, &BitSize::eval_BitSize}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::NewLine),
            {nullptr, &UnaryIntrinsicFunction::verify_args, &NewLine::create_NewLine, &NewLine::eval_NewLine}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Huge),
            {nullptr, &UnaryIntrinsicFunction::verify_args, &Huge::create_Huge, &Huge::eval_Huge}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Loc),
            {nullptr, &UnaryIntrinsicFunction::verify_args, &Loc::create_Loc, &Loc::eval_Loc}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SelectedIntKind),
            {&SelectedIntKind::instantiate_SelectedIntKind, &SelectedIntKind::verify_args, &SelectedIntKind::create_SelectedIntKind, &SelectedIntKind::eval_SelectedIntKind}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Present),
            {&Present::instantiate_Present, &Present::verify_args, &Present::create_Present, &Present::eval_Present}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SelectedRealKind),
            {&SelectedRealKind::instantiate_SelectedRealKind, &SelectedRealKind::verify_args, &SelectedRealKind::create_SelectedRealKind, &SelectedRealKind::eval_SelectedRealKind}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SelectedCharKind),
            {&SelectedCharKind::instantiate_SelectedCharKind, &SelectedCharKind::verify_args, &SelectedCharKind::create_SelectedCharKind, &SelectedCharKind::eval_SelectedCharKind}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SelectedLogicalKind),
            {&SelectedLogicalKind::instantiate_SelectedLogicalKind, &SelectedLogicalKind::verify_args, &SelectedLogicalKind::create_SelectedLogicalKind, &SelectedLogicalKind::eval_SelectedLogicalKind}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicSymbol),
            {nullptr, &SymbolicSymbol::verify_args, &SymbolicSymbol::create_SymbolicSymbol, &SymbolicSymbol::eval_SymbolicSymbol}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicAdd),
            {nullptr, &SymbolicAdd::verify_args, &SymbolicAdd::create_SymbolicAdd, &SymbolicAdd::eval_SymbolicAdd}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicSub),
            {nullptr, &SymbolicSub::verify_args, &SymbolicSub::create_SymbolicSub, &SymbolicSub::eval_SymbolicSub}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicMul),
            {nullptr, &SymbolicMul::verify_args, &SymbolicMul::create_SymbolicMul, &SymbolicMul::eval_SymbolicMul}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicDiv),
            {nullptr, &SymbolicDiv::verify_args, &SymbolicDiv::create_SymbolicDiv, &SymbolicDiv::eval_SymbolicDiv}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicPow),
            {nullptr, &SymbolicPow::verify_args, &SymbolicPow::create_SymbolicPow, &SymbolicPow::eval_SymbolicPow}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicPi),
            {nullptr, &SymbolicPi::verify_args, &SymbolicPi::create_SymbolicPi, &SymbolicPi::eval_SymbolicPi}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicE),
            {nullptr, &SymbolicE::verify_args, &SymbolicE::create_SymbolicE, &SymbolicE::eval_SymbolicE}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicInteger),
            {nullptr, &SymbolicInteger::verify_args, &SymbolicInteger::create_SymbolicInteger, &SymbolicInteger::eval_SymbolicInteger}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicDiff),
            {nullptr, &SymbolicDiff::verify_args, &SymbolicDiff::create_SymbolicDiff, &SymbolicDiff::eval_SymbolicDiff}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicExpand),
            {nullptr, &SymbolicExpand::verify_args, &SymbolicExpand::create_SymbolicExpand, &SymbolicExpand::eval_SymbolicExpand}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicSin),
            {nullptr, &SymbolicSin::verify_args, &SymbolicSin::create_SymbolicSin, &SymbolicSin::eval_SymbolicSin}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicCos),
            {nullptr, &SymbolicCos::verify_args, &SymbolicCos::create_SymbolicCos, &SymbolicCos::eval_SymbolicCos}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicLog),
            {nullptr, &SymbolicLog::verify_args, &SymbolicLog::create_SymbolicLog, &SymbolicLog::eval_SymbolicLog}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicExp),
            {nullptr, &SymbolicExp::verify_args, &SymbolicExp::create_SymbolicExp, &SymbolicExp::eval_SymbolicExp}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicAbs),
            {nullptr, &SymbolicAbs::verify_args, &SymbolicAbs::create_SymbolicAbs, &SymbolicAbs::eval_SymbolicAbs}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicHasSymbolQ),
            {nullptr, &SymbolicHasSymbolQ::verify_args, &SymbolicHasSymbolQ::create_SymbolicHasSymbolQ, &SymbolicHasSymbolQ::eval_SymbolicHasSymbolQ}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicAddQ),
            {nullptr, &SymbolicAddQ::verify_args, &SymbolicAddQ::create_SymbolicAddQ, &SymbolicAddQ::eval_SymbolicAddQ}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicMulQ),
            {nullptr, &SymbolicMulQ::verify_args, &SymbolicMulQ::create_SymbolicMulQ, &SymbolicMulQ::eval_SymbolicMulQ}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicPowQ),
            {nullptr, &SymbolicPowQ::verify_args, &SymbolicPowQ::create_SymbolicPowQ, &SymbolicPowQ::eval_SymbolicPowQ}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicLogQ),
            {nullptr, &SymbolicLogQ::verify_args, &SymbolicLogQ::create_SymbolicLogQ, &SymbolicLogQ::eval_SymbolicLogQ}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicSinQ),
            {nullptr, &SymbolicSinQ::verify_args, &SymbolicSinQ::create_SymbolicSinQ, &SymbolicSinQ::eval_SymbolicSinQ}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::SymbolicGetArgument),
            {nullptr, &SymbolicGetArgument::verify_args, &SymbolicGetArgument::create_SymbolicGetArgument, &SymbolicGetArgument::eval_SymbolicGetArgument}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::CommandArgumentCount),
            {&CommandArgumentCount::instantiate_CommandArgumentCount, &CommandArgumentCount::verify_args, &CommandArgumentCount::create_CommandArgumentCount, nullptr}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Rand),
            {&Rand::instantiate_Rand, &Rand::verify_args, &Rand::create_Rand, nullptr}},
        ...
        {static_cast<int64_t>(IntrinsicElementalFunctions::LCoBound),
            {nullptr, &LCoBound::verify_args, &LCoBound::create_LCoBound, &LCoBound::eval_LCoBound}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::UCoBound),
            {nullptr, &UCoBound::verify_args, &UCoBound::create_UCoBound, &UCoBound::eval_UCoBound}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Int),
            {&Int::instantiate_Int, &Int::verify_args, &Int::create_Int, &Int::eval_Int}},
        };
    ...
    inline const std::map<std::string,
        ...
        static const std::map<std::string,
            std::tuple<create_intrinsic_function,
                ...
                {"iachar", {&Iachar::create_Iachar, &Iachar::eval_Iachar}},
                ...
                {"cmplx", {&Cmplx::create_Cmplx, &Cmplx::eval_Cmplx}},
    ...
    static inline eval_intrinsic_function get_eval_function(int64_t id) {
        ...
        return std::get<3>(get_intrinsic_function_by_id_db().at(id));
    }
