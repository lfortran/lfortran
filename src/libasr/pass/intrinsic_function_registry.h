...
namespace IntrinsicElementalFunctionRegistry {
    ...
    static const std::map<int64_t,
        ...
        {static_cast<int64_t>(IntrinsicElementalFunctions::Scan),
            {&Scan::instantiate_Scan, &Scan::verify_args}},
    ...
    static const std::map<std::string,
        std::tuple<create_intrinsic_function,
                ...
                {"scan", {&Scan::create_Scan, &Scan::eval_Scan}},
