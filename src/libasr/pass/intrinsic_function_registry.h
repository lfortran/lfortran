...
namespace IntrinsicElementalFunctionRegistry {
    ...
    static const std::map<int64_t,
        ...
        {static_cast<int64_t>(IntrinsicElementalFunctions::BesselJ0),
            {&BesselJ0::instantiate_BesselJ0, &UnaryMathIntrinsicFunction::verify_args}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::BesselJ1),
            {&BesselJ1::instantiate_BesselJ1, &UnaryMathIntrinsicFunction::verify_args}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::BesselY0),
            {&BesselY0::instantiate_BesselY0, &UnaryMathIntrinsicFunction::verify_args}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::BesselY1),
            {&BesselY1::instantiate_BesselY1, &UnaryMathIntrinsicFunction::verify_args}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Asind),
            {&Asind::instantiate_Asind, &UnaryMathIntrinsicFunction::verify_args}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Acosd),
            {&Acosd::instantiate_Acosd, &UnaryMathIntrinsicFunction::verify_args}},
        {static_cast<int64_t>(IntrinsicElementalFunctions::Atand),
            {&Atand::instantiate_Atand, &UnaryMathIntrinsicFunction::verify_args}},
