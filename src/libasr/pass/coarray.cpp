...
class PRIFInterface {
    ...
    public:
        ...
        ASR::symbol_t* get_or_create_prif_coarray_descriptor_struct(const Location &loc) {
            SymbolTable *global_scope = unit.m_symtab;
            std::string symbol_name = "__module_prif_prif_coarray_descriptor";
            ...
            ASR::ttype_t *int64_15 = b.Array({15}, int64_type);
            ASR::ttype_t *int64_14 = b.Array({14}, int64_type);
            ASR::ttype_t *int32_15 = b.Array({15}, int32_type);

            declare_variable(struct_symtab, loc, "coarray_data", cptr_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Private, ASR::presenceType::Required, false);
            declare_variable(struct_symtab, loc, "corank", int32_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Private, ASR::presenceType::Required, false);
            declare_variable(struct_symtab, loc, "coarray_size", int64_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Private, ASR::presenceType::Required, false);
            declare_variable(struct_symtab, loc, "final_proc", cptr_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Private, ASR::presenceType::Required, false);

            ASR::symbol_t *prev_sym = declare_variable(struct_symtab, loc, "previous_handle", cptr_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Private, ASR::presenceType::Required, false);
            ASR::down_cast<ASR::Variable_t>(prev_sym)->m_value = ASRUtils::EXPR(ASR::make_PointerNullConstant_t(al, loc, cptr_type, nullptr));
            ASR::down_cast<ASR::Variable_t>(prev_sym)->m_symbolic_value = ASRUtils::EXPR(ASR::make_PointerNullConstant_t(al, loc, cptr_type, nullptr));

            ASR::symbol_t *next_sym = declare_variable(struct_symtab, loc, "next_handle", cptr_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Private, ASR::presenceType::Required, false);
            ASR::down_cast<ASR::Variable_t>(next_sym)->m_value = ASRUtils::EXPR(ASR::make_PointerNullConstant_t(al, loc, cptr_type, nullptr));
            ASR::down_cast<ASR::Variable_t>(next_sym)->m_symbolic_value = ASRUtils::EXPR(ASR::make_PointerNullConstant_t(al, loc, cptr_type, nullptr));

            declare_variable(struct_symtab, loc, "lcobounds", int64_15, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Private, ASR::presenceType::Required, false);
            declare_variable(struct_symtab, loc, "ucobounds", int64_14, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Private, ASR::presenceType::Required, false);
            declare_variable(struct_symtab, loc, "coshape_epp", int32_15, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Private, ASR::presenceType::Required, false);
            declare_variable(struct_symtab, loc, "p_context_data", cptr_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Private, ASR::presenceType::Required, false);
            declare_variable(struct_symtab, loc, "reserved", cptr_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Private, ASR::presenceType::Required, false);

            Vec<char*> members; members.reserve(al, 11);
            members.push_back(al, s2c(al, "coarray_data"));
            members.push_back(al, s2c(al, "corank"));
            members.push_back(al, s2c(al, "coarray_size"));
            members.push_back(al, s2c(al, "final_proc"));
            members.push_back(al, s2c(al, "previous_handle"));
            members.push_back(al, s2c(al, "next_handle"));
            members.push_back(al, s2c(al, "lcobounds"));
            members.push_back(al, s2c(al, "ucobounds"));
            members.push_back(al, s2c(al, "coshape_epp"));
            members.push_back(al, s2c(al, "p_context_data"));
            members.push_back(al, s2c(al, "reserved"));
        ...
        ASR::symbol_t* get_or_create_child_team_info_struct(const Location &loc) {
            SymbolTable *global_scope = unit.m_symtab;
            std::string symbol_name = "__module_prif_prif_child_team_info";
            if (ASR::symbol_t *existing = global_scope->get_symbol(symbol_name)) return existing;
            ...
            declare_variable(struct_symtab, loc, "allocated_memory", cptr_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Public, ASR::presenceType::Required, false);
            declare_variable(struct_symtab, loc, "offset", int64_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Public, ASR::presenceType::Required, false);
            declare_variable(struct_symtab, loc, "size", int64_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Public, ASR::presenceType::Required, false);

            Vec<char*> members; members.reserve(al, 3);
            members.push_back(al, s2c(al, "allocated_memory"));
            members.push_back(al, s2c(al, "offset"));
            members.push_back(al, s2c(al, "size"));
        ...
        ASR::symbol_t* get_or_create_prif_team_descriptor_struct(const Location &loc) {
            SymbolTable *global_scope = unit.m_symtab;
            std::string symbol_name = "__module_prif_prif_team_descriptor";
            ...
            declare_variable(struct_symtab, loc, "gex_team", cptr_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Public, ASR::presenceType::Required, false);
            declare_variable(struct_symtab, loc, "heap_mspace", cptr_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Public, ASR::presenceType::Required, false);
            declare_variable(struct_symtab, loc, "heap_start", int64_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Public, ASR::presenceType::Required, false);
            declare_variable(struct_symtab, loc, "heap_size", int64_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Public, ASR::presenceType::Required, false);
            declare_variable(struct_symtab, loc, "team_number", int64_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Public, ASR::presenceType::Required, false);
            declare_variable(struct_symtab, loc, "this_image", int32_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Public, ASR::presenceType::Required, false);
            declare_variable(struct_symtab, loc, "num_images", int32_type, ASR::intentType::Local, nullptr, ASR::abiType::Source, ASR::accessType::Public, ASR::presenceType::Required, false);

            ASR::ttype_t *parent_ptr_type = ASRUtils::TYPE(ASR::make_Pointer_t(al, loc, struct_type));
            ASR::symbol_t *parent_team_sym = declare_variable(struct_symtab, loc, "parent_team", parent_ptr_type, ASR::intentType::Local, struct_sym, ASR::abiType::Source, ASR::accessType::Public, ASR::presenceType::Required, false);
            ASR::down_cast<ASR::Variable_t>(parent_team_sym)->m_value = ASRUtils::EXPR(ASR::make_PointerNullConstant_t(al, loc, parent_ptr_type, nullptr));
            ASR::down_cast<ASR::Variable_t>(parent_team_sym)->m_symbolic_value = ASRUtils::EXPR(ASR::make_PointerNullConstant_t(al, loc, parent_ptr_type, nullptr));

            ASR::symbol_t *coarray_desc_sym = get_or_create_prif_coarray_descriptor_struct(loc);
            ASR::ttype_t *coarray_desc_type = ASRUtils::make_StructType_t_util(al, loc, coarray_desc_sym, true);
            ASR::ttype_t *coarrays_ptr_type = ASRUtils::TYPE(ASR::make_Pointer_t(al, loc, coarray_desc_type));
            ASR::symbol_t *coarrays_sym = declare_variable(struct_symtab, loc, "coarrays", coarrays_ptr_type, ASR::intentType::Local, coarray_desc_sym, ASR::abiType::Source, ASR::accessType::Public, ASR::presenceType::Required, false);
            ASR::down_cast<ASR::Variable_t>(coarrays_sym)->m_value = ASRUtils::EXPR(ASR::make_PointerNullConstant_t(al, loc, coarrays_ptr_type, nullptr));
            ASR::down_cast<ASR::Variable_t>(coarrays_sym)->m_symbolic_value = ASRUtils::EXPR(ASR::make_PointerNullConstant_t(al, loc, coarrays_ptr_type, nullptr));

            ASR::symbol_t *child_heap_sym = get_or_create_child_team_info_struct(loc);
            ASR::ttype_t *child_heap_type = ASRUtils::make_StructType_t_util(al, loc, child_heap_sym, true);
            ASR::ttype_t *child_ptr_type = ASRUtils::TYPE(ASR::make_Pointer_t(al, loc, child_heap_type));
            ASR::symbol_t *child_heap_info_sym = declare_variable(struct_symtab, loc, "child_heap_info", child_ptr_type, ASR::intentType::Local, child_heap_sym, ASR::abiType::Source, ASR::accessType::Public, ASR::presenceType::Required, false);
            ASR::down_cast<ASR::Variable_t>(child_heap_info_sym)->m_value = ASRUtils::EXPR(ASR::make_PointerNullConstant_t(al, loc, child_ptr_type, nullptr));
            ASR::down_cast<ASR::Variable_t>(child_heap_info_sym)->m_symbolic_value = ASRUtils::EXPR(ASR::make_PointerNullConstant_t(al, loc, child_ptr_type, nullptr));

            Vec<char*> members; members.reserve(al, 10);
            members.push_back(al, s2c(al, "gex_team"));
            members.push_back(al, s2c(al, "heap_mspace"));
            members.push_back(al, s2c(al, "heap_start"));
            members.push_back(al, s2c(al, "heap_size"));
            members.push_back(al, s2c(al, "team_number"));
            members.push_back(al, s2c(al, "this_image"));
            members.push_back(al, s2c(al, "num_images"));
            members.push_back(al, s2c(al, "parent_team"));
            members.push_back(al, s2c(al, "coarrays"));
            members.push_back(al, s2c(al, "child_heap_info"));
        ...
        ASR::symbol_t* get_or_create_prif_team_type_struct(const Location &loc) {
            ...
            ASR::symbol_t *info_desc_sym = get_or_create_prif_team_descriptor_struct(loc);
            ASR::ttype_t *info_desc_type = ASRUtils::make_StructType_t_util(al, loc, info_desc_sym, true);
            ASR::ttype_t *info_ptr_type = ASRUtils::TYPE(ASR::make_Pointer_t(al, loc, info_desc_type));
            
            declare_variable(struct_symtab, loc, "info", info_ptr_type, ASR::intentType::Local, info_desc_sym, ASR::abiType::Source, ASR::accessType::Private, ASR::presenceType::Required, false);
        ...
        ASR::expr_t* make_prif_num_images_call(const Location &loc, ASR::ttype_t *type) {
            ...
            if (!wrapper_fn) {
                ...
                ASR::symbol_t *tmp_sym = declare_variable(
                    fn_symtab, loc, "tmp", int32_type, ASR::intentType::Local, nullptr,
                    ASR::abiType::Source, ASR::accessType::Public, ASR::presenceType::Required, false);
                ...
                arg.m_value = ASRUtils::EXPR(ASR::make_Var_t(al, loc, tmp_sym));
                ...
                body.push_back(al, ASRUtils::STMT(ASR::make_Assignment_t(
                    al, loc, ASRUtils::EXPR(ASR::make_Var_t(al, loc, ret_sym)),
                    ASRUtils::EXPR(ASR::make_Var_t(al, loc, tmp_sym)), nullptr, false, false)));

                Vec<char*> deps;
                deps.reserve(al, 1);
                deps.push_back(al, s2c(al, "__module_prif_prif_num_images"));
        ...
        ASR::expr_t* make_prif_this_image_call(const Location &loc, ASR::ttype_t *type) {
            ...
            if (!wrapper_fn) {
                ...
                Vec<char*> deps;
                deps.reserve(al, 1);
                deps.push_back(al, s2c(al, "__module_prif_prif_this_image_no_coarray"));
...
void pass_replace_coarray(Allocator &al, ASR::TranslationUnit_t &unit,
    ...
    // Phase 2: Replace num_images()/this_image() intrinsics and
    // CoarrayRef with prif calls
