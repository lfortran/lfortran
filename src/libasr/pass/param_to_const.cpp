...
This ASR pass replaces initializer expressions with evaluated values. The
function `pass_replace_param_to_const` transforms the ASR tree in-place.
 ...
 public:
  ...
  void visit_Var(const ASR::Var_t& x) {
    if (is_a<ASR::Variable_t>(
      ...
      ASR::Variable_t* init_var = ASR::down_cast<ASR::Variable_t>(
          LFortran::ASRUtils::symbol_get_past_external(x.m_v));
...
void pass_replace_param_to_const(
