...
namespace Dprod {
    static ASR::expr_t *eval_Dprod(Allocator &al, const Location &loc,
        ...
        int kind1 = ASRUtils::extract_kind_from_ttype_t(expr_type(args[0]));
        int kind2 = ASRUtils::extract_kind_from_ttype_t(expr_type(args[1]));
        if (kind1 != 4 or kind2 != 4) {
    ...
    static inline ASR::expr_t* instantiate_Dprod(Allocator &al, const Location &loc,
        ...
        int kind1 = ASRUtils::extract_kind_from_ttype_t(arg_types[0]);
        int kind2 = ASRUtils::extract_kind_from_ttype_t(arg_types[1]);
        if (kind1 != 4 or kind2 != 4) {
