...
public:
    ...
    void visit_Print(const ASR::Print_t& x)
    {
        if (x.n_values == 1 && PassUtils::is_array(x.m_values[0])) {
            ...
            ASR::stmt_t* empty_print_endl = LFortran::ASRUtils::STMT(
                ASR::make_Print_t(al, x.base.base.loc, nullptr, nullptr, 0, nullptr, nullptr));
            for (int i = n_dims - 1; i >= 0; i--) {
                ...
                if (doloop == nullptr) {
                    ...
                    ASR::stmt_t* print_stmt
                        = LFortran::ASRUtils::STMT(ASR::make_Print_t(al,
                                                                     x.base.base.loc,
                                                                     nullptr,
                                                                     print_args.p,
                                                                     print_args.size(),
...
void
pass_replace_print_arr(Allocator& al,
