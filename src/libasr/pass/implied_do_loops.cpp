...
public:
    ...
    void create_do_loop(ASR::ImpliedDoLoop_t* idoloop,
                        ASR::Var_t* arr_var,
                        ASR::expr_t* arr_idx = nullptr)
    {
        ...
        if (arr_idx == nullptr) {
            const_n = LFortran::ASRUtils::EXPR(
                ASR::make_IntegerConstant_t(al, arr_var->base.base.loc, idoloop->n_values, _type));
            offset = LFortran::ASRUtils::EXPR(ASR::make_IntegerBinOp_t(al,
                                                                       arr_var->base.base.loc,
                                                                       idoloop->m_var,
                                                                       ASR::binopType::Sub,
                                                                       idoloop->m_start,
                                                                       _type,
            ...
            num_grps = LFortran::ASRUtils::EXPR(ASR::make_IntegerBinOp_t(
                al, arr_var->base.base.loc, offset, ASR::binopType::Mul, const_n, _type, nullptr));
            grp_start = LFortran::ASRUtils::EXPR(ASR::make_IntegerBinOp_t(al,
                                                                          arr_var->base.base.loc,
                                                                          num_grps,
                                                                          ASR::binopType::Add,
                                                                          const_1,
        ...
        for (size_t i = 0; i < idoloop->n_values; i++) {
            ...
            ASR::expr_t* array_ref = LFortran::ASRUtils::EXPR(
            ...
            ASR::stmt_t* doloop_stmt = LFortran::ASRUtils::STMT(ASR::make_Assignment_t(
                al, arr_var->base.base.loc, array_ref, idoloop->m_values[i], nullptr));
            doloop_body.push_back(al, doloop_stmt);
            if (arr_idx != nullptr) {
                ASR::expr_t* increment = LFortran::ASRUtils::EXPR(
                    ASR::make_IntegerBinOp_t(al,
                                             arr_var->base.base.loc,
                                             arr_idx,
                                             ASR::binopType::Add,
                                             const_1,
                                             LFortran::ASRUtils::expr_type(arr_idx),
                                             nullptr));
    ...
    void visit_Assignment(const ASR::Assignment_t& x)
    {
        ...
        if (ASR::is_a<ASR::ArrayConstant_t>(*x.m_value)) {
            ...
            ASR::expr_t* const_1 = ASRUtils::EXPR(
                ASR::make_IntegerConstant_t(al, x.base.base.loc, 1, ASRUtils::expr_type(idx_var)));
            ASR::stmt_t* assign_stmt = LFortran::ASRUtils::STMT(
                ASR::make_Assignment_t(al, arr_var->base.base.loc, idx_var, lb, nullptr));
                ...
                if (ASR::is_a<ASR::ImpliedDoLoop_t>(*curr_init)) {
                    ...
                    ASR::expr_t* array_ref = LFortran::ASRUtils::EXPR(
                        ASR::make_ArrayItem_t(al,
                                              ...
                                              nullptr));
                    ASR::stmt_t* assign_stmt = LFortran::ASRUtils::STMT(ASR::make_Assignment_t(
                        al, arr_var->base.base.loc, array_ref, arr_init->m_args[k], nullptr));
                    pass_result.push_back(al, assign_stmt);
                    ASR::expr_t* increment = LFortran::ASRUtils::EXPR(
                        ASR::make_IntegerBinOp_t(al,
                                                 arr_var->base.base.loc,
                                                 ...
                                                 ASR::binopType::Add,
                                                 const_1,
                                                 LFortran::ASRUtils::expr_type(idx_var),
                                                 nullptr));
                   ...
                   &&  // This will be converted to SubroutineCall in array_op.cpp
                   PassUtils::is_array(x.m_target)) {
            contains_array = true;
            visit_expr(*(x.m_value));  // TODO: Add support for updating contains array in all types
                                       // of expressions
            if (contains_array) {
                return;
            }
            ...
            for (int i = n_dims - 1; i >= 0; i--) {
                ...
                if (doloop == nullptr) {
                    ...
                    ASR::stmt_t* assign = LFortran::ASRUtils::STMT(
                        ASR::make_Assignment_t(al, x.base.base.loc, ref, x.m_value, nullptr));
