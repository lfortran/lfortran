...
class ReplaceArrayOpSimplifier: public ASR::BaseExprReplacer<ReplaceArrayOpSimplifier> {
    ...
    ReplaceArrayOpSimplifier(Allocator& al_, Vec<ASR::stmt_t*>& pass_result_,
...
class ArrayOpSimplifierVisitor: public ASR::CallReplacerOnExpressionsVisitor<ArrayOpSimplifierVisitor> {
    private:

    Allocator& al;
    ReplaceArrayOpSimplifier replacer;
    Vec<ASR::stmt_t*> pass_result;
    ...
    ArrayOpSimplifierVisitor(Allocator& al_, bool realloc_lhs_):
    ...
    void visit_If(const ASR::If_t& x) {
        if( !ASRUtils::is_array(ASRUtils::expr_type(x.m_test)) ) {
            ASR::CallReplacerOnExpressionsVisitor<ArrayOpSimplifierVisitor>::visit_If(x);
            return ;
        }
...
void pass_replace_array_op_simplifier(Allocator &al, ASR::TranslationUnit_t &unit,
    ...
    ArrayOpSimplifierVisitor v(al, pass_options.realloc_lhs);
