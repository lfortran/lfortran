        ...
        *current_expr = ASRUtils::EXPR(ASR::make_Var_t(al, x->base.base.loc, slice_sym));
        ...
        for( int i = (int) sliced_rank - 1; i >= 0; i-- ) {
            ...
            if( doloop == nullptr ) {
                ...
                ASR::stmt_t* assign_stmt = ASRUtils::STMT(ASRUtils::make_Assignment_t_util(al, x->base.base.loc, target_ref, value_ref, nullptr));
                ...
                ASR::stmt_t* set_to_one = ASRUtils::STMT(ASRUtils::make_Assignment_t_util(al, x->base.base.loc, idx_vars_target[i+1], const_1, nullptr));
            ...
            ASR::stmt_t* assign_stmt = ASRUtils::STMT(ASRUtils::make_Assignment_t_util(al, x->base.base.loc, idx_vars_target[i], inc_expr, nullptr));
            doloop_body.push_back(al, assign_stmt);
        ...
        ASR::ttype_t* int_type = ASRUtils::TYPE(ASR::make_Integer_t(al, x->base.base.loc, a_kind));
        ASR::expr_t* const_1 = ASRUtils::EXPR(ASR::make_IntegerConstant_t(al, x->base.base.loc, 1, int_type));
        ASR::stmt_t* set_to_one = ASRUtils::STMT(ASRUtils::make_Assignment_t_util(al, x->base.base.loc, idx_vars_target[0], const_1, nullptr));
