...
public:
    ...
    ASR::ttype_t* get_array_from_slice(const ASR::ArraySection_t& x, ASR::expr_t* arr_var)
    {
        ...
        for (size_t i = 0; i < x.n_args; i++) {
            if (x.m_args[i].m_step != nullptr) {
                ...
                ASR::expr_t* gap = LFortran::ASRUtils::EXPR(ASR::make_IntegerBinOp_t(
                    al, x.base.base.loc, end, ASR::binopType::Sub, start, int32_type, nullptr));
                ASR::expr_t* slice_size = LFortran::ASRUtils::EXPR(ASR::make_IntegerBinOp_t(
                    al, x.base.base.loc, gap, ASR::binopType::Div, step, int32_type, nullptr));
        ...
        switch (t2->type) {
            ...
            case ASR::ttypeType::Derived: {
                ...
                new_type = ASRUtils::TYPE(ASR::make_Derived_t(
                    al, x.base.base.loc, curr_type->m_derived_type, m_dims.p, m_dims.size()));
                break;
            }
            default:
                break;
    ...
    void visit_ArraySection(const ASR::ArraySection_t& x)
    {
        if (create_slice_var) {
            ...
            ASR::asr_t* slice_asr = ASR::make_Variable_t(al,
                                                         x.base.base.loc,
                                                         current_scope,
                                                         new_var_name,
                                                         ...
                                                         get_array_from_slice(x, x_arr_var),
                                                         ASR::abiType::Source,
            ...
            PassUtils::create_idx_vars(
                idx_vars_target, x.n_args, x.base.base.loc, al, current_scope, "_t");
            PassUtils::create_idx_vars(
                idx_vars_value, x.n_args, x.base.base.loc, al, current_scope, "_v");
            ...
            for (int i = (int) x.n_args - 1; i >= 0; i--) {
                ...
                if (doloop == nullptr) {
                    ...
                    ASR::stmt_t* set_to_one = LFortran::ASRUtils::STMT(ASR::make_Assignment_t(
                        al, x.base.base.loc, idx_vars_target[i + 1], const_1, nullptr));
            ...
            ASR::stmt_t* set_to_one = LFortran::ASRUtils::STMT(
                ASR::make_Assignment_t(al, x.base.base.loc, idx_vars_target[0], const_1, nullptr));
...
void
pass_replace_arr_slice(Allocator& al,
