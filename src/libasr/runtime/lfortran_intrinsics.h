...
LFORTRAN_API void _lfortran_string_read_i32_array(char *str, char *format, int32_t *arr, size_t array_size);
LFORTRAN_API void _lfortran_string_read_i64(char *str, char *format, int64_t *i);
LFORTRAN_API void _lfortran_string_read_i64_array(char *str, char *format, int64_t *arr, size_t array_size);
LFORTRAN_API void _lfortran_string_read_f32(char *str, char *format, float *f);
LFORTRAN_API void _lfortran_string_read_f32_array(char *str, char *format, float *arr, size_t array_size);
LFORTRAN_API void _lfortran_string_read_f64(char *str, char *format, double *f);
LFORTRAN_API void _lfortran_string_read_f64_array(char *str, char *format, double *arr, size_t array_size);
