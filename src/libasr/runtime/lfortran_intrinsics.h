...
LFORTRAN_API void _lfortran_formatted_read(int32_t unit_num, int32_t* iostat, int32_t* chunk, char* advance, int64_t advance_length, char* fmt, int64_t fmt_len, char* str_data, int64_t str_len, void* dests, int32_t no_of_args);
