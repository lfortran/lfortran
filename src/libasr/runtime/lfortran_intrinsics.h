...
LFORTRAN_API void _lfortran_strcpy_alloc_kind(lfortran_allocator_t* al, char** lhs, int64_t* lhs_len, bool is_lhs_allocatable, bool is_lhs_deferred, char* rhs, int64_t rhs_len, int32_t char_kind);
LFORTRAN_API void _lfortran_copy_str_and_pad_kind(char* lhs, int64_t lhs_len, char* rhs, int64_t rhs_len, int32_t char_kind);
