...
static inline double extract_real(const char* s) { return std::atof(s); }
...
static inline const ASR::symbol_t* symbol_get_past_external(
...
static inline ASR::Variable_t* EXPR2VAR(const ASR::expr_t* f) {
  return ASR::down_cast<ASR::Variable_t>(
      symbol_get_past_external(ASR::down_cast<ASR::Var_t>(f)->m_v));
}
...
static inline std::string type_to_str(const ASR::ttype_t* t) {
  switch (t->type) {
    ...
    default:
      throw LCompilersException("Not implemented " + std::to_string(t->type) +
                                ".");
  }
}
...
static inline std::string logicalbinop_to_str_python(
...
static inline bool is_intrinsic_function2(const ASR::Function_t* fn) {
  ...
  ASR::Module_t* m = get_sym_module0(sym);
  if (m != nullptr) {
    if (m->m_intrinsic || fn->m_abi == ASR::abiType::Intrinsic) {
      return true;
    }
  }
  return false;
...
static inline bool is_intrinsic_optimization(const T* routine) {
  ...
  if (ASR::is_a<ASR::ExternalSymbol_t>(*sym)) {
    ...
    return (std::string(ext_sym->m_module_name)
                .find("lfortran_intrinsic_optimization") != std::string::npos);
  }
  ASR::Module_t* m = get_sym_module0(sym);
  if (m != nullptr) {
    return (std::string(m->m_name).find("lfortran_intrinsic_optimization") !=
            std::string::npos);
  }
  return false;
}
...
static inline bool is_value_constant(ASR::expr_t* a_value,
  ...
  if (ASR::is_a<ASR::IntegerConstant_t>(*a_value)) {
    ASR::IntegerConstant_t* const_int =
        ASR::down_cast<ASR::IntegerConstant_t>(a_value);
...
static inline bool is_value_constant(ASR::expr_t* a_value, bool& const_value) {
  ...
  if (ASR::is_a<ASR::LogicalConstant_t>(*a_value)) {
    ASR::LogicalConstant_t* const_logical =
        ASR::down_cast<ASR::LogicalConstant_t>(a_value);
...
static inline bool is_value_constant(ASR::expr_t* a_value,
  ...
  if (ASR::is_a<ASR::IntegerConstant_t>(*a_value)) {
    ...
    ASR::RealConstant_t* const_real =
        ASR::down_cast<ASR::RealConstant_t>(a_value);
...
static inline bool is_value_constant(ASR::expr_t* a_value,
  ...
  if (ASR::is_a<ASR::StringConstant_t>(*a_value)) {
    ASR::StringConstant_t* const_string =
        ASR::down_cast<ASR::StringConstant_t>(a_value);
...
static inline bool is_value_equal(ASR::expr_t* test_expr,
                                  ASR::expr_t* desired_expr) {
  ASR::expr_t* test_value = expr_value(test_expr);
  ASR::expr_t* desired_value = expr_value(desired_expr);
  if (!is_value_constant(test_value) || !is_value_constant(desired_value) ||
  ...
  switch (desired_value->type) {
    case ASR::exprType::IntegerConstant: {
      ASR::IntegerConstant_t* test_int =
          ASR::down_cast<ASR::IntegerConstant_t>(test_value);
      ASR::IntegerConstant_t* desired_int =
          ASR::down_cast<ASR::IntegerConstant_t>(desired_value);
      return test_int->m_n == desired_int->m_n;
    }
    case ASR::exprType::StringConstant: {
      ASR::StringConstant_t* test_str =
          ASR::down_cast<ASR::StringConstant_t>(test_value);
      ASR::StringConstant_t* desired_str =
          ASR::down_cast<ASR::StringConstant_t>(desired_value);
...
static inline bool is_value_in_range(ASR::expr_t* start, ASR::expr_t* end,
                                     ASR::expr_t* value) {
...
static inline bool extract_value(ASR::expr_t* value_expr, T& value) {
  ...
  switch (value_expr->type) {
    case ASR::exprType::IntegerConstant: {
      ASR::IntegerConstant_t* const_int =
          ASR::down_cast<ASR::IntegerConstant_t>(value_expr);
      value = (T)const_int->m_n;
      break;
    }
    case ASR::exprType::RealConstant: {
      ASR::RealConstant_t* const_real =
          ASR::down_cast<ASR::RealConstant_t>(value_expr);
  ...
  switch (t->type) {
    case ASR::ttypeType::Integer: {
      ...
      switch (i->m_kind) {
        ...
        default: {
          throw LCompilersException("Integer kind not supported");
        }
      }
    ...
    case ASR::ttypeType::Real: {
      ...
      switch (r->m_kind) {
        ...
        default: {
          throw LCompilersException("Float kind not supported");
        }
      }
    ...
    case ASR::ttypeType::Complex: {
      ...
      switch (c->m_kind) {
        ...
        default: {
          throw LCompilersException("Complex kind not supported");
        }
      }
    }
    case ASR::ttypeType::Logical: {
    ...
    case ASR::ttypeType::Dict: {
      ...
      return "dict[" + type_to_str_python(d->m_key_type) + ", " +
             type_to_str_python(d->m_value_type) + "]";
    }
    case ASR::ttypeType::List: {
...
static inline bool is_immutable(const ASR::ttype_t* type) {
  return ((ASR::is_a<ASR::Character_t>(*type) ||
           ASR::is_a<ASR::Tuple_t>(*type) || ASR::is_a<ASR::Complex_t>(*type)));
}

// Returns a list of values
static inline Vec<ASR::call_arg_t> get_arg_values(
    Allocator& al, const Vec<ASR::call_arg_t>& args) {
...
static inline Vec<ASR::expr_t*> call_arg2expr(
    Allocator& al, const Vec<ASR::call_arg_t>& call_args) {
  Vec<ASR::expr_t*> args;
...
// Returns the name of scopes in reverse order (local scope first, function
// second, module last)
static inline Vec<char*> get_scope_names(Allocator& al,
...
void extract_module_python(
    const ASR::TranslationUnit_t& m,
...
ASR::Module_t* load_module(
    Allocator& al, SymbolTable* symtab, const std::string& module_name,
    const Location& loc, bool intrinsic, const std::string& rl_path,
    bool run_verify,
    const std::function<void(const std::string&, const Location&)> err);

ASR::TranslationUnit_t* find_and_load_module(Allocator& al,
...
bool use_overloaded(
    ASR::expr_t* left, ASR::expr_t* right, ASR::binopType op,
    std::string& intrinsic_op_name, SymbolTable* curr_scope, ASR::asr_t*& asr,
...
bool use_overloaded(
    ASR::expr_t* left, ASR::expr_t* right, ASR::cmpopType op,
    std::string& intrinsic_op_name, SymbolTable* curr_scope, ASR::asr_t*& asr,
    Allocator& al, const Location& loc,
    const std::function<void(const std::string&, const Location&)> err);
...
bool use_overloaded_assignment(
    ASR::expr_t* target, ASR::expr_t* value, SymbolTable* curr_scope,
    ASR::asr_t*& asr, Allocator& al, const Location& loc,
    const std::function<void(const std::string&, const Location&)> err);
...
static inline int extract_kind_from_ttype_t(const ASR::ttype_t* type) {
  ...
  switch (type->type) {
    ...
    case ASR::ttypeType::Pointer: {
      return extract_kind_from_ttype_t(
  ...
  switch (x.type) {
    case ASR::ttypeType::List: {
      ASR::List_t* list_type =
          ASR::down_cast<ASR::List_t>(type_get_past_pointer(&x));
...
inline int extract_dimensions_from_ttype(ASR::ttype_t* x,
  ...
  switch (x->type) {
    ...
    case ASR::ttypeType::Pointer: {
      n_dims = extract_dimensions_from_ttype(
          ASR::down_cast<ASR::Pointer_t>(x)->m_type, m_dims);
      break;
    }
    case ASR::ttypeType::List: {
      n_dims = 0;
...
inline bool ttype_set_dimensions(ASR::ttype_t* x, ASR::dimension_t* m_dims,
                                 int64_t n_dims) {
  switch (x->type) {
    case ASR::ttypeType::Integer: {
      ASR::Integer_t* Integer_type = ASR::down_cast<ASR::Integer_t>(x);
    ...
    case ASR::ttypeType::Pointer: {
      return ttype_set_dimensions(ASR::down_cast<ASR::Pointer_t>(x)->m_type,
                                  m_dims, n_dims);
    }
    default:
      return false;
...
static inline ASR::ttype_t* duplicate_type(
    Allocator& al, const ASR::ttype_t* t,
  ...
  switch (t->type) {
    case ASR::ttypeType::Integer: {
      ...
      return ASRUtils::TYPE(
          ASR::make_Integer_t(al, t->base.loc, tnew->m_kind, dimsp, dimsn));
    }
    case ASR::ttypeType::Real: {
      ...
      size_t dimsn = dims ? dims->n : tnew->n_dims;
      return ASRUtils::TYPE(
          ASR::make_Real_t(al, t->base.loc, tnew->m_kind, dimsp, dimsn));
    }
    case ASR::ttypeType::Complex: {
      ...
      size_t dimsn = dims ? dims->n : tnew->n_dims;
      return ASRUtils::TYPE(
          ASR::make_Complex_t(al, t->base.loc, tnew->m_kind, dimsp, dimsn));
    }
    case ASR::ttypeType::Logical: {
      ...
      size_t dimsn = dims ? dims->n : tnew->n_dims;
      return ASRUtils::TYPE(
          ASR::make_Logical_t(al, t->base.loc, tnew->m_kind, dimsp, dimsn));
    }
    case ASR::ttypeType::Character: {
      ASR::Character_t* tnew = ASR::down_cast<ASR::Character_t>(t);
      ASR::dimension_t* dimsp = dims ? dims->p : tnew->m_dims;
      size_t dimsn = dims ? dims->n : tnew->n_dims;
      return ASRUtils::TYPE(ASR::make_Character_t(al, t->base.loc, tnew->m_kind,
                                                  tnew->m_len, tnew->m_len_expr,
                                                  dimsp, dimsn));
    }
    case ASR::ttypeType::Derived: {
      ...
      ASR::dimension_t* dimsp = dims ? dims->p : tnew->m_dims;
      size_t dimsn = dims ? dims->n : tnew->n_dims;
      return ASRUtils::TYPE(ASR::make_Derived_t(
          al, t->base.loc, tnew->m_derived_type, dimsp, dimsn));
    }
    case ASR::ttypeType::Pointer: {
      ASR::Pointer_t* ptr = ASR::down_cast<ASR::Pointer_t>(t);
      ASR::ttype_t* dup_type = duplicate_type(al, ptr->m_type, dims);
      return ASRUtils::TYPE(
          ASR::make_Pointer_t(al, ptr->base.base.loc, dup_type));
    }
    case ASR::ttypeType::TypeParameter: {
      ASR::TypeParameter_t* tp = ASR::down_cast<ASR::TypeParameter_t>(t);
      ASR::dimension_t* dimsp = dims ? dims->p : tp->m_dims;
      size_t dimsn = dims ? dims->n : tp->n_dims;
      return ASRUtils::TYPE(ASR::make_TypeParameter_t(
          al, t->base.loc, tp->m_param, dimsp, dimsn, tp->m_rt, tp->n_rt));
    }
    default:
      throw LCompilersException("Not implemented " + std::to_string(t->type));
  }
...
static inline ASR::ttype_t* duplicate_type_without_dims(Allocator& al,
                                                        const ASR::ttype_t* t) {
  switch (t->type) {
    case ASR::ttypeType::Integer: {
      ASR::Integer_t* tnew = ASR::down_cast<ASR::Integer_t>(t);
      return ASRUtils::TYPE(
          ASR::make_Integer_t(al, t->base.loc, tnew->m_kind, nullptr, 0));
    }
    case ASR::ttypeType::Real: {
      ASR::Real_t* tnew = ASR::down_cast<ASR::Real_t>(t);
      return ASRUtils::TYPE(
          ASR::make_Real_t(al, t->base.loc, tnew->m_kind, nullptr, 0));
    }
    case ASR::ttypeType::Character: {
      ASR::Character_t* tnew = ASR::down_cast<ASR::Character_t>(t);
      return ASRUtils::TYPE(ASR::make_Character_t(al, t->base.loc, tnew->m_kind,
    ...
    case ASR::ttypeType::TypeParameter: {
      ASR::TypeParameter_t* tp = ASR::down_cast<ASR::TypeParameter_t>(t);
      return ASRUtils::TYPE(ASR::make_TypeParameter_t(
          al, t->base.loc, tp->m_param, nullptr, 0, tp->m_rt, tp->n_rt));
    }
    default:
      throw LCompilersException("Not implemented " + std::to_string(t->type));
  }
...
inline bool is_same_type_pointer(ASR::ttype_t* source, ASR::ttype_t* dest) {
  bool is_source_pointer = is_pointer(source),
       is_dest_pointer = is_pointer(dest);
...
inline int extract_kind(ASR::expr_t* kind_expr, const Location& loc) {
  ...
  switch (kind_expr->type) {
    case ASR::exprType::IntegerConstant: {
      a_kind = ASR::down_cast<ASR::IntegerConstant_t>(kind_expr)->m_n;
      break;
    }
    case ASR::exprType::Var: {
      ...
      if (kind_variable->m_storage == ASR::storage_typeType::Parameter) {
        if (kind_variable->m_type->type == ASR::ttypeType::Integer) {
          ...
          a_kind =
              ASR::down_cast<ASR::IntegerConstant_t>(kind_variable->m_value)
                  ->m_n;
        } else {
          std::string msg = "Integer variable required. " +
                            std::string(kind_variable->m_name) +
    ...
    default: {
      throw SemanticError(
          R"""(Only Integer literals or expressions which reduce to constant Integer are accepted as kind parameters.)""",
          loc);
    }
  }
  return a_kind;
...
inline int extract_len(ASR::expr_t* len_expr, const Location& loc) {
  ...
  switch (len_expr->type) {
    case ASR::exprType::IntegerConstant: {
      a_len = ASR::down_cast<ASR::IntegerConstant_t>(len_expr)->m_n;
      break;
    }
    case ASR::exprType::Var: {
      ASR::Var_t* len_var = ASR::down_cast<ASR::Var_t>(len_expr);
      ASR::Variable_t* len_variable = ASR::down_cast<ASR::Variable_t>(
      ...
      if (len_variable->m_storage == ASR::storage_typeType::Parameter) {
        if (len_variable->m_type->type == ASR::ttypeType::Integer) {
          ...
          a_len = ASR::down_cast<ASR::IntegerConstant_t>(len_variable->m_value)
                      ->m_n;
        } else {
          std::string msg = "Integer variable required. " +
                            std::string(len_variable->m_name) +
                            " is not an Integer variable.";
          throw SemanticError(msg, loc);
        }
      } else {
    ...
    default: {
      throw SemanticError(
          "Only Integers or variables implemented so far for `len` expressions",
          loc);
    }
  }
...
inline bool check_equal_type(ASR::ttype_t* x, ASR::ttype_t* y) {
  if (ASR::is_a<ASR::Pointer_t>(*x) || ASR::is_a<ASR::Pointer_t>(*y)) {
    ...
    return result;
  } else if (ASR::is_a<ASR::TypeParameter_t>(*x) &&
             ASR::is_a<ASR::TypeParameter_t>(*y)) {
    return true;
  }
  ...
  if (x->type == y->type && x_kind == y_kind) {
    return true;
  }
...
int select_generic_procedure(
    const Vec<ASR::call_arg_t>& args, const ASR::GenericProcedure_t& p,
    Location loc,
    const std::function<void(const std::string&, const Location&)> err,
...
static inline bool is_dimension_empty(ASR::dimension_t& dim) {
  return ((dim.m_length == nullptr) || (dim.m_start == nullptr));
}
...
static inline ASR::ttype_t* get_type_parameter(ASR::ttype_t* t) {
  switch (t->type) {
    ...
    default:
      throw LCompilersException("Cannot get type parameter from this type.");
  }
}

static inline bool has_trait(ASR::TypeParameter_t* tp, ASR::traitType rt) {
  for (size_t i = 0; i < tp->n_rt; i++) {
    ASR::Restriction_t* restriction =
        ASR::down_cast<ASR::Restriction_t>(tp->m_rt[i]);
...
class ReplaceArgVisitor : public ASR::BaseExprReplacer<ReplaceArgVisitor> {
 ...
 public:
  ReplaceArgVisitor(Allocator& al_, SymbolTable* current_scope_,
                    ASR::Function_t* orig_func_,
                    Vec<ASR::call_arg_t>& orig_args_)
      : al(al_),
        current_scope(current_scope_),
        orig_func(orig_func_),
  ...
  void replace_FunctionCall(ASR::FunctionCall_t* x) {
    ...
    if (maybe_modname == std::string(modname) && f_sym == maybe_f_actual) {
      ...
      new_es = ASR::down_cast<ASR::symbol_t>(ASR::make_ExternalSymbol_t(
          ...
          /* a_name */ unique_name_c, (ASR::symbol_t*)f, modname, nullptr, 0,
...
class ExprStmtDuplicator
    : public ASR::BaseExprStmtDuplicator<ExprStmtDuplicator> {
 public:
  ExprStmtDuplicator(Allocator& al) : BaseExprStmtDuplicator(al) {}
};

class ReplaceReturnWithGotoVisitor
    : public ASR::BaseStmtReplacer<ReplaceReturnWithGotoVisitor> {
 private:
  Allocator& al;
 ...
 public:
  ...
  void set_goto_label(uint64_t label) { goto_label = label; }

  void replace_Return(ASR::Return_t* x) {
    *current_stmt =
        ASRUtils::STMT(ASR::make_GoTo_t(al, x->base.base.loc, goto_label));
...
ASR::asr_t* make_Cast_t_value(Allocator& al, const Location& a_loc,
                              ASR::expr_t* a_arg, ASR::cast_kindType a_kind,
                              ASR::ttype_t* a_type);

static inline ASR::expr_t* compute_length_from_start_end(Allocator& al,
                                                         ASR::expr_t* start,
                                                         ASR::expr_t* end) {
  ...
  if (start_value && end_value) {
    ...
    return ASRUtils::EXPR(ASR::make_IntegerConstant_t(
        al, start->base.loc, end_int - start_int + 1,
  ...
  if (start_value && !end_value) {
    ...
    if (ASR::is_a<ASR::IntegerBinOp_t>(*end)) {
      ...
      if (end_binop->m_op == ASR::binopType::Add ||
        ...
        if (end_leftv) {
          ...
          // In all other cases the length would be (1 - start + end_left) endop
          // end_right endop is the operation of end expression and 1 - start +
          // end_left is a constant.
          ASR::expr_t* remaining_expr = ASRUtils::EXPR(
              ASR::make_IntegerConstant_t(al, end->base.loc, remaining_portion,
                                          ASRUtils::expr_type(end)));
          return ASRUtils::EXPR(ASR::make_IntegerBinOp_t(
              al, end->base.loc, remaining_expr, end_binop->m_op, end_right,
              end_binop->m_type, end_binop->m_value));
        } else if (end_rightv) {
          ...
          ASR::expr_t* remaining_expr = ASRUtils::EXPR(
              ASR::make_IntegerConstant_t(al, end->base.loc, remaining_portion,
                                          ASRUtils::expr_type(end)));
          return ASRUtils::EXPR(ASR::make_IntegerBinOp_t(
              al, end->base.loc, end_left, ASR::binopType::Add, remaining_expr,
              end_binop->m_type, end_binop->m_value));
        }
      }
    }
    ...
    if (!start_value && end_value) {
      ...
      ASR::expr_t* remaining_expr = ASRUtils::EXPR(ASR::make_IntegerConstant_t(
          al, end->base.loc, remaining_portion, ASRUtils::expr_type(end)));
      return ASRUtils::EXPR(ASR::make_IntegerBinOp_t(
          al, end->base.loc, remaining_expr, ASR::binopType::Sub, start,
          ASRUtils::expr_type(end), nullptr));
    }
    ...
    ASR::expr_t* remaining_expr = ASRUtils::EXPR(ASR::make_IntegerConstant_t(
        al, end->base.loc, remaining_portion, ASRUtils::expr_type(end)));
    return ASRUtils::EXPR(ASR::make_IntegerBinOp_t(
        al, end->base.loc, end, ASR::binopType::Add, remaining_expr,
        ASRUtils::expr_type(end), nullptr));
  }

  ASR::expr_t* diff = ASRUtils::EXPR(
      ASR::make_IntegerBinOp_t(al, end->base.loc, end, ASR::binopType::Sub,
                               start, ASRUtils::expr_type(end), nullptr));
  ASR::expr_t* constant_one =
      ASR::down_cast<ASR::expr_t>(ASR::make_IntegerConstant_t(
          al, diff->base.loc, 1, ASRUtils::expr_type(diff)));
  return ASRUtils::EXPR(ASR::make_IntegerBinOp_t(
      al, end->base.loc, diff, ASR::binopType::Add, constant_one,
      ASRUtils::expr_type(end), nullptr));
}

static inline bool is_pass_array_by_data_possible(ASR::Function_t* x,
                                                  std::vector<size_t>& v) {
...
static inline ASR::expr_t* get_bound(ASR::expr_t* arr_expr, int dim,
  ...
  ASR::ttype_t* int32_type = ASRUtils::TYPE(
      ASR::make_Integer_t(al, arr_expr->base.loc, 4, nullptr, 0));
  ASR::expr_t* dim_expr = ASRUtils::EXPR(
      ASR::make_IntegerConstant_t(al, arr_expr->base.loc, dim, int32_type));
  ASR::arrayboundType bound_type = ASR::arrayboundType::LBound;
  if (bound == "ubound") {
    bound_type = ASR::arrayboundType::UBound;
  }
  return ASRUtils::EXPR(ASR::make_ArrayBound_t(al, arr_expr->base.loc, arr_expr,
                                               dim_expr, int32_type, bound_type,
                                               nullptr));
}
...
static inline ASR::expr_t* get_size(ASR::expr_t* arr_expr, int dim,
  ...
  ASR::expr_t* dim_expr = ASRUtils::EXPR(
      ASR::make_IntegerConstant_t(al, arr_expr->base.loc, dim, int32_type));
  return ASRUtils::EXPR(ASR::make_ArraySize_t(al, arr_expr->base.loc, arr_expr,
                                              dim_expr, int32_type, nullptr));
}
