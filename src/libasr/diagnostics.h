...
namespace diag
{
    ...
    struct Label {
        ...
        Label(const std::string& message,
     ...
     */
    enum Level { Error, Warning, Note, Help, Style };

    /*
     * Which stage of the compiler the error is coming from
     */
    enum Stage { CPreprocessor, Prescanner, Tokenizer, Parser, Semantic, ASRPass, CodeGen };
    ...
    struct Diagnostic {
        ...
        Diagnostic(const std::string& message, const Level& level, const Stage& stage)
            : level{ level }
            , stage{ stage }
            , message{ message }
        {
        ...
        Diagnostic(const std::string& message,
                   const Level& level,
                   const Stage& stage,
    ...
    struct Diagnostics {
        ...
        void semantic_warning_label(const std::string& message,
                                    ...
                                    const std::string& error_label)
        {
            message_label(message, locations, error_label, Level::Warning, Stage::Semantic);
        }
        ...
        void semantic_error_label(const std::string& message,
                                  ...
                                  const std::string& error_label)
        {
            message_label(message, locations, error_label, Level::Error, Stage::Semantic);
        }
        ...
        void tokenizer_warning_label(const std::string& message,
                                     ...
                                     const std::string& error_label)
        {
            message_label(message, locations, error_label, Level::Warning, Stage::Tokenizer);
        }
        ...
        void parser_warning_label(const std::string& message,
                                  ...
                                  const std::string& error_label)
        {
            message_label(message, locations, error_label, Level::Warning, Stage::Parser);
        }
        ...
        void codegen_warning_label(const std::string& message,
                                   ...
                                   const std::string& error_label)
        {
            message_label(message, locations, error_label, Level::Warning, Stage::CodeGen);
        }
        ...
        void codegen_error_label(const std::string& message,
                                 ...
                                 const std::string& error_label)
        {
            message_label(message, locations, error_label, Level::Error, Stage::CodeGen);
        }
        ...
        void tokenizer_style_label(const std::string& message,
                                   ...
                                   const std::string& error_label)
        {
            message_label(message, locations, error_label, Level::Style, Stage::Tokenizer);
        }
        ...
        void parser_style_label(const std::string& message,
                                ...
                                const std::string& error_label)
        {
            message_label(message, locations, error_label, Level::Style, Stage::Parser);
        }
    };
    ...
    std::string render_diagnostic_human(Diagnostic& d,
                                        const std::string& input,
                                        const LocationManager& lm,
                                        bool use_colors,
                                        bool show_stacktrace);
    std::string render_diagnostic_short(Diagnostic& d,
                                        const std::string& input,
                                        const LocationManager& lm);
