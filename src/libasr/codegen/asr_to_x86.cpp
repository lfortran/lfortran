...
Result<int>
asr_to_x86(ASR::TranslationUnit_t& asr,
           Allocator& al,
           ...
           bool time_report)
{
    ...
    if (time_report) {
        ...
        int total = time_pass_global + time_pass_do_loops + time_visit_asr + time_verify
                    + time_verify + time_save;
