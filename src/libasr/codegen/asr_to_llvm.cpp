...
class ASRToLLVMVisitor : public ASR::BaseVisitor<ASRToLLVMVisitor> {
 ...
 public:
  ...
  ASRToLLVMVisitor(Allocator& al, llvm::LLVMContext& context, Platform platform,
      ...
      : diag{diagnostics},
        ...
        list_api(std::make_unique<LLVMList>(context, llvm_utils.get(),
                                            builder.get())),
        tuple_api(std::make_unique<LLVMTuple>(context, llvm_utils.get(),
                                              builder.get())),
        dict_api(std::make_unique<LLVMDictOptimizedLinearProbing>(
            context, llvm_utils.get(), builder.get())),
        arr_descr(LLVMArrUtils::Descriptor::get_descriptor(
            context, builder.get(), llvm_utils.get(),
  ...
  llvm::Type* get_el_type(ASR::ttype_t* m_type_) {
  ...
  */
  inline void fill_malloc_array_details(llvm::Value* arr,
  ...
  inline llvm::Type* getIntType(int a_kind, bool get_pointer = false) {
    ...
    if (get_pointer) {
      switch (a_kind) {
        ...
        default:
          throw CodeGenError(
              "Only 8, 16, 32 and 64 bits integer kinds are supported.");
      }
    } else {
      switch (a_kind) {
        case 1:
  ...
  llvm::Type* getDerivedType(ASR::DerivedType_t* der_type,
    ...
    if (name2dertype.find(der_type_name) != name2dertype.end()) {
      ...
      const std::map<std::string, ASR::symbol_t*>& scope =
          der_type->m_symtab->get_scope();
      ...
      der_type_llvm =
          llvm::StructType::create(context, member_types, der_type_name);
  ...
  llvm::Type* getDerivedType(ASR::ttype_t* _type, bool is_pointer = false) {
    ...
    if (der->m_derived_type->type == ASR::symbolType::ExternalSymbol) {
      ASR::ExternalSymbol_t* der_extr =
          (ASR::ExternalSymbol_t*)(&(der->m_derived_type->base));
  ...
  llvm::Type* getClassType(ASR::ttype_t* _type, bool is_pointer = false) {
    ...
    if (der->m_class_type->type == ASR::symbolType::ExternalSymbol) {
      ASR::ExternalSymbol_t* der_extr =
          (ASR::ExternalSymbol_t*)(&(der->m_class_type->base));
      der_sym = der_extr->m_external;
    } else {
      ...
      for (auto itr = scope.begin(); itr != scope.end(); itr++) {
        if (!ASR::is_a<ASR::ClassProcedure_t>(*itr->second) &&
          ...
          ASR::Variable_t* member =
              ASR::down_cast<ASR::Variable_t>(itr->second);
   ...
   * @param runtime_func_name std::string The name of the function to be
   * dispatched from runtime library.
   ...
   */
  llvm::Value* lfortran_complex_bin_op(llvm::Value* left_arg,
    ...
    if (!fn) {
      llvm::FunctionType* function_type = llvm::FunctionType::get(
          llvm::Type::getVoidTy(context),
          {complex_type->getPointerTo(), complex_type->getPointerTo(),
           complex_type->getPointerTo()},
          true);
      fn =
          llvm::Function::Create(function_type, llvm::Function::ExternalLinkage,
                                 runtime_func_name, *module);
    }

    llvm::AllocaInst* pleft_arg = builder->CreateAlloca(complex_type, nullptr);

    builder->CreateStore(left_arg, pleft_arg);
    llvm::AllocaInst* pright_arg = builder->CreateAlloca(complex_type, nullptr);
    builder->CreateStore(right_arg, pright_arg);
    llvm::AllocaInst* presult = builder->CreateAlloca(complex_type, nullptr);
  ...
  llvm::Value* lfortran_strop(llvm::Value* left_arg, llvm::Value* right_arg,
    ...
    if (!fn) {
      llvm::FunctionType* function_type = llvm::FunctionType::get(
          llvm::Type::getVoidTy(context),
          {character_type->getPointerTo(), character_type->getPointerTo(),
    ...
    llvm::AllocaInst* pleft_arg =
        builder->CreateAlloca(character_type, nullptr);
    builder->CreateStore(left_arg, pleft_arg);
    llvm::AllocaInst* pright_arg =
        builder->CreateAlloca(character_type, nullptr);
    builder->CreateStore(right_arg, pright_arg);
  ...
  llvm::Value* lfortran_strrepeat(llvm::Value* left_arg,
                                  llvm::Value* right_arg) {
    ...
    if (!fn) {
      llvm::FunctionType* function_type = llvm::FunctionType::get(
          llvm::Type::getVoidTy(context),
          {character_type->getPointerTo(), llvm::Type::getInt32Ty(context),
           character_type->getPointerTo()},
          false);
      fn =
          llvm::Function::Create(function_type, llvm::Function::ExternalLinkage,
    ...
    if (!fn) {
      llvm::FunctionType* function_type =
          llvm::FunctionType::get(llvm::Type::getInt32Ty(context),
                                  {character_type->getPointerTo()}, false);
      fn =
          llvm::Function::Create(function_type, llvm::Function::ExternalLinkage,
                                 runtime_func_name, *module);
    }
  ...
  llvm::Value* lfortran_str_chr(llvm::Value* str) {
    ...
    if (!fn) {
      llvm::FunctionType* function_type = llvm::FunctionType::get(
          character_type, {llvm::Type::getInt32Ty(context)}, false);
      fn =
          llvm::Function::Create(function_type, llvm::Function::ExternalLinkage,
                                 runtime_func_name, *module);
    }
  ...
  llvm::Value* lfortran_str_copy(llvm::Value* str, llvm::Value* idx1,
                                 llvm::Value* idx2) {
  ...
  llvm::Value* lfortran_str_slice(llvm::Value* str, llvm::Value* idx1,
                                  llvm::Value* idx2, llvm::Value* step,
                                  llvm::Value* left_present,
                                  llvm::Value* right_present) {
    ...
    return builder->CreateCall(
        fn, {str, idx1, idx2, step, left_present, right_present});
  }

  llvm::Value* lfortran_type_to_str(llvm::Value* arg, llvm::Type* value_type,
                                    std::string type, int value_kind) {
    std::string func_name =
        "_lfortran_" + type + "_to_str" + std::to_string(value_kind);
    llvm::Function* fn = module->getFunction(func_name);
    if (!fn) {
      llvm::FunctionType* function_type =
          llvm::FunctionType::get(character_type, {value_type}, false);
      fn = llvm::Function::Create(
          function_type, llvm::Function::ExternalLinkage, func_name, *module);
    }
  ...
  void visit_TranslationUnit(const ASR::TranslationUnit_t& x) {
    ...
    std::vector<llvm::Type*> els_4 = {llvm::Type::getFloatTy(context),
                                      llvm::Type::getFloatTy(context)};
    std::vector<llvm::Type*> els_8 = {llvm::Type::getDoubleTy(context),
                                      llvm::Type::getDoubleTy(context)};
    std::vector<llvm::Type*> els_4_ptr = {llvm::Type::getFloatPtrTy(context),
                                          llvm::Type::getFloatPtrTy(context)};
    std::vector<llvm::Type*> els_8_ptr = {llvm::Type::getDoublePtrTy(context),
    ...
    complex_type_4_ptr =
        llvm::StructType::create(context, els_4_ptr, "complex_4_ptr");
    complex_type_8_ptr =
        llvm::StructType::create(context, els_8_ptr, "complex_8_ptr");
    character_type = llvm::Type::getInt8PtrTy(context);
    list_type = llvm::Type::getInt8PtrTy(context);

    llvm::Type* bound_arg = static_cast<llvm::Type*>(
        arr_descr->get_dimension_descriptor_type(true));
    fname2arg_type["lbound"] =
        std::make_pair(bound_arg, bound_arg->getPointerTo());
    fname2arg_type["ubound"] =
        std::make_pair(bound_arg, bound_arg->getPointerTo());
    ...
    for (auto& item : x.m_global_scope->get_scope()) {
      if (is_a<ASR::Module_t>(*item.second) &&
          item.first.find("lfortran_intrinsic_optimization") !=
              std::string::npos) {
        ASR::Module_t* mod = ASR::down_cast<ASR::Module_t>(item.second);
        for (auto& moditem : mod->m_symtab->get_scope()) {
          ASR::symbol_t* sym =
              ASRUtils::symbol_get_past_external(moditem.second);
    ...
    std::vector<std::string> build_order = determine_module_dependencies(x);
    for (auto& item : build_order) {
      LFORTRAN_ASSERT(x.m_global_scope->get_symbol(item) != nullptr);
  ...
  void visit_Allocate(const ASR::Allocate_t& x) {
    ...
    if (x.m_stat) {
      ...
      if (llvm_symtab.find(h) != llvm_symtab.end()) {
        ...
        throw CodeGenError(
            "Stat variable in allocate not found in LLVM symtab");
      }
    }
  }
  ...
  void _Deallocate(const T& x) {
    ...
    if (!free_fn) {
      llvm::FunctionType* function_type = llvm::FunctionType::get(
          llvm::Type::getVoidTy(context), {character_type}, true);
    ...
    for (size_t i = 0; i < x.n_vars; i++) {
      ...
      ASR::Variable_t* v =
          ASR::down_cast<ASR::Variable_t>(symbol_get_past_external(curr_obj));
      fetch_var(v);
  ...
  void visit_ListConstant(const ASR::ListConstant_t& x) {
    ...
    llvm::Type* llvm_el_type = get_type_from_ttype_t(
        list_type->m_type, ASR::storage_typeType::Default, is_array_type_local,
        is_malloc_array_type_local, is_list_local, m_dims_local, n_dims_local,
        a_kind_local);
    ...
    llvm::Type* const_list_type =
        list_api->get_list_type(llvm_el_type, type_code, type_size);
    llvm::Value* const_list =
        builder->CreateAlloca(const_list_type, nullptr, "const_list");
  ...
  void visit_DictConstant(const ASR::DictConstant_t& x) {
    ...
    llvm::Value* const_dict =
        builder->CreateAlloca(const_dict_type, nullptr, "const_dict");
    ...
    dict_api->dict_init(key_type_code, value_type_code, const_dict,
                        module.get(), x.n_keys);
    uint64_t ptr_loads_key = LLVM::is_llvm_struct(x_dict->m_key_type) ? 0 : 2;
    uint64_t ptr_loads_value =
        LLVM::is_llvm_struct(x_dict->m_value_type) ? 0 : 2;
    uint64_t ptr_loads_copy = ptr_loads;
  ...
  void visit_TupleConstant(const ASR::TupleConstant_t& x) {
    ...
    std::string type_code =
        ASRUtils::get_type_code(tuple_type->m_type, tuple_type->n_type);
    ...
    for (size_t i = 0; i < tuple_type->n_type; i++) {
      llvm_el_types.push_back(get_type_from_ttype_t(
          tuple_type->m_type[i], m_storage, is_array_type, is_malloc_array_type,
          is_list, m_dims, n_dims, a_kind));
    }
    llvm::Type* const_tuple_type =
        tuple_api->get_tuple_type(type_code, llvm_el_types);
    llvm::Value* const_tuple =
        builder->CreateAlloca(const_tuple_type, nullptr, "const_tuple");
  ...
  void visit_IntegerBitLen(const ASR::IntegerBitLen_t& x) {
    ...
    std::string runtime_func_name =
        "_lpython_bit_length" + std::to_string(int_kind);
    llvm::Function* fn = module->getFunction(runtime_func_name);
    if (!fn) {
      llvm::FunctionType* function_type = llvm::FunctionType::get(
          llvm::Type::getInt32Ty(context), {getIntType(int_kind)}, false);
      fn =
          llvm::Function::Create(function_type, llvm::Function::ExternalLinkage,
                                 runtime_func_name, *module);
    }
  ...
  void visit_ListAppend(const ASR::ListAppend_t& x) {
    ASR::List_t* asr_list =
        ASR::down_cast<ASR::List_t>(ASRUtils::expr_type(x.m_a));
    uint64_t ptr_loads_copy = ptr_loads;
    ptr_loads = 0;
  ...
  void visit_ListItem(const ASR::ListItem_t& x) {
    ...
    tmp = list_api->read_item(
        plist, pos, (LLVM::is_llvm_struct(el_type) || ptr_loads == 0));
  }
  ...
  void visit_ArrayItem(const ASR::ArrayItem_t& x) {
    ...
    if (ASR::is_a<ASR::Var_t>(*x.m_v)) {
      ...
      if (ASR::is_a<ASR::Derived_t>(*ASRUtils::expr_type(x.m_v))) {
        ASR::Derived_t* der_type =
            ASR::down_cast<ASR::Derived_t>(ASRUtils::expr_type(x.m_v));
        der_type_name = ASRUtils::symbol_name(
            ASRUtils::symbol_get_past_external(der_type->m_derived_type));
      }
      ptr_loads = ptr_loads_copy;
    ...
    if (ASR::is_a<ASR::Character_t>(*x.m_type) && n_dims == 0) {
      // String indexing:
      if (x.n_args != 1) {
        throw CodeGenError("Only string(a) supported for now.",
                           x.base.base.loc);
      }
      ...
      // TODO: Currently the string starts at the right location, but goes to
      // the end of the original string. We have to allocate a new string, copy
      // it and add null termination.
      ...
      bool is_data_only =
          is_argument && !ASRUtils::is_dimension_empty(m_dims, n_dims);
  ...
  void visit_ArraySection(const ASR::ArraySection_t& x) {
    ...
    llvm::Value* idx1 = tmp;
    // idx = builder->CreateSub(idx, llvm::ConstantInt::get(context,
    // llvm::APInt(32, 1)));
    // std::vector<llvm::Value*> idx_vec = {llvm::ConstantInt::get(context,
    // llvm::APInt(32, 0)), idx};
    // std::vector<llvm::Value*> idx_vec = {idx};
    llvm::Value* str = CreateLoad(array);
    // llvm::Value *p = CreateGEP(str, idx_vec);
    // TODO: Currently the string starts at the right location, but goes to the
    // end of the original string. We have to allocate a new string, copy it and
  ...
  void visit_DerivedRef(const ASR::DerivedRef_t& x) {
    ...
    ptr_loads = ptr_loads_copy;
    ASR::Variable_t* member =
        down_cast<ASR::Variable_t>(symbol_get_past_external(x.m_m));
    std::string member_name = std::string(member->m_name);
    LFORTRAN_ASSERT(der_type_name.size() != 0);
    while (name2memidx[der_type_name].find(member_name) ==
           name2memidx[der_type_name].end()) {
      if (dertype2parent.find(der_type_name) == dertype2parent.end()) {
        throw CodeGenError(
            der_type_name + " doesn't have any member named " + member_name,
            x.base.base.loc);
      }
    ...
    if (ASR::is_a<ASR::DerivedRef_t>(*x.m_v) && is_nested_pointer(tmp)) {
      tmp = CreateLoad(tmp);
    }
    ...
    if (member_type->type == ASR::ttypeType::Derived) {
      ...
      ASR::DerivedType_t* der_type =
          (ASR::DerivedType_t*)(&(der->m_derived_type->base));
  ...
  void visit_Variable(const ASR::Variable_t& x) {
    ...
    if (x.m_type->type == ASR::ttypeType::Integer) {
      ...
      if (!external) {
        if (init_value) {
          ...
          module->getNamedGlobal(x.m_name)->setInitializer(
              llvm::ConstantInt::get(context, llvm::APInt(init_value_bits, 0)));
        }
      }
      llvm_symtab[h] = ptr;
      ...
      if (!external) {
        if (init_value) {
          ...
          if (init_value_bits == 32) {
            ...
            module->getNamedGlobal(x.m_name)->setInitializer(
                llvm::ConstantFP::get(context, llvm::APFloat((double)0)));
          }
        }
      }
      llvm_symtab[h] = ptr;
      ...
      llvm::Constant* ptr =
          module->getOrInsertGlobal(x.m_name, llvm::Type::getInt1Ty(context));
      if (!external) {
        if (init_value) {
          module->getNamedGlobal(x.m_name)->setInitializer(init_value);
        } else {
      ...
      llvm::Constant* ptr = module->getOrInsertGlobal(x.m_name, character_type);
      if (!external) {
        if (init_value) {
          module->getNamedGlobal(x.m_name)->setInitializer(init_value);
        } else {
      ...
      llvm::Constant* ptr = module->getOrInsertGlobal(x.m_name, void_ptr);
      if (!external) {
        if (init_value) {
          module->getNamedGlobal(x.m_name)->setInitializer(init_value);
        } else {
      ...
      llvm::Type* x_ptr = get_type_from_ttype_t(
          x.m_type, x.m_storage, is_array_type, is_malloc_array_type, is_list,
          m_dims, n_dims, a_kind);
      llvm::Constant* ptr = module->getOrInsertGlobal(x.m_name, x_ptr);
      if (!external) {
        if (init_value) {
          module->getNamedGlobal(x.m_name)->setInitializer(init_value);
        } else {
  ...
  void start_module_init_function_prototype(const ASR::Module_t& x) {
    ...
    std::string module_fn_name =
        "__lfortran_module_init_" + std::string(x.m_name);
    llvm::Function* F =
        llvm::Function::Create(function_type, llvm::Function::ExternalLinkage,
                               module_fn_name, module.get());
   ...
   */
  bool is_argument(ASR::Variable_t* v, ASR::expr_t** m_args, int n_args) {
  ...
  llvm::Type* get_dict_type(ASR::ttype_t* asr_type) {
    ...
    llvm::Type* key_llvm_type = get_type_from_ttype_t(
        asr_dict->m_key_type, local_m_storage, is_local_array_type,
        is_local_malloc_array_type, is_local_list, local_m_dims, local_n_dims,
        local_a_kind);
    int32_t key_type_size =
        get_type_size(asr_dict->m_key_type, key_llvm_type, local_a_kind);
    llvm::Type* value_llvm_type = get_type_from_ttype_t(
        asr_dict->m_value_type, local_m_storage, is_local_array_type,
        is_local_malloc_array_type, is_local_list, local_m_dims, local_n_dims,
        local_a_kind);
    ...
    std::string value_type_code =
        ASRUtils::get_type_code(asr_dict->m_value_type);
    return dict_api->get_dict_type(key_type_code, value_type_code,
                                   key_type_size, value_type_size,
                                   key_llvm_type, value_llvm_type);
  }

  llvm::Type* get_type_from_ttype_t(ASR::ttype_t* asr_type,
                                    ASR::storage_typeType m_storage,
                                    bool& is_array_type,
                                    bool& is_malloc_array_type, bool& is_list,
                                    ASR::dimension_t*& m_dims, int& n_dims,
                                    int& a_kind) {
    ...
    switch (asr_type->type) {
      case (ASR::ttypeType::Integer): {
        ...
        if (n_dims > 0) {
          ...
          if (m_storage == ASR::storage_typeType::Allocatable) {
            ...
            llvm_type = arr_descr->get_malloc_array_type(asr_type, a_kind,
                                                         n_dims, el_type);
          } else {
            llvm_type =
                arr_descr->get_array_type(asr_type, a_kind, n_dims, el_type);
          }
        } else {
      ...
      case (ASR::ttypeType::List): {
        ...
        llvm::Type* el_llvm_type = get_type_from_ttype_t(
            asr_list->m_type, m_storage, is_array_type, is_malloc_array_type,
            is_list, m_dims, n_dims, a_kind);
        ...
        llvm_type =
            list_api->get_list_type(el_llvm_type, el_type_code, type_size);
        break;
      }
      ...
      case (ASR::ttypeType::Tuple): {
        ...
        std::string type_code =
            ASRUtils::get_type_code(asr_tuple->m_type, asr_tuple->n_type);
        std::vector<llvm::Type*> llvm_el_types;
        for (size_t i = 0; i < asr_tuple->n_type; i++) {
          ...
          int local_n_dims = 0;
          int local_a_kind = -1;
          ASR::storage_typeType local_m_storage =
              ASR::storage_typeType::Default;
          llvm_el_types.push_back(get_type_from_ttype_t(
              asr_tuple->m_type[i], local_m_storage, is_local_array_type,
              is_local_malloc_array_type, is_local_list, local_m_dims,
              local_n_dims, local_a_kind));
        }
      ...
      default:
        throw CodeGenError("Support for type " +
    ...
    for (auto& item : x.m_symtab->get_scope()) {
      if (is_a<ASR::Variable_t>(*item.second)) {
        ...
        if (v->m_intent == intent_local || v->m_intent == intent_return_var ||
          ...
          if (x.class_type == ASR::symbolType::Function) {
            ...
            if (is_array_type && !is_list) {
              ...
              if (abi_type == ASR::abiType::Source && is_v_arg) {
                type = arr_descr->get_argument_type(type, m_h, v->m_name,
                                                    arr_arg_type_cache);
                is_array_type = false;
          ...
          llvm::AllocaInst* ptr =
              builder->CreateAlloca(type, nullptr, v->m_name);
          llvm_symtab[h] = ptr;
          if (is_malloc_array_type &&
              v->m_type->type != ASR::ttypeType::Pointer && !is_list) {
          ...
          if (v->m_symbolic_value != nullptr &&
            ...
            auto finder =
                std::find(nested_globals.begin(), nested_globals.end(), h);
            if (finder != nested_globals.end()) {
              llvm::Value* ptr = module->getOrInsertGlobal(
                  nested_desc_name, nested_global_struct);
              int idx = std::distance(nested_globals.begin(), finder);
              builder->CreateStore(target_var,
                                   llvm_utils->create_gep(ptr, idx));
            }
          } else {
            if (is_a<ASR::Character_t>(*v->m_type) && !is_array_type &&
              ...
              if (strlen >= 0) {
                ...
                llvm::Value* init_value =
                    builder->CreateGlobalStringPtr(s2c(al, empty));
                builder->CreateStore(init_value, target_var);
              } else if (strlen == -2) {
                ...
                arg_size = builder->CreateAdd(
                    arg_size,
                    llvm::ConstantInt::get(context, llvm::APInt(32, 1)));
                // TODO: this temporary string is never deallocated (leaks
                // memory)
                llvm::Value* init_value =
                    LLVM::lfortran_malloc(context, *module, *builder, arg_size);
  ...
  llvm::Type* get_arg_type_from_ttype_t(
      ASR::ttype_t* asr_type, ASR::abiType m_abi, ASR::abiType arg_m_abi,
      ASR::storage_typeType m_storage, bool arg_m_value_attr, int& n_dims,
      int& a_kind, bool& is_array_type, ASR::intentType arg_intent) {
    llvm::Type* type = nullptr;
    switch (asr_type->type) {
      case (ASR::ttypeType::Integer): {
        ASR::Integer_t* v_type = down_cast<ASR::Integer_t>(asr_type);
        ...
        if (n_dims > 0) {
          if (m_abi == ASR::abiType::BindC ||
            ...
            llvm::Type* el_type = get_el_type(asr_type);
            if (m_storage == ASR::storage_typeType::Allocatable) {
              type = arr_descr->get_malloc_array_type(asr_type, a_kind, n_dims,
                                                      el_type, true);
            } else {
              type = arr_descr->get_array_type(asr_type, a_kind, n_dims,
                                               el_type, true);
            }
          }
        } else {
          if (arg_m_abi == ASR::abiType::BindC && arg_m_value_attr) {
      ...
      case (ASR::ttypeType::Pointer): {
        ...
        type = get_arg_type_from_ttype_t(t2, m_abi, arg_m_abi, m_storage,
                                         arg_m_value_attr, n_dims, a_kind,
      ...
      case (ASR::ttypeType::Complex): {
        ...
        if (m_abi != ASR::abiType::BindC &&
          ...
          if (m_storage == ASR::storage_typeType::Allocatable) {
            ...
            type = arr_descr->get_array_type(asr_type, a_kind, n_dims, el_type,
                                             true);
          }
        } else {
          if (arg_m_abi == ASR::abiType::BindC && arg_m_value_attr) {
            if (a_kind == 4) {
              if (platform == Platform::Windows) {
                ...
                // type_fx2 is <2 x float>
                llvm::Type* type_fx2 =
                    FIXED_VECTOR_TYPE::get(llvm::Type::getFloatTy(context), 2);
                type = type_fx2;
              }
            } else {
      ...
      case (ASR::ttypeType::Tuple): {
        ...
        for (size_t i = 0; i < asr_tuple->n_type; i++) {
          ...
          ASR::storage_typeType local_m_storage =
              ASR::storage_typeType::Default;
          llvm_el_types.push_back(get_arg_type_from_ttype_t(
              asr_tuple->m_type[i], m_abi, arg_m_abi, local_m_storage,
              arg_m_value_attr, local_n_dims, local_a_kind, is_local_array_type,
              ASRUtils::intent_local));
        }
        type =
            tuple_api->get_tuple_type(type_code, llvm_el_types)->getPointerTo();
        break;
      }
      case (ASR::ttypeType::List): {
        bool is_array_type = false, is_malloc_array_type = false;
        ...
        std::string el_type_code = ASRUtils::get_type_code(asr_list->m_type);
        type = list_api->get_list_type(el_llvm_type, el_type_code, type_size)
                   ->getPointerTo();
        break;
      }
      default:
  ...
  std::vector<llvm::Type*> convert_args(const T& x) {
    ...
    for (size_t i = 0; i < x.n_args; i++) {
      if (is_a<ASR::Variable_t>(*symbol_get_past_external(
        ...
        int n_dims = 0, a_kind = 4;
        bool is_array_type = false;
        type = get_arg_type_from_ttype_t(
            arg->m_type, x.m_abi, arg->m_abi, arg->m_storage, arg->m_value_attr,
        ...
        if (is_array_type && arg->m_type->type != ASR::ttypeType::Pointer) {
          if (x.m_abi == ASR::abiType::Source) {
            llvm::Type* orig_type =
                static_cast<llvm::PointerType*>(type)->getElementType();
            type = arr_descr->get_argument_type(orig_type, m_h, arg->m_name,
                                                arr_arg_type_cache);
            is_array_type = false;
        ...
        ASR::Function_t* fn =
            ASR::down_cast<ASR::Function_t>(symbol_get_past_external(
                ASR::down_cast<ASR::Var_t>(x.m_args[i])->m_v));
  ...
  void push_nested_stack(const T& x) {
    ...
    bool is_nested_call = std::find(nesting_map[parent_function_hash].begin(),
                                    nesting_map[parent_function_hash].end(),
                                    calling_function_hash) !=
                          nesting_map[parent_function_hash].end();
        ...
        if (is_a<ASR::Variable_t>(*item.second)) {
          ...
          if (finder != nested_globals.end()) {
            ...
            llvm::Value* glob_struct = module->getOrInsertGlobal(
                nested_desc_name, nested_global_struct);
            llvm::Value* target =
                CreateLoad(llvm_utils->create_gep(glob_struct, idx));
            llvm::Value* glob_stack = module->getOrInsertGlobal(
                nested_stack_name, nested_global_stack);
            llvm::Value* glob_stack_gep =
                llvm_utils->create_gep(glob_stack, sp_val);
            llvm::Value* glob_stack_elem =
                llvm_utils->create_gep(glob_stack_gep, idx);
            builder->CreateStore(CreateLoad(target), glob_stack_elem);
            llvm::Value* glob_stack_val = CreateLoad(glob_stack_gep);
            llvm::Value* glob_stack_sp =
                llvm_utils->create_gep(glob_stack, sp_val);
            builder->CreateStore(glob_stack_val, glob_stack_sp);
          }
        }
      }
      builder->CreateStore(builder->CreateAdd(builder->getInt32(1), sp_val),
                           sp_loc);
    }
  }
  ...
  void pop_nested_stack(const T& x) {
    ...
    if (nested_func_types[calling_function_hash].size() > 0 &&
      ...
      llvm::Value* sp_loc = module->getOrInsertGlobal(
          nested_sp_name, llvm::Type::getInt32Ty(context));
      llvm::Value* sp_val = CreateLoad(sp_loc);
      llvm::BasicBlock* dec_sp =
          llvm::BasicBlock::Create(context, "decrement_sp", lfn);
      llvm::BasicBlock* norm_cont =
          llvm::BasicBlock::Create(context, "normal_continue", lfn);
      llvm::Value* cond = builder->CreateICmpSGT(sp_val, builder->getInt32(0));
        ...
        if (is_a<ASR::Variable_t>(*item.second)) {
          ...
          if (finder != nested_globals.end()) {
            ...
            llvm::Value* sp_loc = module->getOrInsertGlobal(
                nested_sp_name, llvm::Type::getInt32Ty(context));
            llvm::Value* sp_val = CreateLoad(sp_loc);
            llvm::Value* glob_stack_elem = CreateLoad(llvm_utils->create_gep(
                llvm_utils->create_gep(glob_stack, sp_val), idx));
            llvm::Value* glob_struct_loc = module->getOrInsertGlobal(
                nested_desc_name, nested_global_struct);
            llvm::Value* target =
                CreateLoad(llvm_utils->create_gep(glob_struct_loc, idx));
            builder->CreateStore(glob_stack_elem, target);
            builder->CreateStore(target,
    ...
    for (llvm::Argument& llvm_arg : F.args()) {
      if (is_a<ASR::Variable_t>(*symbol_get_past_external(
        ...
        if (finder != nested_globals.end()) {
          ...
          int idx = std::distance(nested_globals.begin(), finder);
          builder->CreateStore(&llvm_arg, llvm_utils->create_gep(ptr, idx));
        }
      ...
      */
      ...
      if (llvm_symtab_fn_names.find(fn_name) == llvm_symtab_fn_names.end()) {
        ...
        F = llvm::Function::Create(function_type,
                                   llvm::Function::ExternalLinkage, fn_name,
                                   module.get());
      } else {
    ...
    if (x.m_return_var) {
      ...
      switch (return_var_type) {
        ...
        case (ASR::ttypeType::Derived):
          ...
          break;
        case (ASR::ttypeType::Tuple): {
          ASR::Tuple_t* asr_tuple =
              ASR::down_cast<ASR::Tuple_t>(return_var_type0);
          std::string type_code =
              ASRUtils::get_type_code(asr_tuple->m_type, asr_tuple->n_type);
          std::vector<llvm::Type*> llvm_el_types;
          for (size_t i = 0; i < asr_tuple->n_type; i++) {
            bool is_local_array_type = false,
                 is_local_malloc_array_type = false;
            bool is_local_list = false;
            ASR::dimension_t* local_m_dims = nullptr;
            int local_n_dims = 0;
            int local_a_kind = -1;
  ...
  void declare_needed_global_types(T& x) {
    ...
    if (nested_func_types[h].size() > 0) {
      ...
      nested_global_struct = llvm::StructType::create(
          context, nested_type, std::string(x.m_name) + "_nstd_types");
      ...
      initializer = llvm::ConstantAggregateZero::get(nested_global_struct);
      module->getNamedGlobal(nested_desc_name)->setInitializer(initializer);
      if (std::find(nested_call_out.begin(), nested_call_out.end(), h) !=
        ...
        recursion, etc */
        nested_global_struct_vals = llvm::StructType::create(
            context, nested_stack, std::string(x.m_name) + "_vals");
        nested_global_stack =
            llvm::ArrayType::get(nested_global_struct_vals, 1000);
        ...
        initializer = llvm::ConstantAggregateZero::get(nested_global_stack);
        module->getNamedGlobal(nested_stack_name)->setInitializer(initializer);
        llvm::ConstantInt* sp_init =
            llvm::ConstantInt::get(module->getContext(), llvm::APInt(32, 0));
        module->getNamedGlobal(nested_sp_name)->setInitializer(sp_init);
      }
    }
  }
  ...
  void generate_function(const ASR::Function_t& x) {
    ...
    if (x.m_deftype == ASR::deftypeType::Implementation) {
      ...
      if (m_name == "lbound" || m_name == "ubound") {
        ...
        llvm::Value* dim_struct =
            arr_descr->get_pointer_to_dimension_descriptor(dim_des_val,
                                                           dim_val);
  ...
  bool is_nested_pointer(llvm::Value* val) {
    ...
    // Related issue,
    // https://github.com/lcompilers/lpython/pull/707#issuecomment-1169773106.
  ...
  void visit_CLoc(const ASR::CLoc_t& x) {
    ...
    tmp = builder->CreateBitCast(
        tmp, llvm::Type::getVoidTy(context)->getPointerTo());
  }
  ...
  void visit_CPtrToPointer(const ASR::CPtrToPointer_t& x) {
    ...
    if (ASRUtils::is_array(ASRUtils::expr_type(fptr))) {
      ...
      llvm_fptr_type =
          static_cast<llvm::PointerType*>(llvm_fptr_type)->getElementType();
      llvm_fptr_type =
          static_cast<llvm::PointerType*>(llvm_fptr_type)->getElementType();
      ...
      int fptr_rank = ASRUtils::extract_dimensions_from_ttype(
          ASRUtils::expr_type(fptr), fptr_dims);
      llvm::Value* llvm_rank =
          llvm::ConstantInt::get(context, llvm::APInt(32, fptr_rank));
      llvm::Value* dim_des = builder->CreateAlloca(
          arr_descr->get_dimension_descriptor_type(), llvm_rank);
      builder->CreateStore(dim_des,
      ...
      llvm::Value* fptr_des =
          arr_descr->get_pointer_to_dimension_descriptor_array(llvm_fptr);
      ...
      llvm_cptr = builder->CreateBitCast(
          llvm_cptr, static_cast<llvm::PointerType*>(fptr_data->getType())
                         ->getElementType());
      ...
      for (int i = 0; i < fptr_rank; i++) {
        ...
        llvm::Value* desi =
            arr_descr->get_pointer_to_dimension_descriptor(fptr_des, curr_dim);
        llvm::Value* desi_lb = arr_descr->get_lower_bound(desi, false);
        llvm::Value* desi_size =
            arr_descr->get_dimension_size(fptr_des, curr_dim, false);
        llvm::Value* i32_one =
            llvm::ConstantInt::get(context, llvm::APInt(32, 1));
        llvm::Value* new_lb = i32_one;
        llvm::Value* new_ub =
            shape_data ? CreateLoad(llvm_utils->create_ptr_gep(shape_data, i))
                       : i32_one;
        builder->CreateStore(new_lb, desi_lb);
        builder->CreateStore(
            builder->CreateAdd(builder->CreateSub(new_ub, new_lb), i32_one),
            desi_size);
      }
    } else {
      uint64_t ptr_loads_copy = ptr_loads;
      ...
      ptr_loads = ptr_loads_copy;
      llvm_cptr = builder->CreateBitCast(
          llvm_cptr, static_cast<llvm::PointerType*>(llvm_fptr->getType())
                         ->getElementType());
  ...
  void visit_Assignment(const ASR::Assignment_t& x) {
    ...
    if (is_target_list && is_value_list) {
      ...
      ptr_loads = ptr_loads_copy;
      ASR::List_t* value_asr_list =
          ASR::down_cast<ASR::List_t>(ASRUtils::expr_type(x.m_value));
      std::string value_type_code =
          ASRUtils::get_type_code(value_asr_list->m_type);
      list_api->list_deepcopy(value_list, target_list, value_asr_list, *module);
      return;
      ...
      if (ASR::is_a<ASR::TupleConstant_t>(*x.m_target) &&
        ...
        ASR::TupleConstant_t* const_tuple =
            ASR::down_cast<ASR::TupleConstant_t>(x.m_target);
        ...
        ptr_loads = ptr_loads_copy;
                 ...
                 ASR::is_a<ASR::TupleConstant_t>(*x.m_value)) {
        ASR::TupleConstant_t* asr_value_tuple =
            ASR::down_cast<ASR::TupleConstant_t>(x.m_value);
        ...
        for (size_t i = 0; i < asr_value_tuple->n_elements; i++) {
          ASR::ttype_t* asr_tuple_i_type =
              ASRUtils::expr_type(asr_value_tuple->m_elements[i]);
          llvm::Type* llvm_tuple_i_type =
              get_type_from_ttype_t_util(asr_tuple_i_type);
          llvm::Value* llvm_tuple_i =
              builder->CreateAlloca(llvm_tuple_i_type, nullptr);
        ...
        ptr_loads = ptr_loads_copy;
        ASR::Tuple_t* value_tuple_type =
            ASR::down_cast<ASR::Tuple_t>(asr_value_type);
        std::string type_code = ASRUtils::get_type_code(
            value_tuple_type->m_type, value_tuple_type->n_type);
        tuple_api->tuple_deepcopy(value_tuple, target_tuple, value_tuple_type,
                                  *module);
      }
      return;
      ...
      ptr_loads = ptr_loads_copy;
      ASR::Dict_t* value_dict_type =
          ASR::down_cast<ASR::Dict_t>(asr_value_type);
      dict_api->dict_deepcopy(value_dict, target_dict, value_dict_type,
                              module.get());
      return;
    }
      ...
      if (is_a<ASR::ArrayItem_t>(*x.m_target)) {
        ...
        if (is_a<ASR::Var_t>(*asr_target0->m_v)) {
          ...
          if (is_a<ASR::Character_t>(*asr_target->m_type)) {
            ASR::Character_t* t =
                ASR::down_cast<ASR::Character_t>(asr_target->m_type);
            if (t->n_dims == 0) {
        ...
        ASR::ArraySection_t* asr_target0 =
        ...
        ASR::ListItem_t* asr_target0 =
            ASR::down_cast<ASR::ListItem_t>(x.m_target);
        uint64_t ptr_loads_copy = ptr_loads;
        ptr_loads = 0;
    ...
    if (is_a<ASR::Character_t>(*expr_type(x.m_value))) {
      ASR::Character_t* t =
          ASR::down_cast<ASR::Character_t>(expr_type(x.m_value));
      if (t->n_dims == 0) {
  ...
  void visit_AssociateBlockCall(const ASR::AssociateBlockCall_t& x) {
    ...
    ASR::AssociateBlock_t* associate_block =
  ...
  void visit_BlockCall(const ASR::BlockCall_t& x) {
    if (x.m_label != -1) {
      if (llvm_goto_targets.find(x.m_label) == llvm_goto_targets.end()) {
        llvm::BasicBlock* new_target =
            llvm::BasicBlock::Create(context, "goto_target");
  ...
  void visit_Exit(const ASR::Exit_t& /* x */) {
    ...
    llvm::BasicBlock* bb =
        llvm::BasicBlock::Create(context, "unreachable_after_exit");
    start_new_block(bb);
  }
  ...
  void visit_Cycle(const ASR::Cycle_t& /* x */) {
    ...
    llvm::BasicBlock* bb =
        llvm::BasicBlock::Create(context, "unreachable_after_cycle");
    start_new_block(bb);
  }
  ...
  void visit_Return(const ASR::Return_t& /* x */) {
    ...
    llvm::BasicBlock* bb =
        llvm::BasicBlock::Create(context, "unreachable_after_return");
    start_new_block(bb);
  }
  ...
  void visit_GoTo(const ASR::GoTo_t& x) {
    ...
    llvm::BasicBlock* bb =
        llvm::BasicBlock::Create(context, "unreachable_after_goto");
    start_new_block(bb);
  }
  ...
  void visit_StringSection(const ASR::StringSection_t& x) {
    ...
    if (x.m_start) {
      ...
      left = tmp;
      left_present = llvm::ConstantInt::get(context, llvm::APInt(1, 1));
    } else {
      left = llvm::Constant::getNullValue(llvm::Type::getInt32Ty(context));
      left_present = llvm::ConstantInt::get(context, llvm::APInt(1, 0));
    }
    if (x.m_end) {
      this->visit_expr_wrapper(x.m_end, true);
      right = tmp;
      right_present = llvm::ConstantInt::get(context, llvm::APInt(1, 1));
    } else {
      right = llvm::Constant::getNullValue(llvm::Type::getInt32Ty(context));
      right_present = llvm::ConstantInt::get(context, llvm::APInt(1, 0));
    }
    if (x.m_step) {
      this->visit_expr_wrapper(x.m_step, true);
      step = tmp;
    } else {
      step = llvm::ConstantInt::get(context, llvm::APInt(32, 1));
    }
    tmp =
        lfortran_str_slice(str, left, right, step, left_present, right_present);
  }
  ...
  void visit_IntegerBinOp(const ASR::IntegerBinOp_t& x) {
    ...
    switch (x.m_op) {
      ...
      case ASR::binopType::Pow: {
        ...
        int a_kind;
        a_kind =
            down_cast<ASR::Integer_t>(ASRUtils::type_get_past_pointer(x.m_type))
                ->m_kind;
        type = getFPType(a_kind);
        llvm::Value* fleft = builder->CreateSIToFP(left_val, type);
        llvm::Value* fright = builder->CreateSIToFP(right_val, type);
  ...
  void visit_RealBinOp(const ASR::RealBinOp_t& x) {
    ...
    switch (x.m_op) {
      ...
      case ASR::binopType::Pow: {
        ...
        int a_kind;
        a_kind =
            down_cast<ASR::Real_t>(ASRUtils::type_get_past_pointer(x.m_type))
                ->m_kind;
        type = getFPType(a_kind);
        std::string func_name = a_kind == 4 ? "llvm.pow.f32" : "llvm.pow.f64";
        llvm::Function* fn_pow = module->getFunction(func_name);
      ...
      default: {
        throw CodeGenError("Binary operator '" +
  ...
  void visit_ComplexBinOp(const ASR::ComplexBinOp_t& x) {
    ...
    int a_kind;
    a_kind =
        down_cast<ASR::Complex_t>(ASRUtils::type_get_past_pointer(x.m_type))
            ->m_kind;
  ...
  void visit_IntegerUnaryMinus(const ASR::IntegerUnaryMinus_t& x) {
    ...
    llvm::Value* zero = llvm::ConstantInt::get(
        context, llvm::APInt(ASRUtils::extract_kind_from_ttype_t(
  ...
  void visit_RealUnaryMinus(const ASR::RealUnaryMinus_t& x) {
    ...
    if (a_kind == 4) {
      ...
      zero = llvm::ConstantFP::get(context, llvm::APFloat((double)0.0));
    } else {
    ...
    switch (a_kind) {
      case 4: {
        tmp = llvm::ConstantInt::get(
            context, llvm::APInt(32, static_cast<int32_t>(val), true));
        break;
      }
      case 8: {
  ...
  void visit_ArrayConstant(const ASR::ArrayConstant_t& x) {
    ...
    if (ASR::is_a<ASR::Integer_t>(*x.m_type)) {
      ...
      switch (ASR::down_cast<ASR::Real_t>(x.m_type)->m_kind) {
        case (4):
          el_type = llvm::Type::getFloatTy(context);
          break;
        case (8):
    ...
    // Create <n x float> type, where `n` is the length of the `x` constant
    // array
      ...
      if (ASR::is_a<ASR::Integer_t>(*x.m_type)) {
        ...
        switch (ASR::down_cast<ASR::Integer_t>(x.m_type)->m_kind) {
          case (4): {
            ...
            llvm_val = llvm::ConstantInt::get(
                context, llvm::APInt(32, static_cast<int32_t>(el_value), true));
            break;
          }
          case (8): {
            int64_t el_value = ci->m_n;
            llvm_val = llvm::ConstantInt::get(context,
                                              llvm::APInt(32, el_value, true));
            break;
          }
          default:
  ...
  void visit_ComplexConstructor(const ASR::ComplexConstructor_t& x) {
    ...
    throw CodeGenError(
        "ComplexConstructor with runtime arguments not implemented yet.");
  }
  ...
  inline void fetch_val(ASR::Variable_t* x) {
    ...
    if (llvm_symtab.find(x_h) == llvm_symtab.end()) {
      LFORTRAN_ASSERT(std::find(nested_globals.begin(), nested_globals.end(),
                                x_h) != nested_globals.end());
      auto finder =
          std::find(nested_globals.begin(), nested_globals.end(), x_h);
      llvm::Constant* ptr =
          module->getOrInsertGlobal(nested_desc_name, nested_global_struct);
      int idx = std::distance(nested_globals.begin(), finder);
      std::vector<llvm::Value*> idx_vec = {
  ...
  inline void fetch_var(ASR::Variable_t* x) {
    ...
    switch (x->m_type->type) {
      ...
      case ASR::ttypeType::Class: {
        ...
        ASR::ClassType_t* der_type =
            (ASR::ClassType_t*)(&(der->m_class_type->base));
        der_type_name = std::string(der_type->m_name);
        uint32_t h = get_hash((ASR::asr_t*)x);
        if (llvm_symtab.find(h) != llvm_symtab.end()) {
          tmp = llvm_symtab[h];
  ...
  void visit_Var(const ASR::Var_t& x) {
    ASR::Variable_t* v =
        ASR::down_cast<ASR::Variable_t>(symbol_get_past_external(x.m_v));
    fetch_var(v);
  }
  ...
  void visit_ComplexRe(const ASR::ComplexRe_t& x) {
    ...
    if (arg_kind == 4 && dest_kind == 4) {
      ...
      std::string msg = "Conversion from " + std::to_string(arg_kind) + " to " +
                        std::to_string(dest_kind) + " not implemented yet.";
  ...
  void visit_Cast(const ASR::Cast_t& x) {
    ...
    switch (x.m_kind) {
      ...
      case (ASR::cast_kindType::CharacterToLogical): {
        ...
        builder->CreateStore(tmp, parg);
        tmp =
            builder->CreateICmpNE(lfortran_str_len(parg), builder->getInt32(0));
        break;
      }
  ...
  void visit_FileRead(const ASR::FileRead_t& x) {
    if (x.m_fmt != nullptr) {
      diag.codegen_warning_label(
          "format string in read() is not implemented yet and it is currently "
          "treated as '*'",
  ...
  void visit_Print(const ASR::Print_t& x) {
    if (x.m_fmt != nullptr) {
      diag.codegen_warning_label(
          "format string in `print` is not implemented yet and it is currently "
          "treated as '*'",
          {x.m_fmt->base.loc}, "treated as '*'");
    }
    handle_print(x);
  ...
  void visit_FileWrite(const ASR::FileWrite_t& x) {
    if (x.m_fmt != nullptr) {
      diag.codegen_warning_label(
          "format string in write() is not implemented yet and it is currently "
          "treated as '*'",
          {x.m_fmt->base.loc}, "treated as '*'");
    }
    if (x.m_unit != nullptr) {
      ...
      if (t->type == ASR::ttypeType::CPtr ||
        ...
        switch (a_kind) {
          case 4: {
            ...
            fmt.push_back("%f");
            d = builder->CreateFPExt(tmp, llvm::Type::getDoubleTy(context));
            break;
          }
          case 8: {
  ...
  std::vector<llvm::Value*> convert_call_args(const T& x, std::string name) {
    ...
    if (x_abi == ASR::abiType::Intrinsic) {
      if (name == "lbound" || name == "ubound") {
        ...
        tmp = llvm_symtab[h];
        llvm::Value* arg1 =
            builder->CreateAlloca(fname2arg_type[name].first, nullptr);
        llvm::Value* first_ele_ptr =
            arr_descr->get_pointer_to_dimension_descriptor_array(tmp);
      ...
      for (size_t i = 0; i < x.n_args; i++) {
        if (x.m_args[i].m_value->type == ASR::exprType::Var) {
          if (is_a<ASR::Variable_t>(*symbol_get_past_external(
            ...
            if (llvm_symtab.find(h) != llvm_symtab.end()) {
              ...
              if (func_subrout->type == ASR::symbolType::Function) {
                ASR::Function_t* func =
                    down_cast<ASR::Function_t>(func_subrout);
                set_func_subrout_params(func, x_abi, m_h, orig_arg,
                                        orig_arg_name, orig_arg_intent, i);
              } else if (func_subrout->type ==
                         ASR::symbolType::ClassProcedure) {
                ASR::ClassProcedure_t* clss_proc =
                    ASR::down_cast<ASR::ClassProcedure_t>(func_subrout);
                if (clss_proc->m_proc->type == ASR::symbolType::Function) {
                  ASR::Function_t* func =
                      down_cast<ASR::Function_t>(clss_proc->m_proc);
                  set_func_subrout_params(func, x_abi, m_h, orig_arg,
                                          orig_arg_name, orig_arg_intent, i);
                }
              } else {
              ...
              if (x_abi == ASR::abiType::Source && arr_descr->is_array(tmp)) {
                llvm::Type* new_arr_type =
                    arr_arg_type_cache[m_h][orig_arg_name];
                ASR::dimension_t* dims;
                size_t n;
                n = ASRUtils::extract_dimensions_from_ttype(orig_arg->m_type,
                                                            dims);
                tmp = arr_descr->convert_to_argument(
                    tmp, new_arr_type,
                    (!ASRUtils::is_dimension_empty(dims, n)));
              } else if (x_abi == ASR::abiType::BindC) {
                if (arr_descr->is_array(tmp)) {
                  tmp = CreateLoad(arr_descr->get_pointer_to_data(tmp));
                  llvm::PointerType* tmp_type =
                      static_cast<llvm::PointerType*>(tmp->getType());
                    ...
                    if (is_a<ASR::Complex_t>(*arg_type)) {
                      ...
                      if (c_kind == 4) {
                        if (platform == Platform::Windows) {
                          ...
                          llvm::Type* type_fx2p =
                              llvm::ArrayType::get(
                                  llvm::Type::getFloatTy(context), 2)
                                  ->getPointerTo();
                          // Convert {float,float}* to [2 x float]* using
                          // bitcast
                          tmp = builder->CreateBitCast(tmp, type_fx2p);
                          // Then convert [2 x float]* -> [2 x float]
                          tmp = CreateLoad(tmp);
                      ...
                      if (!arg->m_value_attr) {
                        // Dereference the pointer argument (unless it is a
                        // CPtr) to pass by value E.g.: i32* -> i32
                  ...
                  if (!orig_arg->m_value_attr && arg->m_value_attr) {
                    ...
                    llvm::BasicBlock& entry_block =
                        builder->GetInsertBlock()->getParent()->getEntryBlock();
                    llvm::IRBuilder<> builder0(context);
                    builder0.SetInsertPoint(&entry_block,
              ...
              tmp = CreateLoad(llvm_utils->create_gep(ptr, idx));
                         ...
                         ASR::down_cast<ASR::Var_t>(x.m_args[i].m_value)
                             ->m_v))) {
            ASR::Function_t* fn =
                ASR::down_cast<ASR::Function_t>(symbol_get_past_external(
                    ASR::down_cast<ASR::Var_t>(x.m_args[i].m_value)->m_v));
          ...
          switch (arg_type->type) {
            ...
            default:
              throw CodeGenError("Type " + ASRUtils::type_to_str(arg_type) +
                                 " not implemented yet.");
          }
          switch (arg_type->type) {
            case ASR::ttypeType::Derived: {
  ...
  void generate_flip_sign(ASR::call_arg_t* m_args) {
    ...
    ASR::Variable_t* asr_variable =
        ASR::down_cast<ASR::Variable_t>(asr_var->m_v);
    ...
    llvm::Value* num_shifts =
        llvm::ConstantInt::get(context, llvm::APInt(32, signal_kind * 8 - 1));
    llvm::Value* shifted_signal = builder->CreateShl(signal, num_shifts);
    llvm::Value* int_var =
        builder->CreateBitCast(CreateLoad(variable), shifted_signal->getType());
    tmp = builder->CreateXor(shifted_signal, int_var);
    llvm::PointerType* variable_type =
        static_cast<llvm::PointerType*>(variable->getType());
    builder->CreateStore(
        builder->CreateBitCast(tmp, variable_type->getElementType()), variable);
  }
  ...
  void generate_fma(ASR::call_arg_t* m_args) {
    ...
    llvm::Value* c = tmp;
    tmp = builder->CreateIntrinsic(llvm::Intrinsic::fma, {a->getType()},
                                   {b, c, a});
  }
  ...
  void generate_sign_from_value(ASR::call_arg_t* m_args) {
    ...
    llvm::Value* num_shifts =
        llvm::ConstantInt::get(context, llvm::APInt(kind * 8, kind * 8 - 1));
    llvm::Value* shifted_one = builder->CreateShl(
        llvm::ConstantInt::get(context, llvm::APInt(kind * 8, 1)), num_shifts);
  ...
  template <typename T>
  bool generate_optimization_instructions(const T* routine,
  ...
  llvm::Value* CreatePointerToStructReturnValue(llvm::FunctionType* fnty,
    ...
    // We can use asr_return_type as well but anyways for compactness I did it
    // here.
    llvm::Value* pointer_to_struct =
        builder->CreateAlloca(fnty->getReturnType(), nullptr);
  ...
  llvm::Value* CreateCallUtil(llvm::Function* fn,
                              std::vector<llvm::Value*>& args,
                              ASR::ttype_t* asr_return_type) {
  ...
  void visit_FunctionCall(const ASR::FunctionCall_t& x) {
    ...
    if (s->m_abi == ASR::abiType::Source && !intrinsic_function) {
      ...
      if (fname2arg_type.find(func_name) != fname2arg_type.end()) {
        ...
        if (s->m_deftype == ASR::deftypeType::Interface) {
          throw CodeGenError(
              "Intrinsic '" + func_name +
              "' not implemented yet and compile time value is not available.");
        } else {
          h = get_hash((ASR::asr_t*)s);
        }
      }
    ...
    if (llvm_symtab_fn_arg.find(h) != llvm_symtab_fn_arg.end()) {
      ...
      llvm::FunctionType* fntype = llvm_symtab_fn[h]->getFunctionType();
      std::string m_name =
          std::string(((ASR::Function_t*)(&(x.m_name->base)))->m_name);
      args = convert_call_args(x, m_name);
      tmp = builder->CreateCall(fntype, fn, args);
    } else if (llvm_symtab_fn.find(h) == llvm_symtab_fn.end()) {
  ...
  void visit_ArraySize(const ASR::ArraySize_t& x) {
    ...
    ptr_loads = 2 -  // Sync: instead of 2 - , should this be ptr_loads_copy -
                (ASRUtils::expr_type(x.m_v)->type == ASR::ttypeType::Pointer);
    ...
    if (x.m_dim) {
      ...
      dim_kind =
          ASRUtils::extract_kind_from_ttype_t(ASRUtils::expr_type(x.m_dim));
      llvm_dim = tmp;
    }
  ...
  void visit_ArrayBound(const ASR::ArrayBound_t& x) {
    ...
    if (array_value && ASR::is_a<ASR::ArrayConstant_t>(*array_value)) {
      ASR::ArrayConstant_t* array_const =
          ASR::down_cast<ASR::ArrayConstant_t>(array_value);
    ...
    llvm::Value* dim_des_val =
        arr_descr->get_pointer_to_dimension_descriptor_array(llvm_arg1);
    visit_expr_wrapper(x.m_dim, true);
    llvm::Value* dim_val = tmp;
    llvm::Value* const_1 = llvm::ConstantInt::get(context, llvm::APInt(32, 1));
    dim_val = builder->CreateSub(dim_val, const_1);
    llvm::Value* dim_struct =
        arr_descr->get_pointer_to_dimension_descriptor(dim_des_val, dim_val);
    llvm::Value* res = nullptr;
    if (x.m_bound == ASR::arrayboundType::LBound) {
      res = arr_descr->get_lower_bound(dim_struct);
    } else if (x.m_bound == ASR::arrayboundType::UBound) {
...
Result<std::unique_ptr<LLVMModule>> asr_to_llvm(
    ASR::TranslationUnit_t& asr, diag::Diagnostics& diagnostics,
    llvm::LLVMContext& context, Allocator& al,
    LCompilers::PassManager& pass_manager, Platform platform,
  ...
  v.nested_func_types = pass_find_nested_vars(asr, context, v.nested_globals,
                                              v.nested_call_out, v.nesting_map);
  try {
  ...
  if (llvm::verifyModule(*v.module, &err)) {
    ...
    diagnostics.diagnostics.push_back(
        diag::Diagnostic(msg, diag::Level::Error, diag::Stage::CodeGen));
    Error error;
    return error;
  };
