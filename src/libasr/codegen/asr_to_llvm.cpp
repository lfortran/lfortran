        ...
        for( size_t i = 0; i < x.n_args; i++ ) {
            ...
            if( n_dims == 0 ) {
                if (ASRUtils::is_character(*curr_arg_m_a_type)) {
                    ...
                    if (std::string(ASRUtils::symbol_name(ASR::down_cast<ASR::StructType_t>(curr_arg_m_a_type)->m_derived_type)) == "~abstract_type") {
                        ...
                        if (m_source && !m_source_is_class) {
                            ...
                            llvm_utils->deepcopy(tmp, x_arr, ASRUtils::expr_type(m_source), curr_arg_m_a_type, module.get(), name2memidx);
                        }
                    } else {
                ...
                llvm_utils->create_if_else(
                    ...
                    []() {});
                fill_malloc_array_details((x_arr && x_arr->getType() != nullptr) ? x_arr : ptr_val, type, llvm_data_type,
        ...
        if (x.m_type->type == ASR::ttypeType::Integer
            ...
            if (!external) {
                ...
                if (x.m_symbolic_value) {
                    ...
                    ptr = llvm_utils->declare_global_string(str, str_const->m_s,
    ...
    void visit_Assignment(const ASR::Assignment_t &x) {
        ...
        if ( ASRUtils::is_character(*(ASRUtils::expr_type(x.m_value))) ) {
            ...
            if (n_dims == 0) { // Not an array.
                ...
                throw LCompilersException("RHS string type shouldn't have LHS as an array");
            }
        }
    ...
    */
    ...
    void visit_ArrayConstantUtil(const ASR::ArrayConstant_t &x) {
        ...
        if (ASRUtils::is_integer(*x_m_type)) {
            ...
            tmp = llvm_utils->declare_constant_stringArray(&x);
            return;
        }
        ...
        if (!fn) {
            ...
            llvm::FunctionType *function_type = llvm::FunctionType::get(
                    ...
                    {llvm::Type::getInt32Ty(context),
                        ...
                        character_type, i64,
                        character_type, i64,
                        llvm::Type::getInt32PtrTy(context), character_type}, false);
            fn = llvm::Function::Create(function_type,
                    llvm::Function::ExternalLinkage, runtime_func_name, *module);
        }
    ...
    void visit_FileInquire(const ASR::FileInquire_t &x) {
        ...
        llvm::Value* f_name_data {}, *f_name_len{};
        llvm::Value *unit {}, *opened_val {}, *size_val {}, *pos_val {} , *write{};
        ...
        tmp = builder->CreateCall(fn, {f_name_data, f_name_len, exist_val, unit, opened_val, size_val, pos_val, write});
    }
                    ...
                    if (!use_value) {
                        ...
                        if( !ASR::is_a<ASR::CPtr_t>(*arg_type) &&
                            ...
                            if( ASR::is_a<ASR::Tuple_t>(*arg_type) ||
                                ...
                                llvm_utils->deepcopy(value, target, arg_type_, arg_type, module.get(), name2memidx);
                            } else {
                                builder->CreateStore(value, target);
                            }
                            tmp = target;
    ...
    void visit_SubroutineCall(const ASR::SubroutineCall_t &x) {
        ...
        if (x.m_dt && (!is_nopass)) {
            ...
            if (ASR::is_a<ASR::Var_t>(*x.m_dt)) {
                ...
                llvm::Value* dt_polymorphic = convert_to_polymorphic_arg(dt, s_m_args0_type, caller_type);
