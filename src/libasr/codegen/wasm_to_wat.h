...
namespace WASM_INSTS_VISITOR
{
    ...
    public:
        ...
        WATVisitor(Vec<uint8_t>& code, uint32_t offset, std::string src, std::string indent)
            : BaseWASMVisitor(code, offset)
            , src(src)
            , indent(indent)
        {
        }
        ...
        void visit_I32Popcnt()
        {
            src += indent + "i32.popcnt";
        }
        void visit_I32Add()
        {
            src += indent + "i32.add";
        ...
        void visit_I32DivS()
        {
            src += indent + "i32.div_s";
        }
        void visit_I32DivU()
        {
            src += indent + "i32.div_u";
        }
        void visit_I32RemS()
        {
            src += indent + "i32.rem_s";
        }
        void visit_I32RemU()
        {
            src += indent + "i32.rem_u";
        }
        void visit_I32And()
        {
            src += indent + "i32.and";
        ...
        void visit_I32ShrS()
        {
            src += indent + "i32.shr_s";
        }
        void visit_I32ShrU()
        {
            src += indent + "i32.shr_u";
        }
        void visit_I32Rotl()
        {
            src += indent + "i32.rotl";
        ...
        void visit_I64Popcnt()
        {
            src += indent + "i64.popcnt";
        }
        void visit_I64Add()
        {
            src += indent + "i64.add";
        ...
        void visit_I64DivS()
        {
            src += indent + "i64.div_s";
        }
        void visit_I64DivU()
        {
            src += indent + "i64.div_u";
        }
        void visit_I64RemS()
        {
            src += indent + "i64.rem_s";
        }
        void visit_I64RemU()
        {
            src += indent + "i64.rem_u";
        }
        void visit_I64And()
        {
            src += indent + "i64.and";
        ...
        void visit_I64ShrS()
        {
            src += indent + "i64.shr_s";
        }
        void visit_I64ShrU()
        {
            src += indent + "i64.shr_u";
        }
        void visit_I64Rotl()
        {
            src += indent + "i64.rotl";
        ...
        void visit_F32Floor()
        {
            src += indent + "f32.floor";
        }
        void visit_F32Trunc()
        {
            src += indent + "f32.trunc";
        }
        void visit_F32Nearest()
        {
            src += indent + "f32.nearest";
        }
        void visit_F32Sqrt()
        {
            src += indent + "f32.sqrt";
        ...
        void visit_F32Copysign()
        {
            src += indent + "f32.copysign";
        }
        ...
        void visit_F64Floor()
        {
            src += indent + "f64.floor";
        }
        void visit_F64Trunc()
        {
            src += indent + "f64.trunc";
        }
        void visit_F64Nearest()
        {
            src += indent + "f64.nearest";
        }
        void visit_F64Sqrt()
        {
            src += indent + "f64.sqrt";
        ...
        void visit_F64Copysign()
        {
            src += indent + "f64.copysign";
        }

        void visit_I32WrapI64()
        {
            src += indent + "i32.wrap_i64";
        }
        void visit_I32TruncF32S()
        {
            src += indent + "i32.trunc_f32_s";
        }
        void visit_I32TruncF64S()
        {
            src += indent + "i32.trunc_f64_s";
        }
        void visit_I64ExtendI32S()
        {
            src += indent + "i64.extend_i32_s";
        }
        void visit_I64TruncF32S()
        {
            src += indent + "i64.trunc_f32_s";
        }
        void visit_I64TruncF64S()
        {
            src += indent + "i64.trunc_f64_s";
        }
        void visit_F32ConvertI32S()
        {
            src += indent + "f32.convert_i32_s";
        }
        void visit_F32ConvertI64S()
        {
            src += indent + "f32.convert_i64_s";
        }
        void visit_F32DemoteF64()
        {
            src += indent + "f32.demote_f64";
        }
        void visit_F64ConvertI32S()
        {
            src += indent + "f64.convert_i32_s";
        }
        void visit_F64ConvertI64S()
        {
            src += indent + "f64.convert_i64_s";
        }
        void visit_F64PromoteF32()
        {
            src += indent + "f64.promote_f32";
        }
        void visit_F64DivS()
        {
            src += indent + "f64.div_s";
        }
