...
namespace LLVM
{
    ...
    llvm::Value* CreateGEP(llvm::IRBuilder<>& builder,
                           llvm::Value* x,
    ...
    llvm::Value* CreateInBoundsGEP(llvm::IRBuilder<>& builder,
                                   llvm::Value* x,
                                   std::vector<llvm::Value*>& idx)
    {
        llvm::Type* t = x->getType();
    ...
    llvm::Value* lfortran_malloc(llvm::LLVMContext& context,
                                 llvm::Module& module,
                                 ...
                                 llvm::Value* arg_size)
    {
        ...
        if (!fn) {
            llvm::FunctionType* function_type = llvm::FunctionType::get(
                llvm::Type::getInt8PtrTy(context), { llvm::Type::getInt32Ty(context) }, true);
    ...
    llvm::Value* lfortran_realloc(llvm::LLVMContext& context,
                                  llvm::Module& module,
                                  llvm::IRBuilder<>& builder,
                                  llvm::Value* ptr,
                                  llvm::Value* arg_size)
...
llvm::Value*
LLVMUtils::create_gep(llvm::Value* ds, int idx)
{
...
llvm::Value*
LLVMUtils::create_gep(llvm::Value* ds, llvm::Value* idx)
{
...
llvm::Value*
LLVMUtils::create_ptr_gep(llvm::Value* ptr, int idx)
{
    std::vector<llvm::Value*> idx_vec = { llvm::ConstantInt::get(context, llvm::APInt(32, idx)) };
    return LLVM::CreateInBoundsGEP(*builder, ptr, idx_vec);
}

llvm::Value*
LLVMUtils::create_ptr_gep(llvm::Value* ptr, llvm::Value* idx)
{
...
llvm::Type*
LLVMUtils::getIntType(int a_kind, bool get_pointer)
{
...
void
LLVMUtils::start_new_block(llvm::BasicBlock* bb)
{
...
LLVMList::LLVMList(llvm::LLVMContext& context_, LLVMUtils* llvm_utils_, llvm::IRBuilder<>* builder_)
    : context(context_)
...
llvm::Type*
LLVMList::get_list_type(llvm::Type* el_type, std::string& type_code, int32_t type_size)
{
...
llvm::Value*
LLVMList::get_pointer_to_list_data(llvm::Value* list)
{
    return llvm_utils->create_gep(list, 2);
}

llvm::Value*
LLVMList::get_pointer_to_current_end_point(llvm::Value* list)
{
    return llvm_utils->create_gep(list, 0);
}

llvm::Value*
LLVMList::get_pointer_to_current_capacity(llvm::Value* list)
{
    return llvm_utils->create_gep(list, 1);
}

void
LLVMList::list_init(std::string& type_code,
                    llvm::Value* list,
                    llvm::Module& module,
                    ...
                    int32_t n)
{
    ...
    llvm::Value* arg_size
        = llvm::ConstantInt::get(context, llvm::APInt(32, type_size * initial_capacity));
...
void
LLVMList::list_deepcopy(llvm::Value* src,
                        llvm::Value* dest,
                        ...
                        llvm::Module& module)
{
    ...
    llvm::Value* arg_size = builder->CreateMul(
        llvm::ConstantInt::get(context, llvm::APInt(32, type_size)), src_capacity);
    llvm::Value* copy_data = LLVM::lfortran_malloc(context, module, *builder, arg_size);
    ...
    builder->CreateMemCpy(copy_data, llvm::MaybeAlign(), src_data, llvm::MaybeAlign(), arg_size);
    builder->CreateStore(copy_data, get_pointer_to_list_data(dest));
}

void
LLVMList::write_item(llvm::Value* list, llvm::Value* pos, llvm::Value* item)
{
...
llvm::Value*
LLVMList::read_item(llvm::Value* list, llvm::Value* pos, bool get_pointer)
{
    llvm::Value* list_data = LLVM::CreateLoad(*builder, get_pointer_to_list_data(list));
    llvm::Value* element_ptr = llvm_utils->create_ptr_gep(list_data, pos);
    if (get_pointer) {
...
llvm::Value*
LLVMList::len(llvm::Value* list)
{
    return LLVM::CreateLoad(*builder, get_pointer_to_current_end_point(list));
}

void
LLVMList::resize_if_needed(llvm::Value* list,
                           llvm::Value* n,
                           llvm::Value* capacity,
                           int32_t type_size,
                           llvm::Type* el_type,
                           llvm::Module& module)
{
    ...
    llvm::Value* new_capacity
        = builder->CreateMul(llvm::ConstantInt::get(context, llvm::APInt(32, 2)), capacity);
    new_capacity
        = builder->CreateAdd(new_capacity, llvm::ConstantInt::get(context, llvm::APInt(32, 1)));
    llvm::Value* arg_size = builder->CreateMul(
        llvm::ConstantInt::get(context, llvm::APInt(32, type_size)), new_capacity);
    llvm::Value* copy_data_ptr = get_pointer_to_list_data(list);
    llvm::Value* copy_data = LLVM::CreateLoad(*builder, copy_data_ptr);
    copy_data = LLVM::lfortran_realloc(context, module, *builder, copy_data, arg_size);
    copy_data = builder->CreateBitCast(copy_data, el_type->getPointerTo());
...
void
LLVMList::shift_end_point_by_one(llvm::Value* list)
{
...
void
LLVMList::append(llvm::Value* list, llvm::Value* item, llvm::Module& module, std::string& type_code)
{
    ...
    llvm::Type* el_type = std::get<2>(typecode2listtype[type_code]);
    resize_if_needed(list, current_end_point, current_capacity, type_size, el_type, module);
...
LLVMTuple::LLVMTuple(llvm::LLVMContext& context_,
    ...
    : context(context_)
    , llvm_utils(llvm_utils_)
    , builder(builder_)
{
}

llvm::Type*
LLVMTuple::get_tuple_type(std::string& type_code, std::vector<llvm::Type*>& el_types)
{
...
llvm::Value*
LLVMTuple::read_item(llvm::Value* llvm_tuple, llvm::Value* pos, bool get_pointer)
{
...
llvm::Value*
LLVMTuple::read_item(llvm::Value* llvm_tuple, size_t pos, bool get_pointer)
{
...
void
LLVMTuple::tuple_init(llvm::Value* llvm_tuple, std::vector<llvm::Value*>& values)
{
...
void
LLVMTuple::tuple_deepcopy(llvm::Value* src, llvm::Value* dest, std::string& type_code)
{
    LFORTRAN_ASSERT(src->getType() == dest->getType());
