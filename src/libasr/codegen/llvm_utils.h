...
class LLVMUtils {
 ...
 public:
  ...
  LLVMUtils(llvm::LLVMContext& context, llvm::IRBuilder<>* _builder);
  ...
  void deepcopy(llvm::Value* src, llvm::Value* dest, ASR::ttype_t* asr_type,
                llvm::Module& module);
...
class LLVMList {
 private:
  ...
  std::map<std::string, std::tuple<llvm::Type*, int32_t, llvm::Type*>>
      typecode2listtype;
 ...
 public:
  ...
  void append(llvm::Value* list, llvm::Value* item, ASR::ttype_t* asr_type,
              llvm::Module& module);

  void insert_item(llvm::Value* list, llvm::Value* pos, llvm::Value* item,
                   ASR::ttype_t* asr_type, llvm::Module& module);

  void remove(llvm::Value* list, llvm::Value* item, ASR::ttype_t* item_type,
              llvm::Module& module);

  void list_clear(llvm::Value* list);

  llvm::Value* find_item_position(llvm::Value* list, llvm::Value* item,
...
class LLVMTuple {
 ...
 public:
  LLVMTuple(llvm::LLVMContext& context_, LLVMUtils* llvm_utils,
            llvm::IRBuilder<>* builder);
...
class LLVMDict {
 ...
 public:
  ...
  LLVMDict(llvm::LLVMContext& context_, LLVMUtils* llvm_utils,
           llvm::IRBuilder<>* builder);

  llvm::Type* get_dict_type(std::string key_type_code,
                            std::string value_type_code, int32_t key_type_size,
                            int32_t value_type_size, llvm::Type* key_type,
  ...
  virtual void resolve_collision(llvm::Value* capacity, llvm::Value* key_hash,
                                 llvm::Value* key, llvm::Value* key_list,
                                 llvm::Value* key_mask, llvm::Module& module,
                                 ASR::ttype_t* key_asr_type,
                                 bool for_read = false);

  virtual void resolve_collision_for_write(llvm::Value* dict,
                                           llvm::Value* key_hash,
  ...
  virtual llvm::Value* resolve_collision_for_read(llvm::Value* dict,
                                                  llvm::Value* key_hash,
                                                  llvm::Value* key,
                                                  llvm::Module& module,
                                                  ASR::ttype_t* key_asr_type);
  ...
  void rehash_all_at_once_if_needed(llvm::Value* dict, llvm::Module* module,
                                    ASR::ttype_t* key_asr_type,
                                    ASR::ttype_t* value_asr_type);

  void write_item(llvm::Value* dict, llvm::Value* key, llvm::Value* value,
