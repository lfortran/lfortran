...
namespace wasm
{
    ...
    void emit_leb128_u32(Vec<uint8_t>& code, Allocator& al, uint32_t n)
    {  // for u32
        do {
            uint8_t byte = n & 0x7f;
            n >>= 7;
    ...
    void emit_leb128_i32(Vec<uint8_t>& code, Allocator& al, int32_t n)
    {  // for i32
        bool more = true;
        do {
            uint8_t byte = n & 0x7f;
    ...
    void emit_leb128_i64(Vec<uint8_t>& code, Allocator& al, int64_t n)
    {  // for i64
        bool more = true;
        do {
            uint8_t byte = n & 0x7f;
    ...
    void emit_ieee754_f32(Vec<uint8_t>& code, Allocator& al, float z)
    {  // for f32
    ...
    void emit_ieee754_f64(Vec<uint8_t>& code, Allocator& al, double z)
    {  // for f64
        uint8_t encoded_float[sizeof(z)];
        std::memcpy(&encoded_float, &z, sizeof(z));
        for (auto& byte : encoded_float) {
    ...
    void emit_u32_b32_idx(Vec<uint8_t>& code, Allocator& al, uint32_t idx, uint32_t section_size)
    {
        /*
    ...
    void emit_export_fn(Vec<uint8_t>& code, Allocator& al, const std::string& name, uint32_t idx)
    {
    ...
    void emit_import_fn(Vec<uint8_t>& code,
                        Allocator& al,
    ...
    void emit_import_mem(Vec<uint8_t>& code,
                         Allocator& al,
                         const std::string& mod_name,
                         const std::string& mem_name,
                         uint32_t min_no_pages,
                         uint32_t max_no_pages = 0)
    {
        emit_str(code, al, mod_name);
    ...
    void encode_section(Vec<uint8_t>& des,
                        Vec<uint8_t>& section_content,
                        Allocator& al,
                        uint32_t section_id,
    ...
    // function to emit string
    void emit_str_const(Vec<uint8_t>& code,
                        Allocator& al,
                        uint32_t mem_idx,
...
main();
    ...
    void emit_i32_load8_s(Vec<uint8_t>& code,
                          Allocator& al,
                          uint32_t mem_align,
                          uint32_t mem_offset)
    {
    ...
    void emit_i32_load8_u(Vec<uint8_t>& code,
                          Allocator& al,
                          uint32_t mem_align,
                          uint32_t mem_offset)
    {
    ...
    void emit_i32_load16_s(Vec<uint8_t>& code,
                           Allocator& al,
                           uint32_t mem_align,
                           uint32_t mem_offset)
    {
    ...
    void emit_i32_load16_u(Vec<uint8_t>& code,
                           Allocator& al,
                           uint32_t mem_align,
                           uint32_t mem_offset)
    {
    ...
    void emit_i64_load8_s(Vec<uint8_t>& code,
                          Allocator& al,
                          uint32_t mem_align,
                          uint32_t mem_offset)
    {
    ...
    void emit_i64_load8_u(Vec<uint8_t>& code,
                          Allocator& al,
                          uint32_t mem_align,
                          uint32_t mem_offset)
    {
    ...
    void emit_i64_load16_s(Vec<uint8_t>& code,
                           Allocator& al,
                           uint32_t mem_align,
                           uint32_t mem_offset)
    {
    ...
    void emit_i64_load16_u(Vec<uint8_t>& code,
                           Allocator& al,
                           uint32_t mem_align,
                           uint32_t mem_offset)
    {
    ...
    void emit_i64_load32_s(Vec<uint8_t>& code,
                           Allocator& al,
                           uint32_t mem_align,
                           uint32_t mem_offset)
    {
    ...
    void emit_i64_load32_u(Vec<uint8_t>& code,
                           Allocator& al,
                           uint32_t mem_align,
                           uint32_t mem_offset)
    {
    ...
    void emit_i32_store16(Vec<uint8_t>& code,
                          Allocator& al,
                          uint32_t mem_align,
                          uint32_t mem_offset)
    {
    ...
    void emit_i64_store16(Vec<uint8_t>& code,
                          Allocator& al,
                          uint32_t mem_align,
                          uint32_t mem_offset)
    {
    ...
    void emit_i64_store32(Vec<uint8_t>& code,
                          Allocator& al,
                          uint32_t mem_align,
                          uint32_t mem_offset)
    {
