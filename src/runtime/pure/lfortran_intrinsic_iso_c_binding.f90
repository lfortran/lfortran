...
integer, parameter :: c_int_least8_t = c_int8_t, c_int_least16_t = c_int16_t, c_int_least32_t = c_int32_t, c_int_least64_t = c_int64_t
integer, parameter :: c_int_fast8_t = c_int8_t, c_int_fast16_t = c_int16_t, c_int_fast32_t = c_int32_t, c_int_fast64_t = c_int64_t
