...
namespace LCompilers::CommandLineInterface {
    ...
    auto LFortranCommandLineParser::parse() -> void {
        ...
        app.add_flag("--gpu-allow-cpu-fallback", compiler_options.po.gpu_allow_cpu_fallback, "Allow CPU fallback for unimplemented GPU lowering; backend limitations always warn and run on the CPU")->group(group_backend_codegen_options);
