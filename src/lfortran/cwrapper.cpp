...
LFortranCParser *lfortran_parser_new() { return new LFortranCParser; }

void lfortran_parser_free(LFortranCParser *self) { delete self; }
...
lfortran_exceptions_t lfortran_parser_pickle(lfortran_ast_t *ast, char **str) {
  CWRAPPER_BEGIN
