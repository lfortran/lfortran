...
public:
    ...
    void visit_SelectRank(const AST::SelectRank_t& x) {
        ...
        ASR::symbol_t* rank_decl_sym = ASR::down_cast<ASR::symbol_t>(ASRUtils::make_Variable_t_util(al, x.base.base.loc, 
            current_scope, "lfortran_rank", nullptr, 0, ASR::intentType::Local, nullptr, nullptr, ASR::storage_typeType::Default, 
        ...
        current_scope->add_symbol("lfortran_rank", rank_decl_sym);
        ...
        for(size_t i=0; i<x.n_body; i++) {
            switch (x.m_body[i]->type) {
                case AST::rank_stmtType::RankExpr: {
                    ...
                    ASR::stmt_t* if_stmt = ASRUtils::STMT(ASR::make_If_t(al, rank_expr->base.base.loc, "", cmp_stmt, rank_body.p, rank_body.size(), nullptr, 0));
