        ...
        if (f) {
            ...
            for (size_t i = 0; i < args.size(); i++) {
                ...
                if (carg.m_value && (i + offset) < f->n_args) {
                    ...
                    if (ASR::is_a<ASR::Variable_t>(*dummy_arg->m_v)) {
                            ...
                            if (dummy_str->m_len &&
                                ...
                                ASR::asr_t *tmp_var_asr =
                                    ASR::make_Variable_t(
                                        ...
                                        ASR::intentType::Local, nullptr, nullptr,
                                        ASR::storage_typeType::Default, dummy_type, nullptr,
                                ...
                                ASR::stmt_t *assign_stmt =
                                    ASR::down_cast<ASR::stmt_t>(
                                        ASR::make_Assignment_t(
                                            ...
                                            ASRUtils::EXPR(
                                                ASR::make_Var_t(
                                                    al, x.base.base.loc, tmp_sym)),
                                            carg.m_value, nullptr, false, false
                                        )
                                    );
                                current_body->push_back(al, assign_stmt);
                                carg.m_value =
            ...
            args = new_args;
            ASRUtils::check_simple_intent_mismatch<SemanticAbort>(
                this->diag, f, args);
        }
