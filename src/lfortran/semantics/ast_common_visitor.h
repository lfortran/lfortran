...
public:
                                     ...
                                     SymbolTable* curr_scope)
    {
        ...
        switch (x.m_op) {
            ...
            default: {
                throw SemanticError("Comparison operator not implemented", x.base.base.loc);
            }
        }
        ...
        if (ASRUtils::use_overloaded(left,
                                     right,
                                     asr_op,
                                     intrinsic_op_name,
                                     curr_scope,
        ...
        if (((left_type->type != ASR::ttypeType::Real && left_type->type != ASR::ttypeType::Integer)
            ...
            && overloaded == nullptr) {
            throw SemanticError("Compare: only Integer or Real can be on the LHS and RHS. "
        ...
        if (overloaded == nullptr) {
            LFORTRAN_ASSERT(ASRUtils::check_equal_type(LFortran::ASRUtils::expr_type(left),
        ...
        if (ASRUtils::is_integer(*dest_type)) {
            if (ASRUtils::expr_value(left) != nullptr && ASRUtils::expr_value(right) != nullptr) {
                int64_t left_value
                    = ASR::down_cast<ASR::IntegerConstant_t>(ASRUtils::expr_value(left))->m_n;
                int64_t right_value
                    = ASR::down_cast<ASR::IntegerConstant_t>(ASRUtils::expr_value(right))->m_n;
                bool result;
                switch (asr_op) {
            ...
            if (ASRUtils::expr_value(left) != nullptr && ASRUtils::expr_value(right) != nullptr) {
                double left_value
                    = ASR::down_cast<ASR::RealConstant_t>(ASRUtils::expr_value(left))->m_r;
                double right_value
                    = ASR::down_cast<ASR::RealConstant_t>(ASRUtils::expr_value(right))->m_r;
                bool result;
                switch (asr_op) {
                    case (ASR::cmpopType::Eq): {
                        result = left_value == right_value;
            ...
            if (ASRUtils::expr_value(left) != nullptr && ASRUtils::expr_value(right) != nullptr) {
                bool left_value
                    = ASR::down_cast<ASR::LogicalConstant_t>(ASRUtils::expr_value(left))->m_value;
                bool right_value
                    = ASR::down_cast<ASR::LogicalConstant_t>(ASRUtils::expr_value(right))->m_value;
                bool result;
                switch (asr_op) {
                    case (ASR::cmpopType::Eq): {
                        result = left_value == right_value;
            ...
            if (ASRUtils::expr_value(left) != nullptr && ASRUtils::expr_value(right) != nullptr) {
                char* left_value
                    = ASR::down_cast<ASR::StringConstant_t>(ASRUtils::expr_value(left))->m_s;
                char* right_value
                    = ASR::down_cast<ASR::StringConstant_t>(ASRUtils::expr_value(right))->m_s;
                                    ...
                                    diag::Diagnostics& diag)
    {
        ...
        ImplicitCastRules::find_conversion_candidate(
            &left, &right, left_type, right_type, conversion_cand, &source_type, &dest_type);
        ImplicitCastRules::set_converted_value(
            al, x.base.base.loc, conversion_cand, source_type, dest_type);
        ...
        if (LFortran::ASRUtils::expr_value(left) != nullptr
            ...
            bool left_value
                = ASR::down_cast<ASR::LogicalConstant_t>(LFortran::ASRUtils::expr_value(left))
                      ->m_value;
            bool right_value
                = ASR::down_cast<ASR::LogicalConstant_t>(LFortran::ASRUtils::expr_value(right))
                      ->m_value;
            bool result;
            switch (op) {
                case (ASR::And):
    ...
    static inline void visit_StrOp(Allocator& al,
                                   const AST::StrOp_t& x,
                                   ASR::expr_t*& left,
                                   ASR::expr_t*& right,
                                   ASR::asr_t*& asr)
    {
        ...
        ASR::ttype_t* dest_type = ASR::down_cast<ASR::ttype_t>(
            ASR::make_Character_t(al,
                                  x.base.base.loc,
                                  left_type2->m_kind,
                                  left_type2->m_len + right_type2->m_len,
                                  nullptr,
                                  nullptr,
                                  0));
        ...
        if (LFortran::ASRUtils::expr_value(left) != nullptr
            && LFortran::ASRUtils::expr_value(right) != nullptr) {
            char* left_value
                = ASR::down_cast<ASR::StringConstant_t>(LFortran::ASRUtils::expr_value(left))->m_s;
            char* right_value
                = ASR::down_cast<ASR::StringConstant_t>(LFortran::ASRUtils::expr_value(right))->m_s;
            char* result;
        ...
        asr = ASR::make_StringConcat_t(al, x.base.base.loc, left, right, dest_type, value);
    }
                                               ...
                                               const Location& loc)
    {
        ...
        if (kind) {
            ...
            if (kind_value) {
                if (ASR::is_a<ASR::IntegerConstant_t>(*kind_value)) {
                    ...
                    throw SemanticError("kind argument to real(a, kind) is not a constant integer",
                                        loc);
                }
            } else {
        ...
        ASR::ttype_t* dest_type
            = LFortran::ASRUtils::TYPE(ASR::make_Real_t(al, loc, kind_int, nullptr, 0));
        ASR::ttype_t* source_type = LFortran::ASRUtils::expr_type(A);

        // TODO: this is implicit cast, use ExplicitCast
        ImplicitCastRules::set_converted_value(al, loc, &result, source_type, dest_type);
                                              ...
                                              const Location& loc)
    {
        ...
        if (kind) {
            ...
            if (kind_value) {
                if (ASR::is_a<ASR::IntegerConstant_t>(*kind_value)) {
                    ...
                    throw SemanticError("kind argument to int(a, kind) is not a constant integer",
                                        loc);
                }
            } else {
        ...
        ASR::expr_t* result = A;
        ASR::ttype_t* dest_type
            = LFortran::ASRUtils::TYPE(ASR::make_Integer_t(al, loc, kind_int, nullptr, 0));
        ASR::ttype_t* source_type = LFortran::ASRUtils::expr_type(A);
...
public:
    ...
    std::set<std::string> intrinsic_module_procedures_as_asr_nodes = { "c_loc", "c_f_pointer" };
        ...
        if (x.m_vartype == nullptr) {
            ...
            for (size_t i = 0; i < x.n_attributes; i++) {
                if (AST::is_a<AST::SimpleAttribute_t>(*x.m_attributes[i])) {
                    ...
                    for (size_t i = 0; i < x.n_syms; ++i) {  // symbols for line only
                        ...
                        if (get_sym == nullptr) {
                            if (compiler_options.implicit_typing) {
                                ...
                                throw SemanticError("Cannot set dimension for undeclared variable",
                                                    x.base.base.loc);
                            }
                        }
                        if (ASR::is_a<ASR::Variable_t>(*get_sym)) {
                            ...
                            if (!ASRUtils::ttype_set_dimensions(
                                    v->m_type, dims.data(), dims.size())) {
                                throw SemanticError(
                                    "Cannot set dimension for variable of non-numerical type",
                                    x.base.base.loc);
                            }
                        } else {
                            throw SemanticError("Cannot attribute non-variable type with dimension",
                                                x.base.base.loc);
                        }
                    }
                    ...
                    if (a->n_object != a->n_value) {
                        if (a->n_object == 1) {
                            ...
                            if (ASRUtils::is_array(obj_type)) {  // it is an array
                                ...
                                tmp = ASR::make_ArrayConstant_t(
                                    al, x.base.base.loc, body.p, body.size(), obj_type);
                        ...
                        throw SemanticError(
                            "The number of values and variables must match in a data statement",
                            x.base.base.loc);
                    }
                    ...
                    throw SemanticError("Attribute declaration not supported", x.base.base.loc);
                }
            }
        } else {
            // Example
            ...
            for (size_t i = 0; i < x.n_syms; i++) {
                ...
                if (x.n_attributes > 0) {
                    for (size_t i = 0; i < x.n_attributes; i++) {
                        ...
                        if (AST::is_a<AST::SimpleAttribute_t>(*a)) {
                            ...
                            if (dims.size() > 0) {
                                throw SemanticError("Dimensions specified twice", x.base.base.loc);
                            }
                ...
                if (s.m_initializer != nullptr) {
                    ...
                    ImplicitCastRules::set_converted_value(
                        al, x.base.base.loc, &init_expr, init_type, type);
                    LFORTRAN_ASSERT(init_expr != nullptr);
                    if (storage_type == ASR::storage_typeType::Parameter) {
                        value = ASRUtils::expr_value(init_expr);
                        if (value == nullptr) {
                            throw SemanticError(
                                "Value of a parameter variable must evaluate to a compile time constant",
                                x.base.base.loc);
                        }
                        if (sym_type->m_type == AST::decl_typeType::TypeCharacter) {
                            ...
                            if (rhs_len >= 0) {
                                if (lhs_len == -1) {
                                    ...
                                    throw SemanticError(
                                        "The LHS character len must not be allocatable in a parameter declaration",
                                        x.base.base.loc);
                                }
                            } else {
                                throw SemanticError(
                ...
                if (std::find(excluded_from_symtab.begin(), excluded_from_symtab.end(), sym)
                    ...
                    ASR::asr_t* v = ASR::make_Variable_t(al,
                                                         s.loc,
                                                         current_scope,
                                 ...
                                 Vec<ASR::dimension_t>& dims)
    {
        ...
        if (sym_type->m_type == AST::decl_typeType::TypeReal) {
            type = LFortran::ASRUtils::TYPE(ASR::make_Real_t(al, loc, a_kind, dims.p, dims.size()));
            if (is_pointer) {
            ...
            type = LFortran::ASRUtils::TYPE(ASR::make_Logical_t(al, loc, 4, dims.p, dims.size()));
            if (is_pointer) {
                type = LFortran::ASRUtils::TYPE(ASR::make_Pointer_t(al, loc, type));
            }
            ...
            type = LFortran::ASRUtils::TYPE(
                ASR::make_Character_t(al, loc, 1, a_len, len_expr, dims.p, dims.size()));
                ...
                for (size_t i = 0; i < current_template_type_parameters.size(); i++) {
                    ...
                    if (name.compare(derived_type_name) == 0) {
                        ...
                        type = LFortran::ASRUtils::TYPE(ASR::make_TypeParameter_t(
                            al, loc, s2c(al, derived_type_name), nullptr, 0));
                    }
                }
            }
            ...
            if (!type_param) {
                if (is_c_ptr(v, derived_type_name)) {
                    ...
                    if (!v) {
                        throw SemanticError("Derived type '" + derived_type_name + "' not declared",
                                            loc);
                    }
                    type = LFortran::ASRUtils::TYPE(
            ...
            if (!v) {
                ...
                ASR::asr_t* dtype = ASR::make_DerivedType_t(al,
                                                            loc,
                                                            current_scope,
            ...
            type = LFortran::ASRUtils::TYPE(ASR::make_Class_t(al, loc, v, dims.p, dims.size()));
        } else {
                                              ...
                                              ASR::symbol_t* v)
    {
        ...
        ASR::ttype_t* der = LFortran::ASRUtils::TYPE(ASR::make_Derived_t(al, loc, v, nullptr, 0));
        return ASR::make_DerivedTypeConstructor_t(al, loc, v, vals.p, vals.size(), der, nullptr);
    }
                                ...
                                ASR::symbol_t* f2)
    {
        ...
        for (size_t i = 0; i < n_args; i++) {
            ...
            if (m_start != nullptr && ASR::is_a<ASR::Var_t>(*m_start)
                ...
                is_item = is_item && (m_start == nullptr && m_step == nullptr && m_end != nullptr);
            }
            ai.m_left = m_start;
            ai.m_right = m_end;
            ai.m_step = m_step;
            ...
            if (v->type == ASR::symbolType::Variable) {
                ...
                if (m_value && m_value->type == ASR::exprType::StringConstant) {
                    ...
                    if (start != -1 && end != -1 && step != -1) {
                        ...
                        arr_ref_val = ASRUtils::EXPR(
                            ASR::make_StringConstant_t(al, loc, l_str.c_str(al), m_str->m_type));
                    }
                }
            }
        }
        ...
        if (is_item) {
            ...
            return ASR::make_ArrayItem_t(al, loc, v_Var, args.p, args.size(), type, arr_ref_val);
        } else {
    ...
    void visit_ArrayInitializer(const AST::ArrayInitializer_t& x)
    {
        ...
        for (size_t i = 0; i < x.n_args; i++) {
            ...
            if (type == nullptr) {
                ...
                if (LFortran::ASRUtils::expr_type(expr)->type != type->type) {
                    throw SemanticError("Type mismatch in array initializer", x.base.base.loc);
                }
            }
        ...
        ASR::expr_t* one
            = ASRUtils::EXPR(ASR::make_IntegerConstant_t(al, x.base.base.loc, 1, int32_type));
        ...
        tmp = ASR::make_ArrayConstant_t(al, x.base.base.loc, body.p, body.size(), type);
    }
                           ...
                           ASR::Function_t* orig_func = nullptr)
    {
        ...
        ASRUtils::ReplaceArgVisitor arg_replacer(al, current_scope, orig_func, orig_args);
                                     ...
                                     ASR::Function_t* f = nullptr)
    {
        ...
        switch (return_type->type) {
            case ASR::ttypeType::Character: {
                ...
                return ASRUtils::TYPE(ASR::make_Character_t(
                    al, loc, t->m_kind, a_len, func_calls[0], new_dims.p, new_dims.size()));
            }
            case ASR::ttypeType::Integer: {
                ...
                return ASRUtils::TYPE(
                    ASR::make_Integer_t(al, loc, t->m_kind, new_dims.p, new_dims.size()));
            }
                                                               ...
                                                               ASR::ExternalSymbol_t* p)
    {
        ...
        std::string local_sym
            = std::string(p->m_name) + "@" + LFortran::ASRUtils::symbol_name(final_sym);
        ...
        return ASR::make_FunctionCall_t(
            al, loc, final_sym, v, args.p, args.size(), return_type, value, nullptr);
    }
                                      ...
                                      ASR::expr_t* v_expr)
    {
        ...
        return ASR::make_FunctionCall_t(
            al, loc, v, nullptr, args.p, args.size(), type, nullptr, v_expr);
    }
                                        ...
                                        ASR::symbol_t* v)
    {
        if (ASR::is_a<ASR::ExternalSymbol_t>(*v)) {
            ...
            if (idx == -1) {
                ...
                if (!v) {
                    throw SemanticError("Couldn't find any function " + v_name + ".", loc);
                }
                return create_FunctionCall(loc, v, args);
            }
            ...
            return ASR::make_FunctionCall_t(
                al, loc, final_sym, v, args.p, args.size(), type, nullptr, nullptr);
        }
    }
    ...
    ASR::asr_t* create_Function(const Location& loc, Vec<ASR::call_arg_t>& args, ASR::symbol_t* v)
    {
        ...
        return ASR::make_FunctionCall_t(
            al, loc, v, nullptr, args.p, args.size(), return_type, value, nullptr);
    }
                                  ...
                                  SymbolTable*& scope)
    {
        ...
        if (ASR::is_a<ASR::Derived_t>(*ASRUtils::type_get_past_pointer(v_variable->m_type))
            ...
            if (ASR::is_a<ASR::ExternalSymbol_t>(*derived_type)) {
                ...
                if (der_sym == nullptr) {
                    throw SemanticError(
                        "'" + std::string(der_ext->m_name) + "' isn't a Derived type.", loc);
                } else {
            ...
            while (par_der_type != nullptr && member == nullptr) {
                ...
                if (par_der_type->m_parent != nullptr) {
                    par_der_type = ASR::down_cast<ASR::DerivedType_t>(
                        LFortran::ASRUtils::symbol_get_past_external(par_der_type->m_parent));
                } else {
            ...
            if (member != nullptr) {
                ...
                throw SemanticError("Variable '" + dt_name + "' doesn't have any member named, '"
                                        + var_name + "'.",
                                    loc);
            }
            ...
            if (var_name == "re") {
                ...
                ASR::ttype_t* dest_type
                    = ASR::down_cast<ASR::ttype_t>(ASR::make_Real_t(al, loc, kind, nullptr, 0));
                ImplicitCastRules::set_converted_value(
                ...
                throw SemanticError("Complex variable '" + dt_name
                                        + "' only has %re and %im members, not '" + var_name + "'",
                                    loc);
            }
        } else {
        ...
        for (size_t i = 0; i < x.n_keywords; i++) {
            ...
            if (args[kwarg_idx + offset] != nullptr) {
                throw SemanticError(curr_kwarg_name + " has already "
                                        + "been specified as a positional/keyword " + "argument to "
                                        + intrinsic_name + ".",
                                    x.base.base.loc);
            }
                             ...
                             ASR::symbol_t* v)
    {
        ...
        ASR::ttype_t* kind_type
            = ASRUtils::TYPE(ASR::make_Integer_t(al, x.base.base.loc, kind_value, nullptr, 0));
        ...
        ASR::GenericProcedure_t* gp = ASR::down_cast<ASR::GenericProcedure_t>(gp_ext->m_external);
        int idx = ASRUtils::select_generic_procedure(
            args2,
            *gp,
            x.base.base.loc,
    ...
    ASR::asr_t* create_ArrayBound(const AST::FuncCallOrArray_t& x, std::string& bound_name)
    {
        ...
        ASR::ttype_t* type
            = ASRUtils::TYPE(ASR::make_Integer_t(al, x.base.base.loc, kind_const, nullptr, 0));
        return ASR::make_ArrayBound_t(al, x.base.base.loc, v_Var, dim, type, bound, nullptr);
    }
    ...
    ASR::asr_t* create_ArrayPack(const AST::FuncCallOrArray_t& x)
    {
        ...
        new_dim.m_start
            = ASRUtils::EXPR(ASR::make_IntegerConstant_t(al, x.base.base.loc, 1, int32_type));
        new_dim.m_length = ASRUtils::EXPR(ASR::make_ArraySize_t(
            al, x.base.base.loc, vector ? vector : mask, nullptr, int32_type, nullptr));
        new_dims.push_back(al, new_dim);
        ASR::ttype_t* type = ASRUtils::duplicate_type(al, ASRUtils::expr_type(array), &new_dims);
        return ASR::make_ArrayPack_t(al, x.base.base.loc, array, mask, vector, type, nullptr);
    }

    ASR::asr_t* create_ArrayReshape(const AST::FuncCallOrArray_t& x)
    {
        if (x.n_args != 2) {
            throw SemanticError("reshape accepts only 2 arguments, got " + std::to_string(x.n_args)
                                    + " arguments instead.",
                                x.base.base.loc);
        }
    ...
    ASR::asr_t* create_Cmplx(const AST::FuncCallOrArray_t& x)
    {
        ...
        if (y_ == nullptr) {
            ASR::ttype_t* real_type
                = ASRUtils::TYPE(ASR::make_Real_t(al, x.base.base.loc, kind_value, nullptr, 0));
            y_ = ASRUtils::EXPR(ASR::make_RealConstant_t(al, x.base.base.loc, 0.0, real_type));
        }
        ASR::ttype_t* type
            = ASRUtils::TYPE(ASR::make_Complex_t(al, x.base.base.loc, kind_value, nullptr, 0));
    ...
    ASR::asr_t* handle_intrinsic_float(Allocator& al,
                                       Vec<ASR::call_arg_t> args,
                                       const Location& loc)
    {
        ...
        ASR::ttype_t* to_type = ASRUtils::TYPE(ASR::make_Real_t(al, loc, 8, nullptr, 0));
        if (!arg) {
        ...
        if (ASRUtils::is_integer(*type)) {
            ...
            throw SemanticError("Conversion of '" + stype + "' to float is not Implemented", loc);
        }
    ...
    void visit_FuncCallOrArray(const AST::FuncCallOrArray_t& x)
    {
        ...
        if (x.n_member == 1) {
            ...
            v = resolve_deriv_type_proc(x.base.base.loc, var_name, x.m_member[0].m_name, scope);
        } else {
        ...
        if (ASR::is_a<ASR::Function_t>(*f2) || ASR::is_a<ASR::GenericProcedure_t>(*f2)) {
                ...
                if (var_name == "floor") {
                    if (ASR::is_a<ASR::ExternalSymbol_t>(*v)) {
                        ...
                        if (ASR::is_a<ASR::GenericProcedure_t>(*f2)) {
                            LFORTRAN_ASSERT(
                                std::string(ASR::down_cast<ASR::GenericProcedure_t>(f2)->m_name)
                                == "floor")
            ...
            switch (f2->type) {
                ...
                case (ASR::symbolType::DerivedType):
                    tmp = create_DerivedTypeConstructor(x.base.base.loc, x.m_args, x.n_args, v);
                    break;
                case (ASR::symbolType::ClassProcedure):
                    tmp = create_ClassProcedure(x.base.base.loc, x.m_args, x.n_args, v, v_expr);
                    break;
                default:
                    throw SemanticError("Symbol '" + var_name + "' is not a function or an array",
                                        x.base.base.loc);
            }
        }
    }
    ...
    ASR::symbol_t* resolve_intrinsic_function(const Location& loc, const std::string& remote_sym)
    {
        ...
        if (!t) {
            throw SemanticError("The symbol '" + remote_sym + "' not found in the module '"
                                    + module_name + "'",
                                loc);
                      ...
                      SymbolTable* curr_scope)
    {
        ...
        if (!ASRUtils::check_equal_type(ASRUtils::expr_type(left), ASRUtils::expr_type(right))) {
        ...
        if (ASRUtils::is_integer(*dest_type)) {
            if (ASRUtils::expr_value(left) != nullptr && ASRUtils::expr_value(right) != nullptr) {
                int64_t left_value
                    = ASR::down_cast<ASR::IntegerConstant_t>(LFortran::ASRUtils::expr_value(left))
                          ->m_n;
                int64_t right_value
                    = ASR::down_cast<ASR::IntegerConstant_t>(LFortran::ASRUtils::expr_value(right))
                          ->m_n;
                int64_t result;
                switch (op) {
                    case (ASR::Add):
                ...
                value = ASR::down_cast<ASR::expr_t>(
                    ASR::make_IntegerConstant_t(al, x.base.base.loc, result, dest_type));
            }
            ...
            if (ASRUtils::expr_value(left) != nullptr && ASRUtils::expr_value(right) != nullptr) {
                double left_value
                    = ASR::down_cast<ASR::RealConstant_t>(LFortran::ASRUtils::expr_value(left))
                          ->m_r;
                double right_value
                    = ASR::down_cast<ASR::RealConstant_t>(LFortran::ASRUtils::expr_value(right))
                          ->m_r;
                double result;
                switch (op) {
                    case (ASR::Add):
            ...
            if (ASRUtils::expr_value(left) != nullptr && ASRUtils::expr_value(right) != nullptr) {
                ASR::ComplexConstant_t* left0
                    = ASR::down_cast<ASR::ComplexConstant_t>(LFortran::ASRUtils::expr_value(left));
                ASR::ComplexConstant_t* right0
                    = ASR::down_cast<ASR::ComplexConstant_t>(LFortran::ASRUtils::expr_value(right));
                std::complex<double> left_value(left0->m_re, left0->m_im);
                std::complex<double> right_value(right0->m_re, right0->m_im);
                std::complex<double> result;
                switch (op) {
                ...
                value = ASR::down_cast<ASR::expr_t>(ASR::make_ComplexConstant_t(
                    al, x.base.base.loc, std::real(result), std::imag(result), dest_type));
            }
    ...
    void visit_Compare(const AST::Compare_t& x)
    {
        ...
        this->visit_expr(*x.m_right);
        ASR::expr_t* right = LFortran::ASRUtils::EXPR(tmp);
        CommonVisitorMethods::visit_Compare(
            al, x, left, right, tmp, cmpop2str[x.m_op], current_scope);
    }
    ...
    void visit_String(const AST::String_t& x)
    {
        ...
        ASR::ttype_t* type = LFortran::ASRUtils::TYPE(
            ASR::make_Character_t(al, x.base.base.loc, 1, s_len, nullptr, nullptr, 0));
    ...
    void visit_BOZ(const AST::BOZ_t& x)
    {
        ...
        tmp = ASR::make_IntegerBOZ_t(al, x.base.base.loc, boz_int, boz_type, nullptr);
    }
    ...
    void visit_Num(const AST::Num_t& x)
    {
        ...
        ASR::ttype_t* type
            = LFortran::ASRUtils::TYPE(ASR::make_Integer_t(al, x.base.base.loc, ikind, nullptr, 0));
    ...
    void visit_Real(const AST::Real_t& x)
    {
        ...
        ASR::ttype_t* type
            = LFortran::ASRUtils::TYPE(ASR::make_Real_t(al, x.base.base.loc, r_kind, nullptr, 0));
    ...
    void visit_Complex(const AST::Complex_t& x)
    {
        ...
        ASR::ttype_t* type = ASRUtils::TYPE(
            ASR::make_Complex_t(al, x.base.base.loc, std::max(a_kind_r, a_kind_i), nullptr, 0));
        ASR::expr_t* value = nullptr;
                                                       ...
                                                       const Location& loc)
    {
        ...
        for (size_t i = 0; i < n; i++) {
            ...
            if (v->m_presence == ASR::presenceType::Optional) {
                SemanticError("Keyword arguments with optional arguments are not implemented yet",
                              loc);
            }
                      ...
                      size_t type_bound = 0)
    {
        ...
        if (n_args + n > fn_n_args) {
            diag.semantic_error_label("Procedure accepts " + std::to_string(fn_n_args)
        ...
        std::vector<std::string> fn_args2 = convert_fn_args_to_string(fn_args, fn_n_args, loc);
    ...
    void visit_Name(const AST::Name_t& x)
    {
        if (x.n_member == 0) {
            ...
            if (x.m_member[0].n_args == 0) {
                SymbolTable* scope = current_scope;
                tmp = this->resolve_variable2(
                    x.base.base.loc, to_lower(x.m_id), to_lower(x.m_member[0].m_name), scope);
            } else {
            ...
            for (i = 2; i < x.n_member; i++) {
                tmp2 = (ASR::DerivedRef_t*) this->resolve_variable2(
                    x.base.base.loc,
                    to_lower(x.m_member[i].m_name),
                    to_lower(x.m_member[i - 1].m_name),
                    scope);
                tmp = ASR::make_DerivedRef_t(al,
                                             x.base.base.loc,
            ...
            i = x.n_member - 1;
            tmp2 = (ASR::DerivedRef_t*) this->resolve_variable2(
                x.base.base.loc, to_lower(x.m_id), to_lower(x.m_member[i].m_name), scope);
            tmp = ASR::make_DerivedRef_t(al,
                                         x.base.base.loc,
                                         LFortran::ASRUtils::EXPR(tmp),
                                         tmp2->m_m,
