 ...
 public:
  inline static void visit_Compare(Allocator &al, const AST::Compare_t &x,
    ...
    if (ASRUtils::use_overloaded(
            left, right, asr_op, intrinsic_op_name, curr_scope, asr, al,
            x.base.base.loc, [&](const std::string &msg, const Location &loc) {
    ...
    if (((left_type->type != ASR::ttypeType::Real &&
      ...
      if (overloaded == nullptr) {
        ...
        ImplicitCastRules::find_conversion_candidate(
            &left, &right, left_type, right_type, conversion_cand, &source_type,
            &dest_type);
    ...
    if (ASRUtils::is_integer(*dest_type)) {
      if (ASRUtils::expr_value(left) != nullptr &&
        ...
        int64_t left_value =
            ASR::down_cast<ASR::IntegerConstant_t>(ASRUtils::expr_value(left))
                ->m_n;
        int64_t right_value =
            ASR::down_cast<ASR::IntegerConstant_t>(ASRUtils::expr_value(right))
                ->m_n;
        bool result;
        switch (asr_op) {
        ...
        value = ASR::down_cast<ASR::expr_t>(
            ASR::make_LogicalConstant_t(al, x.base.base.loc, result, type));
      }

      asr = ASR::make_IntegerCompare_t(al, x.base.base.loc, left, asr_op, right,
                                       type, value);
      ...
      if (ASRUtils::expr_value(left) != nullptr &&
          ASRUtils::expr_value(right) != nullptr) {
        double left_value =
            ASR::down_cast<ASR::RealConstant_t>(ASRUtils::expr_value(left))
                ->m_r;
        double right_value =
            ASR::down_cast<ASR::RealConstant_t>(ASRUtils::expr_value(right))
                ->m_r;
        bool result;
        switch (asr_op) {
          case (ASR::cmpopType::Eq): {
      ...
      asr = ASR::make_RealCompare_t(al, x.base.base.loc, left, asr_op, right,
                                    type, value);
      ...
      asr = ASR::make_ComplexCompare_t(al, x.base.base.loc, left, asr_op, right,
                                       type, value);
      ...
      if (ASRUtils::expr_value(left) != nullptr &&
          ASRUtils::expr_value(right) != nullptr) {
        bool left_value =
            ASR::down_cast<ASR::LogicalConstant_t>(ASRUtils::expr_value(left))
                ->m_value;
        bool right_value =
            ASR::down_cast<ASR::LogicalConstant_t>(ASRUtils::expr_value(right))
                ->m_value;
        bool result;
        switch (asr_op) {
          case (ASR::cmpopType::Eq): {
      ...
      asr = ASR::make_LogicalCompare_t(al, x.base.base.loc, left, asr_op, right,
                                       type, value);
      ...
      if (ASRUtils::expr_value(left) != nullptr &&
          ASRUtils::expr_value(right) != nullptr) {
        char *left_value =
            ASR::down_cast<ASR::StringConstant_t>(ASRUtils::expr_value(left))
                ->m_s;
        char *right_value =
            ASR::down_cast<ASR::StringConstant_t>(ASRUtils::expr_value(right))
                ->m_s;
      ...
      asr = ASR::make_StringCompare_t(al, x.base.base.loc, left, asr_op, right,
                                      type, value);
    }
    if (overloaded != nullptr) {
      asr = ASR::make_OverloadedCompare_t(al, x.base.base.loc, left, asr_op,
                                          right, type, value, overloaded);
    }
  }
  ...
  inline static void visit_BoolOp(Allocator &al, const AST::BoolOp_t &x,
    ...
    switch (x.m_op) {
      ...
      case (AST::Xor):
        ...
        diag.semantic_warning_label(
            ".xor. is an LFortran extension", {x.base.base.loc},
    ...
    if (LFortran::ASRUtils::expr_value(left) != nullptr &&
      ...
      value = ASR::down_cast<ASR::expr_t>(
          ASR::make_LogicalConstant_t(al, x.base.base.loc, result, dest_type));
    }

    asr = ASR::make_LogicalBinOp_t(al, x.base.base.loc, left, op, right,
                                   dest_type, value);
  }
  ...
  inline static void visit_UnaryOp(Allocator &al, const AST::UnaryOp_t &x,
    ...
    if (x.m_op == AST::unaryopType::UAdd) {
      if (LFortran::ASRUtils::is_integer(*operand_type)) {
        if (LFortran::ASRUtils::expr_value(operand) != nullptr) {
          int64_t op_value = ASR::down_cast<ASR::IntegerConstant_t>(
                                 ...
                                 ->m_n;
          asr = ASR::make_IntegerConstant_t(al, x.base.base.loc, op_value,
                                            operand_type);
        }
        ...
        if (LFortran::ASRUtils::expr_value(operand) != nullptr) {
          double op_value = ASR::down_cast<ASR::RealConstant_t>(
                                LFortran::ASRUtils::expr_value(operand))
                                ->m_r;
          asr = ASR::make_RealConstant_t(al, x.base.base.loc, op_value,
                                         operand_type);
        }
      }
      return;
      ...
      if (LFortran::ASRUtils::is_integer(*operand_type)) {
        ...
        if (LFortran::ASRUtils::expr_value(operand) != nullptr) {
          ...
          value = ASR::down_cast<ASR::expr_t>(ASR::make_ComplexConstant_t(
              al, x.base.base.loc, std::real(result), std::imag(result),
              operand_type));
        }
      ...
      if (LFortran::ASRUtils::is_integer(*operand_type)) {
        ...
        asr = ASR::make_IntegerBitNot_t(al, x.base.base.loc, operand,
                                        operand_type, value);
        return;
      } else {
      ...
      if (LFortran::ASRUtils::is_logical(*operand_type)) {
        ...
        asr = ASR::make_LogicalNot_t(al, x.base.base.loc, operand, operand_type,
                                     value);
        return;
      } else {
        throw SemanticError(
  ...
  static inline void visit_StrOp(Allocator &al, const AST::StrOp_t &x,
    ...
    ASR::Character_t *right_type2 =
        ASR::down_cast<ASR::Character_t>(right_type);
    LFORTRAN_ASSERT(left_type2->n_dims == 0);
    LFORTRAN_ASSERT(right_type2->n_dims == 0);
    ASR::ttype_t *dest_type =
        ASR::down_cast<ASR::ttype_t>(ASR::make_Character_t(
    ...
    if (LFortran::ASRUtils::expr_value(left) != nullptr &&
      ...
      result = s.c_str(al);
      LFORTRAN_ASSERT((int64_t)strlen(result) ==
                      ASR::down_cast<ASR::Character_t>(dest_type)->m_len)
      value = ASR::down_cast<ASR::expr_t>(
          ASR::make_StringConstant_t(al, x.base.base.loc, result, dest_type));
    }
    ...
    if (kind) {
      ...
      if (kind_value) {
        if (ASR::is_a<ASR::IntegerConstant_t>(*kind_value)) {
          ...
          throw SemanticError(
              "kind argument to real(a, kind) is not a constant integer", loc);
        }
      } else {
        throw SemanticError("kind argument to real(a, kind) is not constant",
                            loc);
      }
    }
    ASR::expr_t *result = A;
    ASR::ttype_t *dest_type = LFortran::ASRUtils::TYPE(
        ASR::make_Real_t(al, loc, kind_int, nullptr, 0));
    ASR::ttype_t *source_type = LFortran::ASRUtils::expr_type(A);

    // TODO: this is implicit cast, use ExplicitCast
    ImplicitCastRules::set_converted_value(al, loc, &result, source_type,
                                           dest_type);
    return (ASR::asr_t *)result;
  }

  static ASR::asr_t *comptime_intrinsic_int(ASR::expr_t *A, ASR::expr_t *kind,
                                            Allocator &al,
                                            const Location &loc) {
    int kind_int = 4;
    if (kind) {
      ...
      if (kind_value) {
        if (ASR::is_a<ASR::IntegerConstant_t>(*kind_value)) {
          ...
          throw SemanticError(
              "kind argument to int(a, kind) is not a constant integer", loc);
        }
      } else {
        throw SemanticError("kind argument to int(a, kind) is not constant",
                            loc);
      }
    }
    ASR::expr_t *result = A;
    ASR::ttype_t *dest_type = LFortran::ASRUtils::TYPE(
        ASR::make_Integer_t(al, loc, kind_int, nullptr, 0));
    ASR::ttype_t *source_type = LFortran::ASRUtils::expr_type(A);
...
class CommonVisitor : public AST::BaseVisitor<Derived> {
 public:
  ...
  std::map<SymbolTable *,
           std::map<AST::decl_attribute_t *, AST::simple_attributeType>>
      overloaded_ops;
  ...
  ASR::symbol_t *resolve_symbol(const Location &loc,
  ...
  ASR::symbol_t *declare_implicit_variable(const Location &loc,
    ...
    ASR::symbol_t *v = ASR::down_cast<ASR::symbol_t>(ASR::make_Variable_t(
        al, loc, current_scope, s2c(al, var_name), intent, nullptr, nullptr,
        ASR::storage_typeType::Default, type, current_procedure_abi_type,
        ASR::Public, ASR::presenceType::Required, false));
    current_scope->add_symbol(var_name, v);
    return v;
  }

  ASR::asr_t *resolve_variable(const Location &loc,
                               const std::string &var_name) {
    SymbolTable *scope = current_scope;
    ...
    if (!v) {
      ...
      if (compiler_options.implicit_typing) {
        ...
        if (std::find(current_procedure_args.begin(),
                      ...
                      var_name) != current_procedure_args.end()) {
    ...
    for (size_t i = 0; i < n_dim; i++) {
      ...
      if (m_dim[i].m_end) {
        ...
        dim.m_length = ASRUtils::compute_length_from_start_end(
            al, dim.m_start, LFortran::ASRUtils::EXPR(tmp));
      } else {
  ...
  bool is_c_ptr(ASR::symbol_t *v, std::string v_name = "") {
    ...
    if (ASR::is_a<ASR::DerivedType_t>(*v_orig)) {
      ...
      return (der_type_module &&
              std::string(der_type_module->m_name) ==
                  "lfortran_intrinsic_iso_c_binding" &&
              der_type_module->m_intrinsic && v_name == "c_ptr");
    }
    return false;
  }
  ...
  void visit_DeclarationUtil(const AST::Declaration_t &x) {
    ...
    for (size_t i = 0; i < x.n_attributes; i++) {
      if (AST::is_a<AST::AttrType_t>(*x.m_attributes[i])) {
        throw SemanticError("Type must be declared first", x.base.base.loc);
      };
    }
    if (x.m_vartype == nullptr) {
      ...
      // private :: x, y, z
      if (x.n_attributes == 0) {
        throw SemanticError("No attribute specified", x.base.base.loc);
      }
      for (size_t i = 0; i < x.n_attributes; i++) {
        if (AST::is_a<AST::SimpleAttribute_t>(*x.m_attributes[i])) {
              ...
              if (s.m_name == nullptr) {
                ...
                if (sa->m_attr == AST::simple_attributeType ::AttrPrivate) {
                  assgnd_access[sym] = ASR::accessType::Private;
                           ...
                           sa->m_attr ==
                               AST::simple_attributeType ::AttrExternal) {
                  assgnd_access[sym] = ASR::accessType::Public;
                } else if (sa->m_attr ==
                           AST::simple_attributeType ::AttrOptional) {
          ...
          for (size_t i = 0; i < x.n_syms; ++i) {  // symbols for line only
            ...
            if (get_sym == nullptr) {
              if (compiler_options.implicit_typing) {
                ...
                if (std::find(current_procedure_args.begin(),
                              current_procedure_args.end(),
                              sym) != current_procedure_args.end()) {
                  intent = LFortran::ASRUtils::intent_unspecified;
                } else {
                  intent = LFortran::ASRUtils::intent_local;
                }
          ...
          // data x, y / 1.0, 2.0 /
          AST::AttrData_t *a =
              AST::down_cast<AST::AttrData_t>(x.m_attributes[i]);
          if (a->n_object != a->n_value) {
            if (a->n_object == 1) {
              ...
              if (ASRUtils::is_array(obj_type)) {  // it is an array
                ...
                ASR::expr_t *one = ASRUtils::EXPR(ASR::make_IntegerConstant_t(
                    al, x.base.base.loc, 1, int32_type));
                ASR::expr_t *x_n_args =
                    ASRUtils::EXPR(ASR::make_IntegerConstant_t(
                        al, x.base.base.loc, a->n_value, int32_type));
                dim.m_start = one;
            ...
            throw SemanticError(
                "The number of values and variables must match in a data "
                "statement",
                x.base.base.loc);
          }
      ...
      for (size_t i = 0; i < x.n_syms; i++) {
        ...
        if (current_scope->get_symbol(sym) != nullptr) {
          if (current_scope->parent != nullptr) {
            ...
            throw SemanticError(
                diag::Diagnostic("Symbol is already declared in the same scope",
        ...
        if (std::find(current_procedure_args.begin(),
                      current_procedure_args.end(),
                      to_lower(s.m_name)) != current_procedure_args.end()) {
            ...
            if (AST::is_a<AST::SimpleAttribute_t>(*a)) {
              ...
              if (sa->m_attr == AST::simple_attributeType ::AttrPrivate) {
                ...
                storage_type = ASR::storage_typeType::Parameter;
                         ...
                         AST::simple_attributeType ::AttrAllocatable) {
                storage_type = ASR::storage_typeType::Allocatable;
              } else if (sa->m_attr ==
                         AST::simple_attributeType ::AttrPointer) {
                is_pointer = true;
              } else if (sa->m_attr ==
                         AST::simple_attributeType ::AttrOptional) {
        ...
        ASR::ttype_t *type =
            determine_type(x.base.base.loc, x.m_vartype, is_pointer, dims);
        ...
        if (s.m_initializer != nullptr) {
          ...
          ImplicitCastRules::set_converted_value(al, x.base.base.loc,
                                                 &init_expr, init_type, type);
          LFORTRAN_ASSERT(init_expr != nullptr);
          if (storage_type == ASR::storage_typeType::Parameter) {
            value = ASRUtils::expr_value(init_expr);
            if (value == nullptr) {
              throw SemanticError(
                  "Value of a parameter variable must evaluate to a compile "
                  "time constant",
                  x.base.base.loc);
            }
            if (sym_type->m_type == AST::decl_typeType::TypeCharacter) {
              ASR::Character_t *lhs_type =
                  ASR::down_cast<ASR::Character_t>(type);
              ASR::Character_t *rhs_type =
                  ASR::down_cast<ASR::Character_t>(ASRUtils::expr_type(value));
                  ...
                  if (lhs_len != rhs_len) {
                    ...
                    throw SemanticError(
                        "The LHS character len=" + std::to_string(lhs_len) +
                            ...
                            std::to_string(rhs_len) + " are not equal.",
                        x.base.base.loc);
                  }
                } else {
                  LFORTRAN_ASSERT(lhs_len == -2)
                  throw SemanticError(
                      "The LHS character len must not be allocatable in a "
        ...
        if (std::find(excluded_from_symtab.begin(), excluded_from_symtab.end(),
                      sym) == excluded_from_symtab.end()) {
          ASR::asr_t *v = ASR::make_Variable_t(
              al, s.loc, current_scope, s2c(al, to_lower(s.m_name)), s_intent,
              init_expr, value, storage_type, type, current_procedure_abi_type,
  ...
  ASR::ttype_t *determine_type(const Location &loc,
                               ...
                               bool is_pointer, Vec<ASR::dimension_t> &dims) {
    AST::AttrType_t *sym_type = AST::down_cast<AST::AttrType_t>(decl_attribute);
    ASR::ttype_t *type;

    int a_kind = 4;
    if (sym_type->m_type != AST::decl_typeType::TypeCharacter &&
        sym_type->m_kind != nullptr && sym_type->m_kind->m_value != nullptr) {
    ...
    if (sym_type->m_type == AST::decl_typeType::TypeReal) {
      type = LFortran::ASRUtils::TYPE(
          ASR::make_Real_t(al, loc, a_kind, dims.p, dims.size()));
      if (is_pointer) {
        type = LFortran::ASRUtils::TYPE(ASR::make_Pointer_t(al, loc, type));
      }
      ...
      type = LFortran::ASRUtils::TYPE(
          ASR::make_Integer_t(al, loc, a_kind, dims.p, dims.size()));
      if (is_pointer) {
        type = LFortran::ASRUtils::TYPE(ASR::make_Pointer_t(al, loc, type));
      }
    } else if (sym_type->m_type == AST::decl_typeType::TypeLogical) {
      type = LFortran::ASRUtils::TYPE(
          ASR::make_Logical_t(al, loc, 4, dims.p, dims.size()));
      if (is_pointer) {
        type = LFortran::ASRUtils::TYPE(ASR::make_Pointer_t(al, loc, type));
      }
    } else if (sym_type->m_type == AST::decl_typeType::TypeComplex) {
      type = LFortran::ASRUtils::TYPE(
          ASR::make_Complex_t(al, loc, a_kind, dims.p, dims.size()));
      if (is_pointer) {
        type = LFortran::ASRUtils::TYPE(ASR::make_Pointer_t(al, loc, type));
      }
      ...
      if (sym_type->m_kind != nullptr) {
        switch (sym_type->m_kind->m_type) {
          case (AST::kind_item_typeType::Value): {
            ...
            if (sym_type->m_kind->m_value->type ==
                AST::exprType::FuncCallOrArray) {
      ...
      type = LFortran::ASRUtils::TYPE(ASR::make_Character_t(
          al, loc, 1, a_len, len_expr, dims.p, dims.size()));
      ...
      if (is_template) {
        for (size_t i = 0; i < current_template_type_parameters.size(); i++) {
          ASR::TypeParameter_t *param = ASR::down_cast2<ASR::TypeParameter_t>(
              current_template_type_parameters[i]);
          ...
          if (name.compare(derived_type_name) == 0) {
            ...
            type_param = true;
            type = LFortran::ASRUtils::TYPE(ASR::make_TypeParameter_t(
                al, loc, s2c(al, derived_type_name), nullptr, 0, nullptr, 0));
          }
        }
      }
      ...
      if (!type_param) {
        if (is_c_ptr(v, derived_type_name)) {
          ...
          if (!v) {
            throw SemanticError(
                "Derived type '" + derived_type_name + "' not declared", loc);
          }
          type = LFortran::ASRUtils::TYPE(
              ASR::make_Derived_t(al, loc, v, dims.p, dims.size()));
        }
      }
      ...
      if (!v) {
        ...
        ASR::asr_t *dtype = ASR::make_DerivedType_t(
            al, loc, current_scope, s2c(al, to_lower(derived_type_name)),
            nullptr, 0, ASR::abiType::Source, dflt_access, nullptr);
        v = ASR::down_cast<ASR::symbol_t>(dtype);
        parent_scope->add_symbol(derived_type_name, v);
        current_scope = parent_scope;
      }
      type = LFortran::ASRUtils::TYPE(
          ASR::make_Class_t(al, loc, v, dims.p, dims.size()));
    } else {
      throw SemanticError("Type not implemented yet.", loc);
    }
  ...
  ASR::asr_t *create_DerivedTypeConstructor(const Location &loc,
    ...
    ASR::ttype_t *der =
        LFortran::ASRUtils::TYPE(ASR::make_Derived_t(al, loc, v, nullptr, 0));
    return ASR::make_DerivedTypeConstructor_t(al, loc, v, vals.p, vals.size(),
                                              der, nullptr);
  }

  ASR::asr_t *create_ArrayRef(const Location &loc, AST::fnarg_t *m_args,
                              size_t n_args, ASR::symbol_t *v,
                              ASR::symbol_t *f2) {
    bool is_item = true;
    ...
    for (size_t i = 0; i < n_args; i++) {
      ...
      if (m_start != nullptr && ASR::is_a<ASR::Var_t>(*m_start) &&
        ...
        is_item = is_item &&
                  (m_start == nullptr && m_step == nullptr && m_end != nullptr);
      }
      ai.m_left = m_start;
      ai.m_right = m_end;
      ai.m_step = m_step;
    ...
    for (auto &a : args) {
      ...
      if (v->type == ASR::symbolType::Variable) {
        ...
        if (m_value && m_value->type == ASR::exprType::StringConstant) {
          ASR::StringConstant_t *m_str =
              ASR::down_cast<ASR::StringConstant_t>(m_value);
          ...
          if (start != -1 && end != -1 && step != -1) {
            ...
            arr_ref_val = ASRUtils::EXPR(ASR::make_StringConstant_t(
                al, loc, l_str.c_str(al), m_str->m_type));
          }
        }
      }
    }
    ...
    if (is_item) {
      ...
      return ASR::make_ArrayItem_t(al, loc, v_Var, args.p, args.size(), type,
                                   arr_ref_val);
    } else {
      return ASR::make_ArraySection_t(al, loc, v_Var, args.p, args.size(), type,
                                      arr_ref_val);
    }
  }
  ...
  void visit_ArrayInitializer(const AST::ArrayInitializer_t &x) {
    ...
    ASR::expr_t *one = ASRUtils::EXPR(
        ASR::make_IntegerConstant_t(al, x.base.base.loc, 1, int32_type));
    ASR::expr_t *x_n_args = ASRUtils::EXPR(
        ASR::make_IntegerConstant_t(al, x.base.base.loc, x.n_args, int32_type));
    dim.m_start = one;
    dim.m_length = x_n_args;
    dims.push_back(al, dim);
    type = ASRUtils::duplicate_type(al, type, &dims);
    tmp = ASR::make_ArrayConstant_t(al, x.base.base.loc, body.p, body.size(),
                                    type);
  }
  ...
  ASR::ttype_t *handle_return_type(ASR::ttype_t *return_type,
    ...
    switch (return_type->type) {
      case ASR::ttypeType::Character: {
        ...
        return ASRUtils::TYPE(ASR::make_Character_t(al, loc, t->m_kind, a_len,
                                                    func_calls[0], new_dims.p,
                                                    new_dims.size()));
      }
      case ASR::ttypeType::Integer: {
        ...
        return ASRUtils::TYPE(ASR::make_Integer_t(al, loc, t->m_kind,
      ...
      case ASR::ttypeType::Real: {
        ...
        return ASRUtils::TYPE(
            ASR::make_Real_t(al, loc, t->m_kind, new_dims.p, new_dims.size()));
        break;
      }
      default: {
        return return_type;
  ...
  ASR::asr_t *intrinsic_function_transformation(Allocator &al,
                                                const Location &loc,
    ...
    if (fn_name == "real") {
      ...
      return LFortran::CommonVisitorMethods::comptime_intrinsic_real(
          args[0].m_value, arg1, al, loc);
    } else if (fn_name == "int") {
      ASR::expr_t *arg1;
      if (args.size() == 1) {
        arg1 = nullptr;
      ...
      return LFortran::CommonVisitorMethods::comptime_intrinsic_int(
          args[0].m_value, arg1, al, loc);
    } else {
      return nullptr;
    }
  ...
  ASR::asr_t *symbol_resolve_external_generic_procedure_util(
      const Location &loc, int idx, ASR::symbol_t *v,
      Vec<ASR::call_arg_t> &args, ASR::GenericProcedure_t *g,
    ...
    if (func->m_elemental && func->n_args == 1 &&
      ...
      return_type =
          ASRUtils::duplicate_type(al, ASRUtils::expr_type(args[0].m_value));
    } else {
    ...
    if (current_scope->get_symbol(local_sym) == nullptr) {
      ...
      ASR::asr_t *sub = ASR::make_ExternalSymbol_t(
          ...
          /* a_name */ cname, final_sym, p->m_module_name, nullptr, 0,
          LFortran::ASRUtils::symbol_name(final_sym), ASR::accessType::Private);
    ...
    if (ASR::is_a<ASR::Function_t>(*final_sym2)) {
      ...
      if (ASRUtils::is_intrinsic_procedure(f)) {
        ...
        ASR::GenericProcedure_t *gp =
            ASR::down_cast<ASR::GenericProcedure_t>(v2);

        ASR::asr_t *result =
            intrinsic_function_transformation(al, loc, gp->m_name, args);
        if (result) {
          return result;
        } else {
    ...
    return ASR::make_FunctionCall_t(al, loc, final_sym, v, args.p, args.size(),
                                    return_type, value, nullptr);
  }

  ASR::asr_t *symbol_resolve_external_generic_procedure(
      const Location &loc, ASR::symbol_t *v, Vec<ASR::call_arg_t> &args) {
    ...
    return symbol_resolve_external_generic_procedure_util(loc, idx, v, args, g,
                                                          p);
  }

  ASR::asr_t *symbol_resolve_external_generic_procedure_with_ast_node(
      const AST::FuncCallOrArray_t &x, ASR::symbol_t *v,
      Vec<ASR::call_arg_t> &args) {
    ...
    if (idx == -1) {
      ...
      return symbol_resolve_external_generic_procedure_util(loc, idx, v, args,
                                                            g, p);
    }
  }

  ASR::asr_t *create_ClassProcedure(const Location &loc, AST::fnarg_t *m_args,
                                    size_t n_args, ASR::symbol_t *v,
                                    ASR::expr_t *v_expr) {
    Vec<ASR::call_arg_t> args;
    visit_expr_list(m_args, n_args, args);
    ASR::ClassProcedure_t *v_class_proc =
        ASR::down_cast<ASR::ClassProcedure_t>(v);
    ASR::ttype_t *type = nullptr;
    ASR::Function_t *func =
    ...
    return ASR::make_FunctionCall_t(al, loc, v, nullptr, args.p, args.size(),
                                    type, nullptr, v_expr);
  }
  ...
  ASR::asr_t *create_GenericProcedure(const Location &loc,
    ...
    if (ASR::is_a<ASR::ExternalSymbol_t>(*v)) {
      ...
      return ASR::make_FunctionCall_t(al, loc, final_sym, v, args.p,
                                      args.size(), type, nullptr, nullptr);
    }
  }

  ASR::asr_t *create_GenericProcedureWithASTNode(
      const AST::FuncCallOrArray_t &x, Vec<ASR::call_arg_t> &args,
      ASR::symbol_t *v) {
    const Location &loc = x.base.base.loc;
    if (ASR::is_a<ASR::ExternalSymbol_t>(*v)) {
  ...
  ASR::asr_t *create_Function(const Location &loc, Vec<ASR::call_arg_t> &args,
                              ASR::symbol_t *v) {
    ...
    if (ASR::is_a<ASR::ExternalSymbol_t>(*v)) {
      ...
      if (ASRUtils::is_intrinsic_procedure(f)) {
        ASR::asr_t *result =
            intrinsic_function_transformation(al, loc, f->m_name, args);
        if (result) {
          return result;
        } else {
  ...
  ASR::asr_t *create_FunctionCall(const Location &loc, ASR::symbol_t *fn,
                                  Vec<ASR::call_arg_t> &args) {
  ...
  ASR::asr_t *resolve_variable2(const Location &loc,
    ...
    if (ASR::is_a<ASR::Derived_t>(
      ...
      if (ASR::is_a<ASR::ExternalSymbol_t>(*derived_type)) {
        ...
        if (der_sym == nullptr) {
          throw SemanticError(
              "'" + std::string(der_ext->m_name) + "' isn't a Derived type.",
              loc);
        } else {
      ...
      while (par_der_type != nullptr && member == nullptr) {
        ...
        if (par_der_type->m_parent != nullptr) {
          par_der_type = ASR::down_cast<ASR::DerivedType_t>(
              LFortran::ASRUtils::symbol_get_past_external(
                  par_der_type->m_parent));
        } else {
      ...
      if (member != nullptr) {
        ...
        throw SemanticError("Variable '" + dt_name +
                                "' doesn't have any member named, '" +
                                var_name + "'.",
                            loc);
      }
      ...
      if (var_name == "re") {
        ASR::expr_t *val =
            ASR::down_cast<ASR::expr_t>(ASR::make_Var_t(al, loc, v));
        int kind = ASRUtils::extract_kind_from_ttype_t(v_variable->m_type);
        ASR::ttype_t *dest_type = ASR::down_cast<ASR::ttype_t>(
            ASR::make_Real_t(al, loc, kind, nullptr, 0));
        ImplicitCastRules::set_converted_value(al, loc, &val,
                                               v_variable->m_type, dest_type);
        ...
        throw SemanticError("Complex variable '" + dt_name +
                                "' only has %re and %im members, not '" +
                                var_name + "'",
                            loc);
      }
    } else {
      throw SemanticError("Variable '" + dt_name + "' is not a derived type",
                          loc);
    }
  }
  ...
  ASR::symbol_t *resolve_deriv_type_proc(const Location &loc,
    ...
    if (member != nullptr) {
      ...
      member =
          resolve_deriv_type_proc(loc, var_name, "", scope, der_type->m_parent);
    } else {
      throw SemanticError("Variable '" + dt_name +
                              "' doesn't have any member named, '" + var_name +
                              "'.",
                          loc);
    }
    return member;
  ...
  template <typename T>
  void handle_intrinsic_node_args(const T &x, std::vector<ASR::expr_t *> &args,
    ...
    for (size_t i = 0; i < x.n_keywords; i++) {
      std::string curr_kwarg_name = to_lower(x.m_keywords[i].m_arg);
      auto it =
          std::find(kwarg_names.begin(), kwarg_names.end(), curr_kwarg_name);
  ...
  ASR::asr_t *create_Floor(const AST::FuncCallOrArray_t &x,
    ...
    ASR::ttype_t *kind_type = ASRUtils::TYPE(
        ASR::make_Integer_t(al, x.base.base.loc, kind_value, nullptr, 0));
    ...
    ASR::GenericProcedure_t *gp =
        ASR::down_cast<ASR::GenericProcedure_t>(gp_ext->m_external);
    int idx = ASRUtils::select_generic_procedure(
        args2, *gp, x.base.base.loc,
        [&](const std::string &msg, const Location &loc) {
          throw SemanticError(msg, loc);
        },
        true);
    return symbol_resolve_external_generic_procedure_util(
        gp->base.base.loc, idx, v, args2, gp, gp_ext);
  }

  ASR::asr_t *create_ArrayBound(const AST::FuncCallOrArray_t &x,
    ...
    ASR::ttype_t *type = ASRUtils::TYPE(
        ASR::make_Integer_t(al, x.base.base.loc, kind_const, nullptr, 0));
    return ASR::make_ArrayBound_t(al, x.base.base.loc, v_Var, dim, type, bound,
                                  nullptr);
  }
  ...
  ASR::asr_t *create_ArraySize(const AST::FuncCallOrArray_t &x) {
    ...
    int n_dims = ASRUtils::extract_dimensions_from_ttype(
        ASRUtils::expr_type(v_Var), m_dims);
    ...
    if (compile_time_size != -1) {
      size_compiletime = ASRUtils::EXPR(ASR::make_IntegerConstant_t(
          al, x.base.base.loc, compile_time_size, type));
    }
    return ASR::make_ArraySize_t(al, x.base.base.loc, v_Var, dim, type,
                                 size_compiletime);
  }
  ...
  ASR::asr_t *create_ArrayTranspose(const AST::FuncCallOrArray_t &x) {
    std::vector<ASR::expr_t *> args;
    std::vector<std::string> kwarg_names;
    handle_intrinsic_node_args(x, args, kwarg_names, 1, 1,
    ...
    int matrix_rank =
        ASRUtils::extract_dimensions_from_ttype(type, matrix_dims);
    if (matrix_rank != 2) {
      throw SemanticError(
          "transpose accepts arrays "
          "of rank 2 only, provided an array "
          "with rank, " +
              std::to_string(matrix_rank),
          matrix->base.loc);
    }
    ...
    return ASR::make_ArrayTranspose_t(al, x.base.base.loc, matrix, ret_type,
                                      nullptr);
  }
  ...
  ASR::asr_t *create_ArrayMatMul(const AST::FuncCallOrArray_t &x) {
    std::vector<ASR::expr_t *> args;
    std::vector<std::string> kwarg_names;
    handle_intrinsic_node_args(x, args, kwarg_names, 2, 2,
                               std::string("matmul"));
    ...
    if (!matrix_a_numeric && !matrix_a_logical) {
      throw SemanticError(
          "matmul accepts first matrix of "
    ...
    if (matrix_a_numeric) {
      if (!matrix_b_numeric) {
        throw SemanticError(
            "matmul accepts second matrix of "
      ...
      if (!matrix_b_logical) {
        throw SemanticError(
            "matmul accepts second matrix of type "
    ...
    int matrix_a_rank =
        ASRUtils::extract_dimensions_from_ttype(type_a, matrix_a_dims);
    int matrix_b_rank =
        ASRUtils::extract_dimensions_from_ttype(type_b, matrix_b_dims);
    if (matrix_a_rank != 1 && matrix_a_rank != 2) {
      throw SemanticError(
          "matmul accepts arrays "
          "of rank 1 or 2 only, provided an array "
          "with rank, " +
              std::to_string(matrix_a_rank),
          matrix_a->base.loc);
    }
    ...
    ASR::ttype_t *ret_type =
        ASRUtils::duplicate_type(al, selected_type, &reversed_dims);
    return ASR::make_ArrayMatMul_t(al, x.base.base.loc, matrix_a, matrix_b,
                                   ret_type, nullptr);
  }
  ...
  ASR::asr_t *create_ArrayPack(const AST::FuncCallOrArray_t &x) {
    ...
    new_dim.m_start = ASRUtils::EXPR(
        ASR::make_IntegerConstant_t(al, x.base.base.loc, 1, int32_type));
    new_dim.m_length = ASRUtils::EXPR(
        ASR::make_ArraySize_t(al, x.base.base.loc, vector ? vector : mask,
                              nullptr, int32_type, nullptr));
    new_dims.push_back(al, new_dim);
    ASR::ttype_t *type =
        ASRUtils::duplicate_type(al, ASRUtils::expr_type(array), &new_dims);
    return ASR::make_ArrayPack_t(al, x.base.base.loc, array, mask, vector, type,
                                 nullptr);
  }
  ...
  ASR::asr_t *create_ArrayReshape(const AST::FuncCallOrArray_t &x) {
    ...
    if (!ASRUtils::is_array(ASRUtils::expr_type(newshape))) {
      throw SemanticError(
          "reshape only accept arrays for shape "
          "arguments, found " +
    ...
    ASR::ttype_t *empty_type =
        ASRUtils::duplicate_type(al, ASRUtils::expr_type(array), &dims);
    return ASR::make_ArrayReshape_t(al, x.base.base.loc, array, newshape,
                                    empty_type, nullptr);
  }
  ...
  ASR::asr_t *create_BitCast(const AST::FuncCallOrArray_t &x) {
    ...
    if (size && !ASR::is_a<ASR::Integer_t>(*ASRUtils::expr_type(size))) {
      throw SemanticError(
          "size argument to transfer intrinsic must "
          "be of Integer type.",
          size->base.loc);
    }
    Vec<ASR::dimension_t> new_dims;
    ...
    if (size) {
      ASR::expr_t *one = ASRUtils::EXPR(ASR::make_IntegerConstant_t(
          al, x.base.base.loc, 1, ASRUtils::expr_type(size)));
      ...
      if (ASR::is_a<ASR::ArrayConstant_t>(*mold) ||
        ...
        ASR::expr_t *b64 = ASRUtils::EXPR(
            ASR::make_IntegerConstant_t(al, x.base.base.loc, 64, int32_type));
        ASR::dimension_t size_dim;
    ...
    return ASR::make_BitCast_t(al, x.base.base.loc, source, mold, size, type,
                               nullptr);
  }
  ...
  ASR::asr_t *create_Cmplx(const AST::FuncCallOrArray_t &x) {
    ...
    if (y_ == nullptr) {
      ASR::ttype_t *real_type = ASRUtils::TYPE(
          ASR::make_Real_t(al, x.base.base.loc, kind_value, nullptr, 0));
      y_ = ASRUtils::EXPR(
          ASR::make_RealConstant_t(al, x.base.base.loc, 0.0, real_type));
    }
    ASR::ttype_t *type = ASRUtils::TYPE(
        ASR::make_Complex_t(al, x.base.base.loc, kind_value, nullptr, 0));
    return ASR::make_ComplexConstructor_t(al, x.base.base.loc, x_, y_, type,
                                          nullptr);
  }
  ...
  ASR::symbol_t *intrinsic_as_node(const AST::FuncCallOrArray_t &x,
    ...
    if (intrinsic_procedures_as_asr_nodes.is_intrinsic_present_in_ASR(
            var_name)) {
      is_function = false;
      if (var_name == "size") {
  ...
  ASR::asr_t *create_PointerToCptr(const AST::FuncCallOrArray_t &x) {
    ...
    if (!ASR::is_a<ASR::GetPointer_t>(*v_Var) &&
      ...
      ASR::ttype_t *ptr_type = ASRUtils::TYPE(
          ASR::make_Pointer_t(al, x.base.base.loc, ASRUtils::expr_type(v_Var)));
      v_Var = ASRUtils::EXPR(ASR::make_GetPointer_t(al, x.base.base.loc, v_Var,
                                                    ptr_type, nullptr));
    }
  ...
  ASR::asr_t *handle_intrinsic_float(Allocator &al, Vec<ASR::call_arg_t> args,
    ...
    ASR::ttype_t *to_type =
        ASRUtils::TYPE(ASR::make_Real_t(al, loc, 8, nullptr, 0));
    if (!arg) {
    ...
    if (ASRUtils::is_integer(*type)) {
      if (ASRUtils::expr_value(arg) != nullptr) {
        double dval =
            ASR::down_cast<ASR::IntegerConstant_t>(ASRUtils::expr_value(arg))
                ->m_n;
        value = ASR::down_cast<ASR::expr_t>(
            make_RealConstant_t(al, loc, dval, to_type));
      }
      return (ASR::asr_t *)ASR::down_cast<ASR::expr_t>(ASR::make_Cast_t(
          al, loc, arg, ASR::cast_kindType::IntegerToReal, to_type, value));
    } else if (ASRUtils::is_logical(*type)) {
      if (ASRUtils::expr_value(arg) != nullptr) {
        double dval =
            ASR::down_cast<ASR::LogicalConstant_t>(ASRUtils::expr_value(arg))
                ->m_value;
        value = ASR::down_cast<ASR::expr_t>(
            make_RealConstant_t(al, loc, dval, to_type));
      }
      return (ASR::asr_t *)ASR::down_cast<ASR::expr_t>(ASR::make_Cast_t(
          al, loc, arg, ASR::cast_kindType::LogicalToReal, to_type, value));
    } else if (ASRUtils::is_real(*type)) {
      // float() always returns 64-bit floating point numbers.
      if (ASRUtils::extract_kind_from_ttype_t(type) != 8) {
        return (ASR::asr_t *)ASR::down_cast<ASR::expr_t>(ASR::make_Cast_t(
            al, loc, arg, ASR::cast_kindType::RealToReal, to_type, value));
      }
      return (ASR::asr_t *)arg;
    } else {
      std::string stype = ASRUtils::type_to_str(type);
      throw SemanticError(
          "Conversion of '" + stype + "' to float is not Implemented", loc);
    }
  ...
  void create_implicit_interface_function(const Call &x, std::string func_name,
    ...
    for (size_t i = 0; i < x.n_args; i++) {
      ...
      ASR::asr_t *arg_var = ASR::make_Variable_t(
          al, x.base.base.loc, current_scope, s2c(al, arg_name),
          LFortran::ASRUtils::intent_unspecified, nullptr, nullptr,
          ASR::storage_typeType::Default,
          ASRUtils::expr_type(c_args[i].m_value), ASR::abiType::Source,
          ASR::Public, ASR::presenceType::Required, false);
      current_scope->add_symbol(arg_name,
                                ASR::down_cast<ASR::symbol_t>(arg_var));
      args.push_back(
          al, LFortran::ASRUtils::EXPR(ASR::make_Var_t(
                  al, x.base.base.loc, current_scope->get_symbol(arg_name))));
    }
    // currently hardcoding the return type to real-8
    ASR::ttype_t *type = LFortran::ASRUtils::TYPE(
        ASR::make_Real_t(al, x.base.base.loc, 8, nullptr, 0));
    ASR::expr_t *to_return = nullptr;
    if (add_return) {
      std::string return_var_name = sym_name + "_return_var_name";
      ASR::asr_t *return_var = ASR::make_Variable_t(
          al, x.base.base.loc, current_scope, s2c(al, return_var_name),
          LFortran::ASRUtils::intent_return_var, nullptr, nullptr,
          ASR::storage_typeType::Default, type, ASR::abiType::Source,
          ASR::Public, ASR::presenceType::Required, false);
      current_scope->add_symbol(return_var_name,
                                ASR::down_cast<ASR::symbol_t>(return_var));
      to_return = ASRUtils::EXPR(ASR::make_Var_t(
          al, x.base.base.loc, ASR::down_cast<ASR::symbol_t>(return_var)));
    }

    tmp = ASR::make_Function_t(al, x.base.base.loc,
                               /* a_symtab */ current_scope,
                               ...
                               ASR::deftypeType::Interface, nullptr, false,
                               false, false, false);
    ...
    if (ASR::is_a<ASR::Function_t>(*f2) ||
      ...
      if (ASRUtils::is_intrinsic_symbol(f2)) {
        ...
        if (var_name == "floor") {
          if (ASR::is_a<ASR::ExternalSymbol_t>(*v)) {
            ...
            ASR::ExternalSymbol_t *p = ASR::down_cast<ASR::ExternalSymbol_t>(v);
            ASR::symbol_t *f2 =
                ASR::down_cast<ASR::ExternalSymbol_t>(v)->m_external;
            if (ASR::is_a<ASR::GenericProcedure_t>(*f2)) {
              LFORTRAN_ASSERT(
                  std::string(
                      ASR::down_cast<ASR::GenericProcedure_t>(f2)->m_name) ==
                  "floor")
      ...
      if (x.n_keywords > 0) {
        if (ASR::is_a<ASR::Function_t>(*f2)) {
          ...
          visit_kwargs(args, x.m_keywords, x.n_keywords, f->m_args, f->n_args,
                       x.base.base.loc, f, diags, x.n_member);
          if (diags.has_error()) {
          ...
          LFORTRAN_ASSERT(ASR::is_a<ASR::GenericProcedure_t>(*f2))
          ASR::GenericProcedure_t *gp =
              ASR::down_cast<ASR::GenericProcedure_t>(f2);
          ...
          for (int i = 0; i < (int)gp->n_procs; i++) {
            ...
            diag::Diagnostics diags;
            visit_kwargs(args_copy, x.m_keywords, x.n_keywords, f->m_args,
                         f->n_args, x.base.base.loc, f, diags, x.n_member);
            if (diags.has_error()) {
              continue;
            }
            int idx = ASRUtils::select_generic_procedure(
                args_copy, *gp, x.base.base.loc,
                [&](const std::string &msg, const Location &loc) {
                  throw SemanticError(msg, loc);
                },
                false);
          ...
          if (v == nullptr) {
            throw SemanticError(
                "Unable to find a function to bind for generic procedure "
                "call, " +
      ...
      switch (f2->type) {
        ...
        case (ASR::symbolType::DerivedType):
          tmp = create_DerivedTypeConstructor(x.base.base.loc, x.m_args,
                                              x.n_args, v);
          break;
        case (ASR::symbolType::ClassProcedure):
          tmp = create_ClassProcedure(x.base.base.loc, x.m_args, x.n_args, v,
                                      v_expr);
          break;
        default:
          throw SemanticError(
              "Symbol '" + var_name + "' is not a function or an array",
              x.base.base.loc);
      }
    }
  }

  ASR::symbol_t *resolve_intrinsic_function(const Location &loc,
                                            const std::string &remote_sym) {
    if (!intrinsic_procedures.is_intrinsic(remote_sym)) {
      if (compiler_options.implicit_interface) {
        return nullptr;
      } else {
        throw SemanticError("Function '" + remote_sym +
                                "' not found"
    ...
    ASR::Module_t *m = ASRUtils::load_module(
        al, tu_symtab, module_name, loc, true, rl_path, true,
        [&](const std::string &msg, const Location &loc) {
          throw SemanticError(msg, loc);
        });
    ...
    if (!t) {
      ...
      throw SemanticError(
          "The symbol '" + remote_sym + "' found in the module '" +
              module_name + "', " +
    ...
    ASR::asr_t *fn =
        ASR::make_ExternalSymbol_t(al, t->base.loc,
                                   /* a_symtab */ current_scope,
                                   /* a_name */ fn_name, t, m->m_name, nullptr,
                                   0, fn_name, ASR::accessType::Private);
  ...
  void visit_BinOp2(Allocator &al, const AST::BinOp_t &x, ASR::expr_t *&left,
    ...
    ASR::expr_t *overloaded = nullptr;
    if (ASRUtils::use_overloaded(
            left, right, op, intrinsic_op_name, curr_scope, asr, al,
            x.base.base.loc, [&](const std::string &msg, const Location &loc) {
              throw SemanticError(msg, loc);
            })) {
      overloaded = LFortran::ASRUtils::EXPR(asr);
    ...
    ASR::ttype_t *source_type = left_type;
    ASR::ttype_t *dest_type = right_type;
    if (!ASRUtils::is_generic(*left_type) &&
        !ASRUtils::is_generic(*right_type)) {
      ImplicitCastRules::find_conversion_candidate(&left, &right, left_type,
                                                   right_type, conversion_cand,
                                                   &source_type, &dest_type);
    }
    ...
    if (ASRUtils::is_integer(*dest_type)) {
      ...
      asr = ASR::make_IntegerBinOp_t(al, x.base.base.loc, left, op, right,
                                     dest_type, value);

    } else if (ASRUtils::is_generic(*left_type) ||
               ASRUtils::is_generic(*right_type)) {
      asr = ASR::make_TemplateBinOp_t(al, x.base.base.loc, left, op, right,
                                      dest_type, value);
    } else if (ASRUtils::is_real(*dest_type)) {
      if (ASRUtils::expr_value(left) != nullptr &&
          ASRUtils::expr_value(right) != nullptr) {
      ...
      asr = ASR::make_RealBinOp_t(al, x.base.base.loc, left, op, right,
                                  dest_type, value);
      ...
      if (ASRUtils::expr_value(left) != nullptr &&
        ...
        value = ASR::down_cast<ASR::expr_t>(
            ASR::make_ComplexConstant_t(al, x.base.base.loc, std::real(result),
                                        std::imag(result), dest_type));
      }

      asr = ASR::make_ComplexBinOp_t(al, x.base.base.loc, left, op, right,
                                     dest_type, value);
    }

    if (overloaded != nullptr) {
      asr = ASR::make_OverloadedBinOp_t(al, x.base.base.loc, left, op, right,
                                        dest_type, value, overloaded);
    }
  }
  ...
  void visit_String(const AST::String_t &x) {
    ...
    ASR::ttype_t *type = LFortran::ASRUtils::TYPE(ASR::make_Character_t(
        al, x.base.base.loc, 1, s_len, nullptr, nullptr, 0));
  ...
  void visit_BOZ(const AST::BOZ_t &x) {
    ...
    tmp =
        ASR::make_IntegerBOZ_t(al, x.base.base.loc, boz_int, boz_type, nullptr);
  }
  ...
  void visit_Num(const AST::Num_t &x) {
          ...
          if (ASR::is_a<ASR::Variable_t>(*v3)) {
            ...
            if (v2->m_value) {
              if (ASR::is_a<ASR::IntegerConstant_t>(*v2->m_value)) {
                ikind =
                    ASR::down_cast<ASR::IntegerConstant_t>(v2->m_value)->m_n;
              } else {
                throw SemanticError("Variable '" + var_name +
    ...
    ASR::ttype_t *type = LFortran::ASRUtils::TYPE(
        ASR::make_Integer_t(al, x.base.base.loc, ikind, nullptr, 0));
    if (BigInt::is_int_ptr(x.m_n)) {
      std::string str_repr = BigInt::largeint_to_string(x.m_n);
      if (!BigInt::is_int64(str_repr)) {
        throw SemanticError(
            "Integer constants larger than 2^64-1 are not implemented yet",
            x.base.base.loc);
      }
  ...
  void visit_Real(const AST::Real_t &x) {
        ...
        if (ASR::is_a<ASR::Variable_t>(*v3)) {
          ...
          if (v2->m_value) {
            if (ASR::is_a<ASR::IntegerConstant_t>(*v2->m_value)) {
              ...
              throw SemanticError(
                  "Variable '" + var_name + "' is constant but not an integer",
                  x.base.base.loc);
            }
          } else {
            throw SemanticError("Variable '" + var_name + "' is not constant",
    ...
    ASR::ttype_t *type = LFortran::ASRUtils::TYPE(
        ASR::make_Real_t(al, x.base.base.loc, r_kind, nullptr, 0));
  ...
  void visit_Complex(const AST::Complex_t &x) {
    ...
    ASR::ttype_t *type = ASRUtils::TYPE(ASR::make_Complex_t(
        al, x.base.base.loc, std::max(a_kind_r, a_kind_i), nullptr, 0));
    ASR::expr_t *value = nullptr;
    if (re_value && im_value) {
      ...
      if (ASR::is_a<ASR::RealConstant_t>(*re_value)) {
        ...
        throw SemanticError(
            "Argument `a` in a ComplexConstructor `(a,b)` must be either Real "
            "or Integer",
            x.base.base.loc);
      }
      double im_double;
      if (ASR::is_a<ASR::RealConstant_t>(*im_value)) {
        ...
        throw SemanticError(
            "Argument `b` in a ComplexConstructor `(a,b)` must be either Real "
            "or Integer",
            x.base.base.loc);
      }
      value = ASR::down_cast<ASR::expr_t>(ASR::make_ComplexConstant_t(
          al, x.base.base.loc, re_double, im_double, type));
    }
    tmp = ASR::make_ComplexConstructor_t(al, x.base.base.loc, re, im, type,
                                         value);
  }
  ...
  void visit_expr_list(AST::fnarg_t *ast_list, size_t n,
  ...
  std::vector<std::string> convert_fn_args_to_string(ASR::expr_t **expr_list,
                                                     size_t n,
                                                     const Location &loc) {
    ...
    for (size_t i = 0; i < n; i++) {
      ...
      if (v->m_presence == ASR::presenceType::Optional) {
        SemanticError(
            "Keyword arguments with optional arguments are not implemented yet",
            loc);
      }
  ...
  template <typename T>
  void visit_kwargs(Vec<ASR::call_arg_t> &args, AST::keyword_t *kwargs,
                    size_t n, ASR::expr_t **fn_args, size_t fn_n_args,
                    const Location &loc, T *fn, diag::Diagnostics &diag,
                    size_t type_bound = 0) {
    ...
    if (n_args + n > fn_n_args) {
      diag.semantic_error_label(
          "Procedure accepts " + std::to_string(fn_n_args) +
              ...
              " were provided",
          {loc}, "incorrect number of arguments to " + std::string(fn_name));
      return;
    }

    std::vector<std::string> fn_args2 =
        convert_fn_args_to_string(fn_args, fn_n_args, loc);

    for (size_t i = 0; i < n; i++) {
      std::string str = std::string(kwargs[i].m_arg);
      if (std::find(optional_args.begin(), optional_args.end(), str) ==
          optional_args.end()) {
    ...
    for (size_t i = 0; i < n; i++) {
      ...
      auto search_optional =
          std::find(optional_args.begin(), optional_args.end(), name);
      if (search_optional != optional_args.end()) {
        size_t kwarg_idx =
            std::distance(optional_args.begin(), search_optional);
        ...
        if (search != fn_args2.end()) {
          ...
          if (idx < n_args) {
            diag.semantic_error_label(
                "Keyword argument is already specified as a non-keyword "
                "argument",
                {loc}, name + "keyword argument is already specified.");
            return;
          }
          if (args[idx].m_value != nullptr) {
            diag.semantic_error_label(
                "Keyword argument is already specified as another keyword "
                "argument",
                {loc}, name + "keyword argument is already specified.");
            return;
          }
          ...
          diag.semantic_error_label("Keyword argument not found " + name, {loc},
    ...
    for (size_t i = 0; i < offset; i++) {
      if (args[i].m_value == nullptr) {
        diag.semantic_error_label(
            "Argument was not specified", {loc},
            std::to_string(i) + "-th argument not specified for " + fn_name);
        return;
      }
    }
  }
  ...
  void visit_Name(const AST::Name_t &x) {
    if (x.n_member == 0) {
      ...
      SymbolTable *scope = current_scope;
      tmp = this->resolve_variable2(x.base.base.loc,
                                    to_lower(x.m_member[1].m_name),
                                    to_lower(x.m_member[0].m_name), scope);
      ASR::DerivedRef_t *tmp2;
      std::uint32_t i;
      for (i = 2; i < x.n_member; i++) {
        tmp2 = (ASR::DerivedRef_t *)this->resolve_variable2(
            x.base.base.loc, to_lower(x.m_member[i].m_name),
            to_lower(x.m_member[i - 1].m_name), scope);
        tmp = ASR::make_DerivedRef_t(al, x.base.base.loc,
                                     LFortran::ASRUtils::EXPR(tmp), tmp2->m_m,
                                     tmp2->m_type, nullptr);
      }
      i = x.n_member - 1;
      tmp2 = (ASR::DerivedRef_t *)this->resolve_variable2(
          x.base.base.loc, to_lower(x.m_id), to_lower(x.m_member[i].m_name),
          scope);
      tmp = ASR::make_DerivedRef_t(al, x.base.base.loc,
                                   LFortran::ASRUtils::EXPR(tmp), tmp2->m_m,
                                   tmp2->m_type, nullptr);
