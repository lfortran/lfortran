        ...
        if ((ASR::cast_kindType)cast_kind == ASR::cast_kindType::RealToInteger) {
            ...
            if (ASRUtils::expr_value(*convert_can)) {
                ...
                if (ASR::is_a<ASR::IntegerConstant_t>(*value)) {
                  ...
                  if (dest_kind == 4) {
                    float *new_array = new float[array_size];
            ...
            if (ASRUtils::expr_value(*convert_can)) {
                ...
                if (dest_kind == 4) {
                  ...
                  for (size_t i = 0; i < array_size; i++) {
                    if ( kind == 4 ) {
                      new_array[i] = float(((float*) data)[i]);
                    } else {
                      new_array[i] = float(((double*) data)[i]);
                    }
                  }
                  ASR::ttype_t* new_array_type = ASRUtils::TYPE(ASR::make_Array_t(al, dest_type2->base.loc, dest_type2,
                                            array_type->m_dims, array_type->n_dims, ASR::array_physical_typeType::FixedSizeArray));
            ...
            if (ASRUtils::expr_value(*convert_can)) {
                ...
                if( ASR::is_a<ASR::IntegerConstant_t>(*value) ) {
                  ...
                  if (dest_kind == 4) {
                    ...
                    for (size_t i = 0; i < array_size; i++) {
                      if ( kind == 4) {
                        new_array[i] = int(((int*) data)[i]);
                      } else if ( kind == 8 ) {
                        new_array[i] = int(((int64_t*) data)[i]);
                      } else if ( kind == 2 ) {
                        new_array[i] = int(((int16_t*) data)[i]);
                      } else if ( kind == 1 ) {
                        new_array[i] = int(((int8_t*) data)[i]);
                      }
                    }
                    ASR::ttype_t* new_array_type = ASRUtils::TYPE(ASR::make_Array_t(al, dest_type2->base.loc, dest_type2,
                                              array_type->m_dims, array_type->n_dims, ASR::array_physical_typeType::FixedSizeArray));
                    ...
                    int64_t *new_array = new int64_t[array_size];
                    for (size_t i = 0; i < array_size; i++) {
                      if ( kind == 4) {
                        new_array[i] = int64_t(((int*) data)[i]);
                      } else if ( kind == 8 ) {
                        new_array[i] = int64_t(((int64_t*) data)[i]);
                      } else if ( kind == 2 ) {
                        new_array[i] = int64_t(((int16_t*) data)[i]);
                      } else if ( kind == 1 ) {
                        new_array[i] = int64_t(((int8_t*) data)[i]);
                      }
                    }
                    ASR::ttype_t* new_array_type = ASRUtils::TYPE(ASR::make_Array_t(al, dest_type2->base.loc, dest_type2,
                                              array_type->m_dims, array_type->n_dims, ASR::array_physical_typeType::FixedSizeArray));
