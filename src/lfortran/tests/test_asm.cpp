...
template <>
inline std::ostream &print_vec(std::ostream &out,
...
std::string S(const std::string &s) { return s.substr(1, s.size()); }
...
TEST_CASE("modrm_sib_disp") {
  ...
  code.reserve(al, 32);
  LFortran::modrm_sib_disp(code, al, LFortran::X86Reg::ebx, &base, nullptr, 1,
                           0, false);
  ref = {0xd9};
  ...
  code.reserve(al, 32);
  LFortran::modrm_sib_disp(code, al, LFortran::X86Reg::ebx, &base, &index, 1, 0,
                           true);
  ref = {0x1c, 0x18};
  CHECK(code.as_vector() == ref);
  ...
  index = LFortran::X86Reg::eax;
  code.reserve(al, 32);
  LFortran::modrm_sib_disp(code, al, LFortran::X86Reg::ebx, &base, &index, 2, 0,
                           true);
  ref = {0x1c, 0x43};
  CHECK(code.as_vector() == ref);
  ...
  index = LFortran::X86Reg::eax;
  code.reserve(al, 32);
  LFortran::modrm_sib_disp(code, al, LFortran::X86Reg::ebx, &base, &index, 4, 0,
                           true);
  ref = {0x1c, 0x83};
  CHECK(code.as_vector() == ref);
  ...
  index = LFortran::X86Reg::eax;
  code.reserve(al, 32);
  LFortran::modrm_sib_disp(code, al, LFortran::X86Reg::ebx, &base, &index, 8, 0,
                           true);
  ref = {0x1c, 0xc3};
  CHECK(code.as_vector() == ref);
  ...
  index = LFortran::X86Reg::eax;
  code.reserve(al, 32);
  LFortran::modrm_sib_disp(code, al, LFortran::X86Reg::ebx, &base, &index, 8,
                           127, true);
  ref = {0x5c, 0xc3, 0x7f};
  CHECK(code.as_vector() == ref);
  ...
  index = LFortran::X86Reg::eax;
  code.reserve(al, 32);
  LFortran::modrm_sib_disp(code, al, LFortran::X86Reg::ebx, &base, &index, 2, 1,
                           true);
  ref = {0x5c, 0x43, 0x01};
  CHECK(code.as_vector() == ref);
  ...
  index = LFortran::X86Reg::ebx;
  code.reserve(al, 32);
  LFortran::modrm_sib_disp(code, al, LFortran::X86Reg::ecx, &base, &index, 4, 1,
                           true);
  ref = {0x4c, 0x9d, 0x01};
  CHECK(code.as_vector() == ref);
  ...
  index = LFortran::X86Reg::ebx;
  code.reserve(al, 32);
  LFortran::modrm_sib_disp(code, al, LFortran::X86Reg::ecx, &base, &index, 4,
                           128, true);
  ...
  index = LFortran::X86Reg::ebx;
  code.reserve(al, 32);
  LFortran::modrm_sib_disp(code, al, LFortran::X86Reg::ecx, nullptr, &index, 4,
                           1, true);
  ...
  index = LFortran::X86Reg::ebx;
  code.reserve(al, 32);
  CHECK_THROWS_AS(LFortran::modrm_sib_disp(code, al, LFortran::X86Reg::ecx,
                                           nullptr, &index, 3, 1, true),
                  LFortran::AssemblerError);

  index = LFortran::X86Reg::ebx;
  code.reserve(al, 32);
  CHECK_THROWS_AS(LFortran::modrm_sib_disp(code, al, LFortran::X86Reg::ecx,
                                           nullptr, nullptr, 1, 0, false),
                  LFortran::AssemblerError);
...
TEST_CASE("elf32 binary") {
  ...
  a.asm_mov_r32_imm32(LFortran::X86Reg::ecx,
                      a.get_defined_symbol("msg").value);  // buf
