...
// Ensure the YYSTYPE size is equal to Vec<AST::ast_t*>, which is a required
// member, so YYSTYPE has to be at least as big, but it should not be bigger,
// otherwise it would reduce performance.
