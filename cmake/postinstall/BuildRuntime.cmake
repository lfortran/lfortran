if(WIN32)
  set(LFORTRAN_PATH "${CMAKE_INSTALL_PREFIX}/bin/lfortran.exe")
else()
  set(LFORTRAN_PATH "${CMAKE_INSTALL_PREFIX}/bin/lfortran")
endif()
...
execute_process(
  COMMAND "${CMAKE_COMMAND}" --build  "${CMAKE_BINARY_DIR}/src/runtime" --target install
  WORKING_DIRECTORY "${CMAKE_BINARY_DIR}/src/runtime"
